/*
 * Robojax_WCS_LCD-VCC
 * This code gets the 5V for VCC from digital pin 9 (you can change it)
...
//if you don't want to use this method, open the other sketch which doesn't use digital pin for VCC
