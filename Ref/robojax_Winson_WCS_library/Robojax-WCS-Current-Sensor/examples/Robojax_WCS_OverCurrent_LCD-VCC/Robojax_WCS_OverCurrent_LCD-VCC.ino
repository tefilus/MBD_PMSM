/*
Robojax_WCS_OverCurrent_LCD-VCC
this code is to use digital as VCC for LCD
 ...
 * Read current and control a relay to disconnect load at certain current value
 and display the current on LCD1602 or LCD2004 with I2C
...
{
  Serial.begin(9600);
  Serial.println("Robojax WCS Library LCD Relay");
  sensor.begin();
