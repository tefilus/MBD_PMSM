 ...
 *
 * SIL generated interface for code: "Controller1"
 *
 */
       ...
       case 2:
        {
          ...
          if (!initComplete) {
            ...
            {
              void * dataAddress = (void *) &(Controller1_U.Iabc_fb[0]);
            ...
            {
              void * dataAddress = (void *) &(Controller1_U.Pos_fb[0]);
       ...
       case 5:
        {
          ...
          if (!initComplete) {
            ...
            {
              void * dataAddress = (void *) &(Controller1_U.Speed_Ref_PU);
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Controller1_Y.Dutycycles[0]);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 6 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Controller1_Y.Idc_Ref);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Controller1_Y.Idc_fb);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Controller1_Y.Speed_Ref);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Controller1_Y.Speed_fb);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
