...
## Generated on : Mon Jun 23 13:25:22 2025
...
SRCS = $(START_DIR)\Controller_ert_rtw\Controller.c $(START_DIR)\Controller_ert_rtw\Controller_data.c $(START_DIR)\Controller_ert_rtw\rtGetInf.c $(START_DIR)\Controller_ert_rtw\rtGetNaN.c $(START_DIR)\Controller_ert_rtw\rt_nonfinite.c $(START_DIR)\Controller_ert_rtw\rtmodel.c
...
OBJS = Controller.obj Controller_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rtmodel.obj
...
{$(START_DIR)\Controller_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Controller_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\Controller_ert_rtw\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_ert_rtw\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Controller_ert_rtw\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_ert_rtw\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Controller_ert_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_ert_rtw\rt_nonfinite.c"


rtmodel.obj : "$(START_DIR)\Controller_ert_rtw\rtmodel.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_ert_rtw\rtmodel.c"
