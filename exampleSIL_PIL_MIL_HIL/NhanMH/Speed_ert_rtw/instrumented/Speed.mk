...
## 
## Makefile     : Speed.mk
## Generated on : Fri Mar 21 11:40:59 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Speed.out
...
START_DIR                 = D:/MATLABNhan/final/Simulink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Speed.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Speed_ert_rtw/instrumented -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -IE:/Package Matlab/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/include -IE:/Package Matlab/ti/controlSUITE/device_support/f2806x/v151/F2806x_headers/include -IE:/Package Matlab/ti/controlSUITE//libs/math/CLAmath/v400/include -IE:/Package Matlab/ti/controlSUITE//libs/math/IQmath/v160/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IE:/Package Matlab/ti/controlSUITE//libs/utilities/hrcap_hccal/type0/v110/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/ipclite -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc/ipclite
...
SRCS = $(START_DIR)/Speed_ert_rtw/instrumented/MW_c28xx_csl.c $(START_DIR)/Speed_ert_rtw/instrumented/MW_c28xx_board.c $(START_DIR)/Speed_ert_rtw/instrumented/Speed.c coder_profile_timer.c

MAIN_SRC = $(START_DIR)/Speed_ert_rtw/instrumented/ert_main.c
...
OBJS = MW_c28xx_csl.obj MW_c28xx_board.obj Speed.obj coder_profile_timer.obj
...
LIBS = E:/Package Matlab/ti/controlSUITE/libs/math/FPUfastRTS/V100/lib/rts2800_fpu32_fast_supplement.lib E:/Package Matlab/ti/controlSUITE/libs/utilities/hrcap_hccal/type0/v110/lib/HCCAL_Type0_V1_fpu32.lib
...
%.obj : $(START_DIR)/Speed_ert_rtw/instrumented/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/instrumented/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/instrumented/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/instrumented/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"


MW_c28xx_csl.obj : $(START_DIR)/Speed_ert_rtw/instrumented/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/Speed_ert_rtw/instrumented/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Speed.obj : $(START_DIR)/Speed_ert_rtw/instrumented/Speed.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/Speed_ert_rtw/instrumented/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
