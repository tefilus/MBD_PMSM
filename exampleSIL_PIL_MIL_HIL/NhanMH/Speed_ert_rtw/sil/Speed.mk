...
## 
## Makefile     : Speed.mk
## Generated on : Mon Mar 17 17:39:03 2025
## Final product: ./Speed.exe
...
MODELREF_LINK_RSPFILE     = Speed_ref.rsp
CMD_FILE                  = Speed.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Speed_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/Speed_ert_rtw/sil -I$(START_DIR)/Speed_ert_rtw/coderassumptions -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(MATLAB_ROOT)/extern/include/coder/connectivity/XILTgtAppSvc -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CoderAssumpTgtAppSvc
...
DEFINES_ = -DCODER_ASSUMPTIONS_ENABLED=1 -DXIL_SIGNAL_HANDLER=1 -DHOST_WORD_ADDRESSABLE_TESTING=1
...
MODELREF_LIBS = hostobj/Speed.obj

LIBS = $(START_DIR)/Speed_ert_rtw/coderassumptions/pwslib/Speed_ca.lib $(MATLAB_ROOT)/sys/lcc64/lcc64/lib64/wsock32.lib
...
xil_interface.obj : $(START_DIR)/Speed_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


sil_main.obj : $(START_DIR)/Speed_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
