...
%Ts_motor_simscape = (T_pwm/100)*200;
...
%// đầu cao, cuối sai
%PI_params = mcb_SetControllerParameters(bldc,inverter,PU_System,T_pwm,Ts*0.4,Ts_speed*1.1);

%// giữa sai
%PI_params = mcb_SetControllerParameters(bldc,inverter,PU_System,T_pwm,Ts*0.9,Ts_speed);

%PI_params = mcb_SetControllerParameters(bldc,inverter,PU_System,T_pwm,Ts*1.1,Ts_speed*0.9);
