...
## 
## Makefile     : Current.mk
## Generated on : Tue Mar 18 10:54:52 2025
## Final product: ./Current.exe
...
MODELREF_LINK_RSPFILE     = Current_ref.rsp
CMD_FILE                  = Current.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
MODELREF_LIBS = hostobj/Current.obj hostobj/Current_data.obj hostobj/rtGetInf.obj hostobj/rtGetNaN.obj hostobj/rt_nonfinite.obj hostobj/rtmodel.obj

LIBS = $(START_DIR)/Current_ert_rtw/coderassumptions/pwslib/Current_ca.lib $(MATLAB_ROOT)/sys/lcc64/lcc64/lib64/wsock32.lib
...
xil_interface.obj : $(START_DIR)/Current_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


sil_main.obj : $(START_DIR)/Current_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
