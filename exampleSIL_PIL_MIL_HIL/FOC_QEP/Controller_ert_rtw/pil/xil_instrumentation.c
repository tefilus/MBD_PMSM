...
#define profileStart_Controller_sim_offset 5
#define profileEnd_Controller_sim_offset 5
...
/* Code instrumentation offset(s) for model Controller */
#define overheadStartFunction_estimate_offset 8
#define overheadEndFunction_estimate_offset 8
#define overheadStartTask_estimate_offset 8
#define overheadEndTask_estimate_offset 8
#define overheadStartFreeze_estimate_offset 8
#define overheadEndFreeze_estimate_offset 8
#define overheadStartGeneric_estimate_offset 8
#define overheadEndGeneric_estimate_offset 8
