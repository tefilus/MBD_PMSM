...
## Generated on : Mon Mar 17 10:59:02 2025
## Final product: ./Controller.out
...
START_DIR                 = E:/GiaotrinhDH/DATN/exampleSIL_PIL_MIL_HIL/FOC_QEP
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Controller_ert_rtw/instrumented -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -ID:/TiC2000_Install/ControlSUITE/controlSUITE/device_support/f2806x/v151/F2806x_common/include -ID:/TiC2000_Install/ControlSUITE/controlSUITE/device_support/f2806x/v151/F2806x_headers/include -ID:/TiC2000_Install/ControlSUITE/controlSUITE/libs/math/CLAmath/v400/include -ID:/TiC2000_Install/ControlSUITE/controlSUITE/libs/math/IQmath/v160/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -ID:/TiC2000_Install/ControlSUITE/controlSUITE/libs/utilities/hrcap_hccal/type0/v110/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/ipclite -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc/ipclite -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/Controller_ert_rtw/pil -I$(MATLAB_ROOT)/extern/include/coder/connectivity/XILTgtAppSvc -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CoderAssumpTgtAppSvc -I$(START_DIR)/Controller_ert_rtw/coderassumptions -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CodeInstrTgtAppSvc -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_base/src
...
MODELREF_LIBS = ../instrumented/MW_c28xx_csl.obj ../instrumented/MW_c28xx_board.obj ../instrumented/Controller.obj ../instrumented/Controller_data.obj ../instrumented/rtGetInf.obj ../instrumented/rtGetNaN.obj ../instrumented/rt_nonfinite.obj

LIBS = D:/TiC2000_Install/ControlSUITE/controlSUITE/libs/math/FPUfastRTS/V100/lib/rts2800_fpu32_fast_supplement.lib D:/TiC2000_Install/ControlSUITE/controlSUITE/libs/utilities/hrcap_hccal/type0/v110/lib/HCCAL_Type0_V1_fpu32.lib $(START_DIR)/Controller_ert_rtw/coderassumptions/lib/Controller_ca.lib C:/ProgramData/MATLAB/tic2000/3P.instrset/tic28xcodegentools.instrset/ti-cgt-c2000_22.6.0.LTS/lib/rts2800_fpu32.lib D:/TiC2000_Install/ControlSUITE/controlSUITE/libs/math/IQmath/v160/lib/IQmath_fpu32.lib $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2806xPeripherals.cmd $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c28069M.cmd
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS)
	...
	$(LD) $(LDFLAGS) --output_file=$(PRODUCT) $(OBJS) ../instrumented/MW_c28xx_csl.obj ../instrumented/MW_c28xx_board.obj ../instrumented/Controller.obj ../instrumented/Controller_data.obj ../instrumented/rtGetInf.obj ../instrumented/rtGetNaN.obj ../instrumented/rt_nonfinite.obj $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
xil_interface.obj : $(START_DIR)/Controller_ert_rtw/pil/xil_interface.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
xil_instrumentation.obj : $(START_DIR)/Controller_ert_rtw/pil/xil_instrumentation.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
