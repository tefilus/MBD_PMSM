...
## 
## Makefile     : Current.mk
## Generated on : Thu Mar 20 13:13:47 2025
...
SRCS = $(START_DIR)/Current_ert_rtw/instrumented/MW_c28xx_csl.c $(START_DIR)/Current_ert_rtw/instrumented/MW_c28xx_board.c $(START_DIR)/Current_ert_rtw/instrumented/Current.c $(START_DIR)/Current_ert_rtw/instrumented/Current_data.c $(START_DIR)/Current_ert_rtw/instrumented/rtGetInf.c $(START_DIR)/Current_ert_rtw/instrumented/rtGetNaN.c $(START_DIR)/Current_ert_rtw/instrumented/rt_nonfinite.c coder_profile_timer.c
...
OBJS = MW_c28xx_csl.obj MW_c28xx_board.obj Current.obj Current_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj coder_profile_timer.obj
...
rtGetInf.obj : $(START_DIR)/Current_ert_rtw/instrumented/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/Current_ert_rtw/instrumented/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/Current_ert_rtw/instrumented/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
