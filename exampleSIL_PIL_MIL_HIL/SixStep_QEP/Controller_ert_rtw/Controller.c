...
void Controller_step1(void)            /* Sample time: [5.0E-5s, 0.0s] */
{
  ...
  if ((uint16_T)i != 0U) {
    ...
    Controller_HallValueof7(&rtb_Merge1);
...
void Controller_step2(void)            /* Sample time: [0.0005s, 0.0s] */
{
  ...
  rtb_Saturation_h = Controller_SpeedControl1(Controller_Y.Speedref,
    Controller_DW.RT_Buffer, &Controller_DW.SpeedControl1);
...
void Controller_initialize(void)
{
...

  {
    ...
    Controll_SpeedControl1_Init(&Controller_DW.SpeedControl1);
