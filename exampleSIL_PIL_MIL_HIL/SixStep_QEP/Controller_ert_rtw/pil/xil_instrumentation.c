...
#define profileStart_Controller_offset 6
#define profileEnd_Controller_offset   6
...
/* Code instrumentation offset(s) for model Controller */
#define overheadStartFunction_estimate_offset 9
#define overheadEndFunction_estimate_offset 9
#define overheadStartTask_estimate_offset 9
#define overheadEndTask_estimate_offset 9
#define overheadStartFreeze_estimate_offset 9
#define overheadEndFreeze_estimate_offset 9
#define overheadStartGeneric_estimate_offset 9
#define overheadEndGeneric_estimate_offset 9
