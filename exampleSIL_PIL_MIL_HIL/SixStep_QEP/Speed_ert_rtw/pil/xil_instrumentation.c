...
/* Code instrumentation offset(s) for model Speed Control */
#define profileStart_Speed_Control_offset 3
#define profileEnd_Speed_Control_offset 3

/* Code instrumentation offset(s) for model Speed */
#define taskTimeStart_Speed_offset     0
#define taskTimeEnd_Speed_offset       0
...
{
  profileStart(profileStart_Speed_Control_offset + sectionId);
}

void profileEnd_Speed_Control(uint16_T sectionId)
{
  profileEnd(profileEnd_Speed_Control_offset + sectionId);
}

/* Code instrumentation method(s) for model Speed */
void taskTimeStart_Speed(uint16_T sectionId)
{
  taskTimeStart(taskTimeStart_Speed_offset + sectionId);
}

void taskTimeEnd_Speed(uint16_T sectionId)
{
  taskTimeEnd(taskTimeEnd_Speed_offset + sectionId);
}
