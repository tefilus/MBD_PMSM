 ...
 *
 * PIL generated interface for code: "Speed"
 *
 */
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    taskTimeStart_Speed(1U);
    Speed_initialize();
    taskTimeEnd_Speed(1U);
  } else {
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Speed_U.SpeedRef);
        ...
        {
          void * dataAddress = (void *) &(Speed_U.Speed_fb);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    taskTimeStart_Speed(2U);
    Speed_step();
    taskTimeEnd_Speed(2U);
    break;
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Speed_Y.IdcRef_PU);
...
XIL_INTERFACE_ERROR_CODE xilTerminate(uint32_T xilFcnId)
{
  ...
  taskTimeStart_Speed(3U);
  Speed_terminate();
  taskTimeEnd_Speed(3U);
