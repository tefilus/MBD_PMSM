###########################################################################
## Makefile generated for component 'Speed_ca'. 
## 
## Makefile     : Speed_ca.mk
## Generated on : Thu Mar 20 13:56:01 2025
## Final product: ./Speed_ca.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/Speed_ert_rtw/coderassumptions -I$(START_DIR)/Speed_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -ID:/TiC2000_Install/ControlSUITE/controlSUITE/device_support/f2806x/v151/F2806x_common/include -ID:/TiC2000_Install/ControlSUITE/controlSUITE/device_support/f2806x/v151/F2806x_headers/include -ID:/TiC2000_Install/ControlSUITE/controlSUITE/libs/math/CLAmath/v400/include -ID:/TiC2000_Install/ControlSUITE/controlSUITE/libs/math/IQmath/v160/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -ID:/TiC2000_Install/ControlSUITE/controlSUITE/libs/utilities/hrcap_hccal/type0/v110/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/ipclite -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc/ipclite
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/Speed_ert_rtw/coderassumptions/Speed_ca.c
...
OBJS = coder_assumptions_hwimpl.obj coder_assumptions_flt.obj Speed_ca.obj
...
%.obj : $(START_DIR)/Speed_ert_rtw/coderassumptions/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/coderassumptions/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/coderassumptions/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/coderassumptions/lib/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/coderassumptions/lib/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Speed_ert_rtw/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
Speed_ca.obj : $(START_DIR)/Speed_ert_rtw/coderassumptions/Speed_ca.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
