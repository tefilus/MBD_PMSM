...
} rtB_To_LCD_sixstep_f28069mLaunc;

/* Block states (default storage) for system '<Root>/To_LCD' */
typedef struct {
  uint16_T Output_DSTATE;              /* '<S294>/Output' */
  uint16_T Add_DWORK1;                 /* '<S289>/Add' */
} rtDW_To_LCD_sixstep_f28069mLaun;

extern void sixstep_f28069m_To_LCD_Init(rtB_To_LCD_sixstep_f28069mLaunc *localB);
extern void sixstep_f28069mLaunc_To_LCD(const real32_T *rtd_speedSCI_B,
  rtB_To_LCD_sixstep_f28069mLaunc *localB, rtDW_To_LCD_sixstep_f28069mLaun
  *localDW);
