###########################################################################
## Makefile generated for component 'sixstep_f28069mLaunchPad'. 
## 
## Makefile     : sixstep_f28069mLaunchPad.mk
## Generated on : Fri May 23 19:01:02 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sixstep_f28069mLaunchPad.out
...
PRODUCT_NAME              = sixstep_f28069mLaunchPad
MAKEFILE                  = sixstep_f28069mLaunchPad.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sixstep_f28069mLaunchPad.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -ID:/TiC2000_Install/ControlSUITE/controlSUITE/device_support/f2806x/v151/F2806x_common/include -ID:/TiC2000_Install/ControlSUITE/controlSUITE/device_support/f2806x/v151/F2806x_headers/include -ID:/TiC2000_Install/ControlSUITE/controlSUITE/libs/math/CLAmath/v400/include -ID:/TiC2000_Install/ControlSUITE/controlSUITE/libs/math/IQmath/v160/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -ID:/TiC2000_Install/ControlSUITE/controlSUITE/libs/utilities/hrcap_hccal/type0/v110/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/ipclite -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc/ipclite
...
DEFINES_STANDARD = -DMODEL=sixstep_f28069mLaunchPad -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_qep.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_qep.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


To_LCD.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/To_LCD.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


sixstep_f28069mLaunchPad.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/sixstep_f28069mLaunchPad.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


sixstep_f28069mLaunchPad_data.obj : $(START_DIR)/sixstep_f28069mLaunchPad_ert_rtw/sixstep_f28069mLaunchPad_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
