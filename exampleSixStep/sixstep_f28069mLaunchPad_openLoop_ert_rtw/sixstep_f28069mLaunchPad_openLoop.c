/*
 * File: sixstep_f28069mLaunchPad_openLoop.c
 *
...
#include "sixstep_f28069mLaunchPad_openLoop.h"
#include "sixstep_f28069mLaunchPad_openLoop_private.h"
#include "rtwtypes.h"
#include <math.h>
#include <string.h>

/* Block signals (default storage) */
BlockIO_sixstep_f28069mLaunchPa sixstep_f28069mLaunchPad_open_B;

/* Block states (default storage) */
D_Work_sixstep_f28069mLaunchPad sixstep_f28069mLaunchPad__DWork;

/* Real-time model */
static RT_MODEL_sixstep_f28069mLaunchP sixstep_f28069mLaunchPad_ope_M_;
RT_MODEL_sixstep_f28069mLaunchP *const sixstep_f28069mLaunchPad_ope_M =
  &sixstep_f28069mLaunchPad_ope_M_;
 ...
 */
void sixstep_f28069mLaunchPad_openLoop_SetEventsForThisBaseStep(boolean_T
  *eventFlags)
{
  /* Task runs when its counter is zero, computed via rtmStepTask macro */
  eventFlags[1] = ((boolean_T)rtmStepTask(sixstep_f28069mLaunchPad_ope_M, 1));
}
...
static void rate_monotonic_scheduler(void)
{
   ...
   */
  (sixstep_f28069mLaunchPad_ope_M->Timing.TaskCounters.TID[1])++;
  if ((sixstep_f28069mLaunchPad_ope_M->Timing.TaskCounters.TID[1]) > 4) {/* Sample time: [0.5s, 0.0s] */
    sixstep_f28069mLaunchPad_ope_M->Timing.TaskCounters.TID[1] = 0;
  }
}

/* Model step function for TID0 */
void sixstep_f28069mLaunchPad_openLoop_step0(void) /* Sample time: [0.1s, 0.0s] */
{
  ...
  {
    sixstep_f28069mLaunchPad_open_B.CWCCW_GPIO7 = GpioDataRegs.GPADAT.bit.GPIO7;
  }

  /* DataStoreWrite: '<S4>/Data Store Write1' */
  sixstep_f28069mLaunchPad__DWork.readTorqueSign =
    sixstep_f28069mLaunchPad_open_B.CWCCW_GPIO7;

  /* S-Function (c280xgpio_di): '<S4>/ON//OFF_GPIO6' */
  {
    sixstep_f28069mLaunchPad_open_B.ONOFF_GPIO6 = GpioDataRegs.GPADAT.bit.GPIO6;
  }

  /* DataStoreWrite: '<S4>/Data Store Write' */
  sixstep_f28069mLaunchPad__DWork.Enable =
    sixstep_f28069mLaunchPad_open_B.ONOFF_GPIO6;
}

/* Model step function for TID1 */
void sixstep_f28069mLaunchPad_openLoop_step1(void) /* Sample time: [0.5s, 0.0s] */
{
  /* S-Function (c280xgpio_do): '<S1>/Digital Output' incorporates:
   *  Constant: '<S1>/Constant'
   */
  {
    GpioDataRegs.GPBTOGGLE.bit.GPIO34 = (uint16_T)((1.0) != 0);
  }
}

/* Model initialize function */
void sixstep_f28069mLaunchPad_openLoop_initialize(void)
{
  /* Registration code */

  /* initialize real-time model */
  (void) memset((void *)sixstep_f28069mLaunchPad_ope_M, 0,
                sizeof(RT_MODEL_sixstep_f28069mLaunchP));

  /* block I/O */
  (void) memset(((void *) &sixstep_f28069mLaunchPad_open_B), 0,
                sizeof(BlockIO_sixstep_f28069mLaunchPa));

  {
    int16_T i;
    for (i = 0; i < 6; i++) {
      sixstep_f28069mLaunchPad_open_B.DataTypeConversion1[i] = 0.0F;
    }

    sixstep_f28069mLaunchPad_open_B.Merge = 0.0;
    sixstep_f28069mLaunchPad_open_B.Sign = 0.0;
    sixstep_f28069mLaunchPad_open_B.DataTypeConversion = 0.0F;
    sixstep_f28069mLaunchPad_open_B.DTC = 0.0F;
    sixstep_f28069mLaunchPad_open_B.Product = 0.0F;
    sixstep_f28069mLaunchPad_open_B.DTC_a = 0.0F;
    sixstep_f28069mLaunchPad_open_B.SpeedGain = 0.0F;
    sixstep_f28069mLaunchPad_open_B.Product_b = 0.0F;
    sixstep_f28069mLaunchPad_open_B.UnitDelay = 0.0F;
    sixstep_f28069mLaunchPad_open_B.Product1 = 0.0F;
    sixstep_f28069mLaunchPad_open_B.Add1 = 0.0F;
    sixstep_f28069mLaunchPad_open_B.Switch = 0.0F;
    sixstep_f28069mLaunchPad_open_B.Merge_k = 0.0F;
    sixstep_f28069mLaunchPad_open_B.Numberofpolepairs = 0.0F;
    sixstep_f28069mLaunchPad_open_B.Floor = 0.0F;
    sixstep_f28069mLaunchPad_open_B.Add = 0.0F;
  }

  /* states (dwork) */
  (void) memset((void *)&sixstep_f28069mLaunchPad__DWork, 0,
                sizeof(D_Work_sixstep_f28069mLaunchPad));
  sixstep_f28069mLaunchPad__DWork.desiredSpeed = 0.0;
  ...
  /* System initialize for function-call system: '<Root>/Current Control' */
  {
    ...
    for (i = 0; i < 6; i++) {
      ...
      sixstep_f28069mLaunchPad_open_B.Merge_n[i] = false;
    }
...
void sixstep_f28069mLaunchPad_openLoop_terminate(void)
{
  ...
  if (1 == runModel) {
    {
      ...
      /* Output and update for function-call system: '<Root>/Current Control' */
      {
        ...
        sixstep_f28069mLaunchPad_open_B.Enable =
          sixstep_f28069mLaunchPad__DWork.Enable;

        /* S-Function (c280xgpio_do): '<S9>/Digital Output' */
        {
          if (sixstep_f28069mLaunchPad_open_B.Enable) {
        ...
        /* S-Function (c2802xadc): '<S11>/Read POT' */
        {
          ...
          sixstep_f28069mLaunchPad_open_B.ReadPOT = (AdcResult.ADCRESULT1);
        }

        /* Gain: '<S5>/Gain' */
        sixstep_f28069mLaunchPad_open_B.Gain = (uint32_T)
          sixstep_f28069mLaunchPad_open_B.ReadPOT << 15U;

        /* Saturate: '<S5>/Pot_limit' incorporates:
         *  Gain: '<S5>/Gain'
         */
        duty = sixstep_f28069mLaunchPad_open_B.Gain;
        if ((int32_T)duty <= 120795955L) {
          /* Saturate: '<S5>/Pot_limit' */
          sixstep_f28069mLaunchPad_open_B.Pot_limit = duty;
        } else {
          /* Saturate: '<S5>/Pot_limit' */
          sixstep_f28069mLaunchPad_open_B.Pot_limit = 120795955UL;
        }
        ...
        {
          sixstep_f28069mLaunchPad_open_B.eQEP_o1 = EQep1Regs.QPOSCNT;/*eQEP Position Counter*/
          sixstep_f28069mLaunchPad_open_B.eQEP_o2 = EQep1Regs.QPOSILAT;
         ...
         * */
        sixstep_f28069mLaunchPad_open_B.Sum3 =
          sixstep_f28069mLaunchPad_open_B.eQEP_o1 -
          sixstep_f28069mLaunchPad_open_B.eQEP_o2;
        sixstep_f28069mLaunchPad_open_B.Sum7 =
          sixstep_f28069mLaunchPad_open_B.Sum3 + 10000U;
        u0 = sixstep_f28069mLaunchPad_open_B.Sum3;
        minV_tmp = sixstep_f28069mLaunchPad_open_B.Sum7;
        if (u0 <= minV_tmp) {
          minV_tmp = u0;
        }

        sixstep_f28069mLaunchPad_open_B.Merge_o = minV_tmp;

        /* End of Outputs for SubSystem: '<S45>/PositionNoReset' */
        sixstep_f28069mLaunchPad_open_B.DTC =
          sixstep_f28069mLaunchPad_open_B.Merge_o;
        sixstep_f28069mLaunchPad_open_B.Product =
          sixstep_f28069mLaunchPad_open_B.DTC * 0.0001F;
        sixstep_f28069mLaunchPad_open_B.PositionToCount = (uint32_T)
          (4.2949673E+9F * sixstep_f28069mLaunchPad_open_B.Product);
        sixstep_f28069mLaunchPad_open_B.Delay =
          sixstep_f28069mLaunchPad__DWork.Delay_DSTATE[sixstep_f28069mLaunchPad__DWork.CircBufIdx];
        sixstep_f28069mLaunchPad_open_B.SpeedCount = (int32_T)
          sixstep_f28069mLaunchPad_open_B.PositionToCount - (int32_T)
          sixstep_f28069mLaunchPad_open_B.Delay;
        sixstep_f28069mLaunchPad_open_B.DTC_a = (real32_T)
          sixstep_f28069mLaunchPad_open_B.SpeedCount;
        sixstep_f28069mLaunchPad_open_B.SpeedGain = 2.70785794E-9F *
          sixstep_f28069mLaunchPad_open_B.DTC_a;
        sixstep_f28069mLaunchPad_open_B.Product_b =
          sixstep_f28069mLaunchPad_open_B.SpeedGain * 0.01F;
        sixstep_f28069mLaunchPad_open_B.UnitDelay =
          sixstep_f28069mLaunchPad__DWork.UnitDelay_DSTATE;
        sixstep_f28069mLaunchPad_open_B.Product1 = 0.99F *
          sixstep_f28069mLaunchPad_open_B.UnitDelay;
        sixstep_f28069mLaunchPad_open_B.Add1 =
          sixstep_f28069mLaunchPad_open_B.Product_b +
          sixstep_f28069mLaunchPad_open_B.Product1;
        sixstep_f28069mLaunchPad_open_B.Switch = 0.1985F;
        if (sixstep_f28069mLaunchPad_open_B.Product <= 0.1985F) {
           ...
           *  Sum: '<S54>/Add'
           */
          sixstep_f28069mLaunchPad_open_B.Merge_k =
            (sixstep_f28069mLaunchPad_open_B.Product + 1.0F) - 0.1985F;
           ...
           */
          sixstep_f28069mLaunchPad_open_B.Merge_k =
            sixstep_f28069mLaunchPad_open_B.Product - 0.1985F;

          /* End of Outputs for SubSystem: '<S52>/If Action Subsystem1' */
        }

        sixstep_f28069mLaunchPad_open_B.Numberofpolepairs = 5.0F *
          sixstep_f28069mLaunchPad_open_B.Merge_k;
        sixstep_f28069mLaunchPad_open_B.Floor = (real32_T)floor
          (sixstep_f28069mLaunchPad_open_B.Numberofpolepairs);
        sixstep_f28069mLaunchPad_open_B.Add =
          sixstep_f28069mLaunchPad_open_B.Numberofpolepairs -
          sixstep_f28069mLaunchPad_open_B.Floor;
        sixstep_f28069mLaunchPad__DWork.Delay_DSTATE[sixstep_f28069mLaunchPad__DWork.CircBufIdx]
          = sixstep_f28069mLaunchPad_open_B.PositionToCount;
        ...
        sixstep_f28069mLaunchPad_open_B.DataStoreRead =
          sixstep_f28069mLaunchPad__DWork.readTorqueSign;

        /* If: '<S5>/If1' */
        if (!sixstep_f28069mLaunchPad_open_B.DataStoreRead) {
           ...
           */
          sixstep_f28069mLaunchPad_open_B.Merge = 1.0;
        ...
        /* Signum: '<S5>/Sign' */
        i = (int16_T)sixstep_f28069mLaunchPad_open_B.Merge;
        if (i < 0) {
          /* Signum: '<S5>/Sign' */
          sixstep_f28069mLaunchPad_open_B.Sign = -1.0;
        } else {
          /* Signum: '<S5>/Sign' */
          sixstep_f28069mLaunchPad_open_B.Sign = (i > 0);
        }
         ...
         */
        if ((sixstep_f28069mLaunchPad_open_B.Add > 0.0833F) &&
            (sixstep_f28069mLaunchPad_open_B.Add <= 0.25F)) {
           ...
           */
          sixstep_f28069mLaunchPad_open_B.Merge_l = 2U;

          /* End of Outputs for SubSystem: '<S21>/Enabled Subsystem' */
        } else if ((sixstep_f28069mLaunchPad_open_B.Add > 0.25F) &&
                   (sixstep_f28069mLaunchPad_open_B.Add <= 0.4167F)) {
           ...
           */
          sixstep_f28069mLaunchPad_open_B.Merge_l = 3U;

          /* End of Outputs for SubSystem: '<S21>/Enabled Subsystem1' */
        } else if ((sixstep_f28069mLaunchPad_open_B.Add > 0.4167F) &&
                   (sixstep_f28069mLaunchPad_open_B.Add <= 0.5833F)) {
           ...
           */
          sixstep_f28069mLaunchPad_open_B.Merge_l = 4U;

          /* End of Outputs for SubSystem: '<S21>/Enabled Subsystem2' */
        } else if ((sixstep_f28069mLaunchPad_open_B.Add > 0.5833F) &&
                   (sixstep_f28069mLaunchPad_open_B.Add <= 0.75F)) {
           ...
           */
          sixstep_f28069mLaunchPad_open_B.Merge_l = 5U;

          /* End of Outputs for SubSystem: '<S21>/Enabled Subsystem3' */
        } else if ((sixstep_f28069mLaunchPad_open_B.Add > 0.75F) &&
                   (sixstep_f28069mLaunchPad_open_B.Add <= 0.9167F)) {
           ...
           */
          sixstep_f28069mLaunchPad_open_B.Merge_l = 6U;
           ...
           */
          sixstep_f28069mLaunchPad_open_B.Merge_l = (uint16_T)
            ((sixstep_f28069mLaunchPad_open_B.Add > 0.9167F) ||
             (sixstep_f28069mLaunchPad_open_B.Add <= 0.0833F));
         ...
         */
        sixstep_f28069mLaunchPad_open_B.ShiftArithmetic =
          sixstep_f28069mLaunchPad_open_B.Merge_l >> 2U;
        sixstep_f28069mLaunchPad_open_B.A =
          sixstep_f28069mLaunchPad_open_B.ShiftArithmetic;
        sixstep_f28069mLaunchPad_open_B.DataTypeConversion_i =
          (sixstep_f28069mLaunchPad_open_B.A != 0U);
        sixstep_f28069mLaunchPad_open_B.Merge_e[0] =
          sixstep_f28069mLaunchPad_open_B.DataTypeConversion_i;
        sixstep_f28069mLaunchPad_open_B.ShiftArithmetic1 =
          sixstep_f28069mLaunchPad_open_B.Merge_l >> 1U;
        sixstep_f28069mLaunchPad_open_B.B =
          sixstep_f28069mLaunchPad_open_B.ShiftArithmetic1 & 1U;
        sixstep_f28069mLaunchPad_open_B.DataTypeConversion1_m =
          (sixstep_f28069mLaunchPad_open_B.B != 0U);
        sixstep_f28069mLaunchPad_open_B.Merge_e[1] =
          sixstep_f28069mLaunchPad_open_B.DataTypeConversion1_m;
        sixstep_f28069mLaunchPad_open_B.C =
          sixstep_f28069mLaunchPad_open_B.Merge_l & 1U;
        sixstep_f28069mLaunchPad_open_B.DataTypeConversion2 =
          (sixstep_f28069mLaunchPad_open_B.C != 0U);
        sixstep_f28069mLaunchPad_open_B.Merge_e[2] =
          sixstep_f28069mLaunchPad_open_B.DataTypeConversion2;

        /* End of Outputs for SubSystem: '<S18>/Bit Extract' */
        if (sixstep_f28069mLaunchPad_open_B.Sign > 0.0) {
           ...
           *  Merge: '<S19>/Merge'
           */
          minV_tmp = sixstep_f28069mLaunchPad_open_B.Merge_e[0U];
          minV_tmp = (minV_tmp << 1) + sixstep_f28069mLaunchPad_open_B.Merge_e
            [1U];
          minV_tmp = (minV_tmp << 1) + sixstep_f28069mLaunchPad_open_B.Merge_e
            [2U];
          sixstep_f28069mLaunchPad_open_B.Merge_n[0] =
            sixstep_f28069mLaunchPad_ConstP.pooled8[minV_tmp];

          /* CombinatorialLogic: '<S33>/SA2' incorporates:
           *  Merge: '<S19>/Merge'
           */
          sixstep_f28069mLaunchPad_open_B.Merge_n[1] =
            sixstep_f28069mLaunchPad_ConstP.pooled7[minV_tmp];

          /* CombinatorialLogic: '<S33>/SB1' incorporates:
           *  Merge: '<S19>/Merge'
           */
          sixstep_f28069mLaunchPad_open_B.Merge_n[2] =
            sixstep_f28069mLaunchPad_ConstP.pooled10[minV_tmp];

          /* CombinatorialLogic: '<S33>/SB2' incorporates:
           *  Merge: '<S19>/Merge'
           */
          sixstep_f28069mLaunchPad_open_B.Merge_n[3] =
            sixstep_f28069mLaunchPad_ConstP.pooled9[minV_tmp];

          /* CombinatorialLogic: '<S33>/SC1' incorporates:
           *  Merge: '<S19>/Merge'
           */
          sixstep_f28069mLaunchPad_open_B.Merge_n[4] =
            sixstep_f28069mLaunchPad_ConstP.pooled12[minV_tmp];

          /* CombinatorialLogic: '<S33>/SC2' incorporates:
           *  Merge: '<S19>/Merge'
           */
          sixstep_f28069mLaunchPad_open_B.Merge_n[5] =
            sixstep_f28069mLaunchPad_ConstP.pooled11[minV_tmp];
        ...
        for (i = 0; i < 6; i++) {
          ...
          if (sixstep_f28069mLaunchPad_open_B.Enable) {
            ...
            DataTypeConversion1 = (int16_T)
              sixstep_f28069mLaunchPad_open_B.Merge_n[i];
            sixstep_f28069mLaunchPad_open_B.DataTypeConversion1[i] =
              DataTypeConversion1;
            ...
            duty = (uint32_T)((real32_T)
                              sixstep_f28069mLaunchPad_open_B.Pot_limit *
                              7.4505806E-9F * (real32_T)DataTypeConversion1 *
                              1.34217728E+8F);
            sixstep_f28069mLaunchPad_open_B.duty[i] = duty;

            /* Gain: '<S9>/Scale_to_PWM_Counter_PRD' incorporates:
             *  Product: '<S5>/Product'
             */
            u0 = (uint16_T)((1125ULL * duty) >> 26U);
            sixstep_f28069mLaunchPad_open_B.Scale_to_PWM_Counter_PRD[i] = u0;

            /* Switch: '<S9>/Switch1' */
            sixstep_f28069mLaunchPad_open_B.Switch1[i] = u0;
          } else {
            /* Switch: '<S9>/Switch1' */
            sixstep_f28069mLaunchPad_open_B.Switch1[i] = 0U;
          }
        ...
        /*-- Update CMPA value for ePWM1 --*/
        {
          EPwm1Regs.CMPA.half.CMPA = (uint16_T)
            (sixstep_f28069mLaunchPad_open_B.Switch1[0]);
        }

        /*-- Update CMPB value for ePWM1 --*/
        {
          EPwm1Regs.CMPB = (uint16_T)(sixstep_f28069mLaunchPad_open_B.Switch1[1]);
        }
        ...
        /*-- Update CMPA value for ePWM2 --*/
        {
          EPwm2Regs.CMPA.half.CMPA = (uint16_T)
            (sixstep_f28069mLaunchPad_open_B.Switch1[2]);
        }

        /*-- Update CMPB value for ePWM2 --*/
        {
          EPwm2Regs.CMPB = (uint16_T)(sixstep_f28069mLaunchPad_open_B.Switch1[3]);
        }
        ...
        /*-- Update CMPA value for ePWM3 --*/
        {
          EPwm3Regs.CMPA.half.CMPA = (uint16_T)
            (sixstep_f28069mLaunchPad_open_B.Switch1[4]);
        }

        /*-- Update CMPB value for ePWM3 --*/
        {
          EPwm3Regs.CMPB = (uint16_T)(sixstep_f28069mLaunchPad_open_B.Switch1[5]);
        }

        /* DataTypeConversion: '<S5>/Data Type Conversion' incorporates:
         *  Saturate: '<S5>/Pot_limit'
         */
        sixstep_f28069mLaunchPad_open_B.DataTypeConversion = (real32_T)
          sixstep_f28069mLaunchPad_open_B.Pot_limit * 7.4505806E-9F;

        /* UnitDelay: '<S34>/Output' */
        sixstep_f28069mLaunchPad_open_B.Output =
          sixstep_f28069mLaunchPad__DWork.Output_DSTATE;

        /* DataTypeConversion: '<S36>/Data Type Conversion' */
        sixstep_f28069mLaunchPad_open_B.DataTypeConversion_g[0] = (int16_T)
          (sixstep_f28069mLaunchPad_open_B.Add1 * 4096.0F);
        sixstep_f28069mLaunchPad_open_B.DataTypeConversion_g[1] = (int16_T)
          (sixstep_f28069mLaunchPad_open_B.DataTypeConversion * 4096.0F);

        /* DataTypeConversion: '<S36>/Data Type Conversion1' incorporates:
         *  DataTypeConversion: '<S36>/Data Type Conversion'
         */
        sixstep_f28069mLaunchPad_open_B.DataTypeConversion1_h[0] = (uint16_T)
          sixstep_f28069mLaunchPad_open_B.DataTypeConversion_g[0];
        sixstep_f28069mLaunchPad_open_B.DataTypeConversion1_h[1] = (uint16_T)
          sixstep_f28069mLaunchPad_open_B.DataTypeConversion_g[1];

        /* If: '<S7>/If' */
        if (sixstep_f28069mLaunchPad_open_B.Output == 0U) {
           ...
           */
          sixstep_f28069mLaunchPad_open_B.SCI_Tx_Data[0] = 21331U;

          /* SignalConversion generated from: '<S38>/Data' */
          u0 = sixstep_f28069mLaunchPad_open_B.DataTypeConversion1_h[0];

          /* End of Outputs for SubSystem: '<S7>/Start' */
          sixstep_f28069mLaunchPad_open_B.Data_fw[0] = u0;
           ...
           *  SignalConversion generated from: '<S38>/Data_out'
           */
          sixstep_f28069mLaunchPad_open_B.SCI_Tx_Data[1] = u0;

          /* SignalConversion generated from: '<S38>/Data' */
          u0 = sixstep_f28069mLaunchPad_open_B.DataTypeConversion1_h[1];

          /* End of Outputs for SubSystem: '<S7>/Start' */
          sixstep_f28069mLaunchPad_open_B.Data_fw[1] = u0;
           ...
           *  SignalConversion generated from: '<S38>/Data_out'
           */
          sixstep_f28069mLaunchPad_open_B.SCI_Tx_Data[2] = u0;

          /* Merge: '<S7>/Merge1' incorporates:
           *  Bias: '<S38>/Bias'
           */
          sixstep_f28069mLaunchPad_open_B.SCI_Tx_Iteration =
            sixstep_f28069mLaunchPad_ConstB.Width + 1U;

          /* End of Outputs for SubSystem: '<S7>/Start' */
        } else if (sixstep_f28069mLaunchPad_open_B.Output == 599U) {
          ...
          sixstep_f28069mLaunchPad_open_B.Data_f[0] = u0;
           ...
           */
          sixstep_f28069mLaunchPad_open_B.SCI_Tx_Data[0] = u0;

          /* SignalConversion generated from: '<S37>/Data' */
          u0 = sixstep_f28069mLaunchPad_open_B.DataTypeConversion1_h[1];

          /* End of Outputs for SubSystem: '<S7>/End' */
          sixstep_f28069mLaunchPad_open_B.Data_f[1] = u0;
           ...
           */
          sixstep_f28069mLaunchPad_open_B.SCI_Tx_Data[1] = u0;
          sixstep_f28069mLaunchPad_open_B.SCI_Tx_Data[2] = 17733U;
          ...
          sixstep_f28069mLaunchPad_open_B.Data[0] = u0;
          ...
          /* End of Outputs for SubSystem: '<S7>/Data' */
          sixstep_f28069mLaunchPad_open_B.Data[1] = u0;
           ...
           */
          sixstep_f28069mLaunchPad_open_B.SCI_Tx_Data[1] = u0;
          sixstep_f28069mLaunchPad_open_B.SCI_Tx_Data[2] = 0U;
        ...
        i = 1;
        do {
          sixstep_f28069mLaunchPad_open_B.WhileIterator = i;
          sixstep_f28069mLaunchPad_open_B.IndexVector =
            sixstep_f28069mLaunchPad_open_B.SCI_Tx_Data[sixstep_f28069mLaunchPad_open_B.WhileIterator
            - 1];

          {
            if (checkSCITransmitInProgressA != 1U) {
              ...
              errFlgData = scia_xmit((unsigned char*)
                &sixstep_f28069mLaunchPad_open_B.IndexVector, 2, 2);
              checkSCITransmitInProgressA = 0U;
            }
          }

          sixstep_f28069mLaunchPad_open_B.Add_g =
            sixstep_f28069mLaunchPad_open_B.SCI_Tx_Iteration - (uint16_T)
            sixstep_f28069mLaunchPad_open_B.WhileIterator;
          i++;
        } while (sixstep_f28069mLaunchPad_open_B.Add_g != 0U);
         ...
         */
        sixstep_f28069mLaunchPad_open_B.FixPtSum1 =
          sixstep_f28069mLaunchPad_open_B.Output + 1U;

        /* Switch: '<S40>/FixPt Switch' */
        if (sixstep_f28069mLaunchPad_open_B.FixPtSum1 > 599U) {
          /* Switch: '<S40>/FixPt Switch' incorporates:
           *  Constant: '<S40>/Constant'
           */
          sixstep_f28069mLaunchPad_open_B.FixPtSwitch = 0U;
        } else {
          /* Switch: '<S40>/FixPt Switch' */
          sixstep_f28069mLaunchPad_open_B.FixPtSwitch =
            sixstep_f28069mLaunchPad_open_B.FixPtSum1;
        }
