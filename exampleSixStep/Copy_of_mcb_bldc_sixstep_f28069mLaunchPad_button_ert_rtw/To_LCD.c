...
void Copy_of_mcb_bld_To_LCD_Init(rtB_To_LCD_Copy_of_mcb_bldc_six *localB)
{
...
void Copy_of_mcb_bldc_six_To_LCD(const real32_T *rtd_speedSCI_B,
  ...
  *localDW)
{
   ...
   *  WhileIterator: '<S201>/While Iterator'
   */
  s201_iter = 1;
  do {
  ...
  /* Update for UnitDelay: '<S206>/Output' */
