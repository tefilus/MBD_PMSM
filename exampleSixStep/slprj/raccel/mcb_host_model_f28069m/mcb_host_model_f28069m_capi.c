...
static const rtwCAPI_Signals rtBlockSignals [ ] = { { 0 , 0 , TARGET_STRING (
 "mcb_host_model_f28069m/Serial Communication/MATLAB Function/is_active_c3_mcb_host_model_f28069m"
) , TARGET_STRING ( "is_active_c3_mcb_host_model_f28069m" ) , 0 , 0 , 0 , 0 ,
0 } , { 1 , 0 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Speed demand (RPM)" ) ,
TARGET_STRING ( "" ) , 0 , 1 , 0 , 0 , 0 } , { 2 , 0 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Gain" ) , TARGET_STRING (
"Speed (PU)" ) , 0 , 1 , 0 , 0 , 0 } , { 3 , 0 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Gain1" ) , TARGET_STRING (
"Speed (RPM)" ) , 0 , 1 , 1 , 0 , 0 } , { 4 , 4 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Median Filter" ) , TARGET_STRING
( "" ) , 0 , 1 , 2 , 0 , 0 } , { 0 , 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0
, 0 } } ; static const rtwCAPI_BlockParameters rtBlockParameters [ ] = { { 5
, TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Motor Start // Stop" ) ,
TARGET_STRING ( "Value" ) , 1 , 0 , 0 } , { 6 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Speed demand (RPM)" ) ,
TARGET_STRING ( "Value" ) , 1 , 0 , 0 } , { 7 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Gain" ) , TARGET_STRING ( "Gain"
) , 1 , 0 , 0 } , { 8 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Gain1" ) , TARGET_STRING (
"Gain" ) , 1 , 0 , 0 } , { 9 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Gain2" ) , TARGET_STRING (
"Gain" ) , 1 , 0 , 0 } , { 10 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Unit Delay" ) , TARGET_STRING (
"InitialCondition" ) , 1 , 0 , 0 } , { 11 , TARGET_STRING (
"mcb_host_model_f28069m/Serial Communication/Unit Delay1" ) , TARGET_STRING (
"InitialCondition" ) , 1 , 0 , 0 } , { 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 }
...
static void * rtDataAddrMap [ ] = { & rtDW . itd3yklner , & rtB . fv2hmrzenm
, & rtB . jxqsgorstp , & rtB . ikgm14ejw2 [ 0 ] , & rtB . nw0sbkamir [ 0 ] ,
...
, rtDimensionArray } , "float" , { 743607247U , 2599999071U , 172209083U ,
875051970U } , ( NULL ) , 0 , ( boolean_T ) 0 , rt_LoggedStateIdxList } ;
const rtwCAPI_ModelMappingStaticInfo *
mcb_host_model_f28069m_GetCAPIStaticMap ( void ) { return & mmiStatic ; }
#ifndef HOST_CAPI_BUILD
void mcb_host_model_f28069m_InitializeDataMapInfo ( void ) {
