...
#include "Copy_of_mcb_host_model_f28069m_dt.h"
...
model_S ; static void ii514olh2i ( kxhgzsud0w * * pEmxArray , int32_T
numDimensions ) ; static void mnmu4or4it ( dkgmwniqkw * * pEmxArray , int32_T
numDimensions ) ; static void n3xnmwkn3j ( escf2nogrs * pStruct ) ; static
void fefajt5km0 ( lz2r3kxmyl * pStruct ) ; static void mg4ynbai1k (
lydzjepctw * pStruct ) ; static void fefajt5km02 ( nd1ykmemr0 * pStruct ) ;
static void ovtkkflsbr ( jlr2oc3akq * pStruct ) ; static void afehf3ozac (
ay3g115f1i * pStruct ) ; static void o3mnz0yuxu ( kxhgzsud0w * emxArray ,
int32_T oldNumel ) ; static void mxcdmm1lza ( const char_T in [ 4096 ] ,
char_T out_data [ ] , int32_T out_size [ 2 ] ) ; static void gkew4wu3pw (
kxhgzsud0w * * pEmxArray ) ; static void fgsydcr0gf ( dkgmwniqkw * emxArray ,
int32_T oldNumel ) ; static real_T clr3ajxix0 ( jlr2oc3akq * obj ) ; static
void f1mkyd4ecj ( jlr2oc3akq * obj , lydzjepctw * iobj_0 , nd1ykmemr0 *
iobj_1 ) ; static boolean_T pv5og4xv2t ( jlr2oc3akq * obj ) ; static
boolean_T djcnyk5csz ( jlr2oc3akq * obj ) ; static void dmpp4pm0lv (
jlr2oc3akq * obj ) ; static void mthjxpxvqr ( ay3g115f1i * obj ) ; static
void n3xnmwkn3j2 ( escf2nogrso * pStruct ) ; static void fefajt5km02r (
lz2r3kxmyld * pStruct ) ; static void mg4ynbai1k3 ( lydzjepctwj * pStruct ) ;
static void fefajt5km02r0 ( nd1ykmemr0w * pStruct ) ; static void ovtkkflsbr0
( jlr2oc3akq1 * pStruct ) ; static void nze024knzp ( pzfkkiwufc * pStruct ) ;
static real_T clr3ajxix0q ( jlr2oc3akq1 * obj ) ; static void ipykpg1fst (
dkgmwniqkw * * pEmxArray ) ; static void f1mkyd4ecjj ( jlr2oc3akq1 * obj ,
lydzjepctwj * iobj_0 , nd1ykmemr0w * iobj_1 ) ; static boolean_T pv5og4xv2t1
( jlr2oc3akq1 * obj ) ; static boolean_T djcnyk5csz5 ( jlr2oc3akq1 * obj ) ;
static void dmpp4pm0lvf ( jlr2oc3akq1 * obj ) ; static void mthjxpxvqrf (
pzfkkiwufc * obj ) ; static void fefajt5km02r0x ( lz2r3kxmyldm * pStruct ) ;
static void mg4ynbai1k3u ( lydzjepctwjv * pStruct ) ; static void
fefajt5km02r0xf ( nd1ykmemr0wc * pStruct ) ; static void ovtkkflsbr0u (
jlr2oc3akq1q * pStruct ) ; static void ei413zhxgv ( i4q10my5ye * pStruct ) ;
static real_T clr3ajxix0qu ( jlr2oc3akq1q * obj ) ; static void f1mkyd4ecjj3
( jlr2oc3akq1q * obj , lydzjepctwjv * iobj_0 , nd1ykmemr0wc * iobj_1 ) ;
static boolean_T pv5og4xv2t1b ( jlr2oc3akq1q * obj ) ; static boolean_T
djcnyk5csz50 ( jlr2oc3akq1q * obj ) ; static void dmpp4pm0lvff ( jlr2oc3akq1q
* obj ) ; static void mthjxpxvqrfb ( i4q10my5ye * obj ) ; static void
mscqpmuvwk ( m5lryued4q * obj ) ; static void gyaetsztlv ( real_T
newTime_tv_sec , real_T newTime_tv_nsec ) ; static void cgzq2cxjix ( void ) ;
static void bkrg4vfz1n ( l3r0seotmm * * pEmxArray , int32_T numDimensions ) ;
static void gyaetsztlv1 ( real_T * outTime_tv_sec , real_T * outTime_tv_nsec
) ; static real_T extq512hka ( void ) ; static void odrsct0bpa ( const
dkgmwniqkw * packet , real_T startIndex , real_T endIndex , dkgmwniqkw *
result ) ; static void odrsct0bpak ( const dkgmwniqkw * packet , real_T
endIndex , dkgmwniqkw * result ) ; static void nvre0b1z5s ( go2up1egww * *
pEmxArray , int32_T numDimensions ) ; static void cgzq2cxjix0 ( real_T *
tstart_tv_sec , real_T * tstart_tv_nsec ) ; static boolean_T f2ixltgxku (
const char_T a_data [ ] , const int32_T a_size [ 2 ] ) ; static void
egjz3gjn44 ( fvknachgjd * pStruct ) ; static void fmgpjv2w42 ( go2up1egww *
emxArray , int32_T fromIndex , int32_T toIndex ) ; static void hnvmc54gzx (
fvknachgjd * pStruct ) ; static void lc413233ol ( go2up1egww * emxArray ,
int32_T fromIndex , int32_T toIndex ) ; static void l3hnsgnz1r ( go2up1egww *
emxArray , int32_T oldNumel ) ; static void f5chb1ochr ( const escf2nogrso *
obj , real_T countRequested , go2up1egww * packets , real_T * countRead ) ;
static boolean_T f2ixltgxkug ( const char_T a_data [ ] , const int32_T a_size
[ 2 ] ) ; static boolean_T f2ixltgxkug5 ( const char_T a_data [ ] , const
int32_T a_size [ 2 ] ) ; static real_T extq512hkas ( real_T tstart_tv_sec ,
real_T tstart_tv_nsec ) ; static void bi1gsurois ( go2up1egww * * pEmxArray )
; static void kzunah5v3t ( escf2nogrso * obj , real_T countRequested ,
dkgmwniqkw * data , real_T * countRead , char_T err_data [ ] , int32_T
err_size [ 2 ] ) ; static void c5bguvf3do ( hkhkhom4xnj * pStruct ) ; static
void psnvefdcio ( ij0jf0t5ac * pEmxArray ) ; static void p4eqyxqrgu ( const
cj5bbeqbeda * obj , char_T status_data [ ] , int32_T status_size [ 2 ] ) ;
static void gx43grnn1n ( hkhkhom4xnj * data , int32_T fromIndex , int32_T
toIndex ) ; static void hmdk4nt3r0 ( hkhkhom4xnj * pStruct ) ; static void
j4kwcei1n4 ( hkhkhom4xnj * data , int32_T fromIndex , int32_T toIndex ) ;
static void bskbtgr1u1 ( hkhkhom4xnj * data , const int32_T * size , int32_T
oldNumel ) ; static void lnzocciadk ( dkgmwniqkw * * dst , dkgmwniqkw * const
* src ) ; static void b5o2xwrvus ( hkhkhom4xnj * dst , const hkhkhom4xnj *
src ) ; static void hq0ez5t5pc ( ij0jf0t5ac * pEmxArray ) ; static void
gxaefduqug ( lz2r3kxmyld * obj , const dkgmwniqkw * data ) ; static real_T
e5xq51aq1e ( const lz2r3kxmyld * obj ) ; static void nonfr50pcl ( const
lz2r3kxmyld * obj , real_T startIndex , real_T endIndex , dkgmwniqkw * result
) ; static void kzunah5v3td ( escf2nogrso * obj , real_T countRequested ,
dkgmwniqkw * data ) ; static void fhn3hzw3ov ( lz2r3kxmyld * obj , real_T
numBytesToRead , dkgmwniqkw * data ) ; static void cng4zbur03 ( l3r0seotmm *
emxArray , int32_T oldNumel ) ; static void irqghwolva ( avy5t05fil * *
pEmxArray , int32_T numDimensions ) ; static void lcukdzp42v ( lydzjepctwj *
obj , char_T status_data [ ] , int32_T status_size [ 2 ] ) ; static void
mso5evj0k4 ( coadmtcrth * pEmxArray ) ; static void adhv3xzbyc ( fvknachgjd *
data , int32_T fromIndex , int32_T toIndex ) ; static void imk1yc2wkx (
fvknachgjd * data , int32_T fromIndex , int32_T toIndex ) ; static void
ndz1kh5at3 ( fvknachgjd * data , const int32_T * size , int32_T oldNumel ) ;
static void hxo3e04w4s ( fvknachgjd * dst , const fvknachgjd * src ) ; static
void nelzqkwogp ( coadmtcrth * pEmxArray ) ; static void gxaefduqug4 (
lz2r3kxmyld * obj , const dkgmwniqkw * data ) ; static void cuhbleb0ur (
l3r0seotmm * * pEmxArray ) ; static void gcl3jfecc3 ( jlr2oc3akq1 *
varargin_1 ) ; static void ar3bsdqspf ( lydzjepctwj * obj , real_T numToRead
, dkgmwniqkw * data ) ; static void bfpfrm3zav ( jlr2oc3akq1 * varargin_1 ,
dkgmwniqkw * data ) ; static void mzzf3byge3 ( avy5t05fil * emxArray ,
int32_T oldNumel ) ; static void hkxf0y2w3t ( avy5t05fil * * pEmxArray ) ;
static void bzz10kv3ft ( m5lryued4q * obj , real32_T i ) ; static void
aqjmcdusnj ( m5lryued4q * obj , real32_T i ) ; static void cgzq2cxjix0x (
real_T * tstart_tv_sec , real_T * tstart_tv_nsec ) ; static real_T
extq512hkasr ( real_T tstart_tv_sec , real_T tstart_tv_nsec ) ; static void
elcxa00vnt ( jlr2oc3akq1q * varargin_1 , const uint8_T varargin_2 [ 4 ] ) ;
static void a1z4odhlh0 ( const nd1ykmemr0 * obj ) ; static void a1z4odhlh0k (
const lz2r3kxmyl * obj ) ; static void hgxr25txlz ( escf2nogrs * pStruct ) ;
static void n4qs3gh3ji ( lz2r3kxmyl * pStruct ) ; static void gt02sxkqg0 (
lydzjepctw * pStruct ) ; static void n4qs3gh3jir ( nd1ykmemr0 * pStruct ) ;
static void lr3h3inwym ( jlr2oc3akq * pStruct ) ; static void n5frfhages (
ay3g115f1i * pStruct ) ; static void a1z4odhlh0kh ( const nd1ykmemr0w * obj )
; static void a1z4odhlh0khx ( lz2r3kxmyld * obj ) ; static void hgxr25txlzb (
escf2nogrso * pStruct ) ; static void n4qs3gh3jira ( lz2r3kxmyld * pStruct )
; static void gt02sxkqg0h ( lydzjepctwj * pStruct ) ; static void
n4qs3gh3jirak ( nd1ykmemr0w * pStruct ) ; static void lr3h3inwymb (
jlr2oc3akq1 * pStruct ) ; static void k1usf3tvuh ( pzfkkiwufc * pStruct ) ;
static void a1z4odhlh0khxk ( const nd1ykmemr0wc * obj ) ; static void
a1z4odhlh0khxk3 ( const lz2r3kxmyldm * obj ) ; static void n4qs3gh3jirako (
lz2r3kxmyldm * pStruct ) ; static void gt02sxkqg0hn ( lydzjepctwjv * pStruct
) ; static void n4qs3gh3jirakod ( nd1ykmemr0wc * pStruct ) ; static void
lr3h3inwymbk ( jlr2oc3akq1q * pStruct ) ; static void du3caa3v4d ( i4q10my5ye
* pStruct ) ; static void ii514olh2i ( kxhgzsud0w * * pEmxArray , int32_T
numDimensions ) { kxhgzsud0w * emxArray ; int32_T i ; * pEmxArray = (
kxhgzsud0w * ) malloc ( sizeof ( kxhgzsud0w ) ) ; emxArray = * pEmxArray ;
...
size [ i ] = 0 ; } } static void mnmu4or4it ( dkgmwniqkw * * pEmxArray ,
int32_T numDimensions ) { dkgmwniqkw * emxArray ; int32_T i ; * pEmxArray = (
dkgmwniqkw * ) malloc ( sizeof ( dkgmwniqkw ) ) ; emxArray = * pEmxArray ;
emxArray -> data = ( uint8_T * ) NULL ; emxArray -> numDimensions =
numDimensions ; emxArray -> size = ( int32_T * ) malloc ( sizeof ( int32_T )
* ( uint32_T ) numDimensions ) ; emxArray -> allocatedSize = 0 ; emxArray ->
canFreeData = true ; for ( i = 0 ; i < numDimensions ; i ++ ) { emxArray ->
size [ i ] = 0 ; } } static void n3xnmwkn3j ( escf2nogrs * pStruct ) {
mnmu4or4it ( & pStruct -> ExampleData , 2 ) ; } static void fefajt5km0 (
lz2r3kxmyl * pStruct ) { n3xnmwkn3j ( & pStruct -> InputStream ) ; } static
void mg4ynbai1k ( lydzjepctw * pStruct ) { fefajt5km0 ( & pStruct ->
UnreadDataBuffer ) ; ii514olh2i ( & pStruct -> ByteOrder , 2 ) ; } static
void fefajt5km02 ( nd1ykmemr0 * pStruct ) { n3xnmwkn3j ( & pStruct ->
InputStream ) ; } static void ovtkkflsbr ( jlr2oc3akq * pStruct ) {
ii514olh2i ( & pStruct -> ByteOrder , 2 ) ; ii514olh2i ( & pStruct ->
NativeDataType , 2 ) ; ii514olh2i ( & pStruct -> DataFieldName , 2 ) ;
ii514olh2i ( & pStruct -> Port , 2 ) ; ii514olh2i ( & pStruct -> FlowControl
, 2 ) ; ii514olh2i ( & pStruct -> Parity , 2 ) ; mg4ynbai1k ( & pStruct ->
_pobj0 ) ; fefajt5km02 ( & pStruct -> _pobj1 ) ; } static void afehf3ozac (
ay3g115f1i * pStruct ) { ovtkkflsbr ( & pStruct -> SerialObj ) ; } static
void o3mnz0yuxu ( kxhgzsud0w * emxArray , int32_T oldNumel ) { int32_T i ;
...
mxcdmm1lza ( const char_T in [ 4096 ] , char_T out_data [ ] , int32_T
...
sizeof ( char_T ) ) ; } } static void gkew4wu3pw ( kxhgzsud0w * * pEmxArray )
{ if ( * pEmxArray != ( kxhgzsud0w * ) NULL ) { if ( ( ( * pEmxArray ) ->
data != ( char_T * ) NULL ) && ( * pEmxArray ) -> canFreeData ) { free ( ( *
pEmxArray ) -> data ) ; } free ( ( * pEmxArray ) -> size ) ; free ( *
pEmxArray ) ; * pEmxArray = ( kxhgzsud0w * ) NULL ; } } static void
fgsydcr0gf ( dkgmwniqkw * emxArray , int32_T oldNumel ) { int32_T i ; int32_T
...
clr3ajxix0 ( jlr2oc3akq * obj ) { CoderChannel chImpl ; nd1ykmemr0 * obj_p ;
...
static void f1mkyd4ecj ( jlr2oc3akq * obj , lydzjepctw * iobj_0 , nd1ykmemr0
* iobj_1 ) { CoderChannel chImpl ; CoderInputStream streamImpl ;
CoderOutputStream streamImpl_p ; kxhgzsud0w * b ; kxhgzsud0w *
options_ServiceName ; lydzjepctw * obj_p ; nd1ykmemr0 * channel ; real_T e [
2 ] ; real_T f [ 2 ] ; real_T varargin_8 [ 2 ] ; int32_T loop_ub ; int32_T
success ; char_T deviceFullPath_data [ 4096 ] ; char_T devicePlugin_data [
4096 ] ; char_T localAbsPath [ 4096 ] ; char_T errorID [ 1024 ] ; char_T
errorText [ 1024 ] ; char_T d [ 4 ] ; char_T g [ 4 ] ; boolean_T hasSyncError
; boolean_T result ; static const jr22y2uzoh tmp = { true , true , true ,
true , true , 0.0 , 0ULL } ; static const char_T tmp_p [ 13 ] = { 'l' , 'i' ,
't' , 't' , 'l' , 'e' , '-' , 'e' , 'n' , 'd' , 'i' , 'a' , 'n' } ; int32_T
deviceFullPath_size [ 2 ] ; int32_T converterPlugin_size_idx_1 ; ii514olh2i (
& options_ServiceName , 2 ) ; success = options_ServiceName -> size [ 0 ] *
options_ServiceName -> size [ 1 ] ; options_ServiceName -> size [ 0 ] = 1 ;
options_ServiceName -> size [ 1 ] = obj -> Port -> size [ 1 ] ; o3mnz0yuxu (
options_ServiceName , success ) ; loop_ub = obj -> Port -> size [ 1 ] ; for (
success = 0 ; success < loop_ub ; success ++ ) { options_ServiceName -> data
[ success ] = obj -> Port -> data [ success ] ; } coderComputeAbsolutePath (
"serialdevice.dll" , & localAbsPath [ 0 ] ) ; mxcdmm1lza ( localAbsPath ,
...
, & localAbsPath [ 0 ] ) ; mxcdmm1lza ( localAbsPath , deviceFullPath_data ,
...
"serialcoderconverter.dll" , & localAbsPath [ 0 ] ) ; mxcdmm1lza (
...
= iobj_1 -> ChannelImpl ; ii514olh2i ( & b , 2 ) ; if ( options_ServiceName
-> size [ 1 ] == 1 ) { success = b -> size [ 0 ] * b -> size [ 1 ] ; b ->
size [ 0 ] = 1 ; b -> size [ 1 ] = 2 ; o3mnz0yuxu ( b , success ) ; b -> data
...
size [ 1 ] ; o3mnz0yuxu ( b , success ) ; loop_ub = options_ServiceName ->
...
, & f [ 0 ] , "FlowControl" , "char" , 4 , & g [ 0 ] ) ; gkew4wu3pw ( & b ) ;
gkew4wu3pw ( & options_ServiceName ) ; if ( success == 0 ) {
coderChannelHasSyncError ( chImpl , & hasSyncError ) ; if ( ! hasSyncError )
{ coderChannelGetLastError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ;
} else { coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , &
...
1 ] = 1 ; fgsydcr0gf ( iobj_1 -> InputStream . ExampleData , success ) ;
...
-> IsSharingExistingTimeout ) ) { clr3ajxix0 ( obj ) ; } channel = obj ->
...
o3mnz0yuxu ( iobj_0 -> ByteOrder , success ) ; for ( success = 0 ; success <
13 ; success ++ ) { iobj_0 -> ByteOrder -> data [ success ] = tmp_p [ success
] ; } coderComputeAbsolutePath ( "buffer.dll" , & localAbsPath [ 0 ] ) ;
mxcdmm1lza ( localAbsPath , deviceFullPath_data , deviceFullPath_size ) ; if
...
devicePlugin_data [ 0 ] , & deviceFullPath_data [ 0 ] , ( uint32_T ) loop_ub
* sizeof ( char_T ) ) ; } else { success = 0 ; } } coderComputeAbsolutePath (
"buffercoderconverter.dll" , & localAbsPath [ 0 ] ) ; mxcdmm1lza (
localAbsPath , deviceFullPath_data , deviceFullPath_size ) ; if (
deviceFullPath_size [ 1 ] != 0 ) { converterPlugin_size_idx_1 =
deviceFullPath_size [ 1 ] ; loop_ub = deviceFullPath_size [ 1 ] ; memcpy ( &
localAbsPath [ 0 ] , & deviceFullPath_data [ 0 ] , ( uint32_T ) loop_ub *
...
UnreadDataBuffer . InputStream . ExampleData -> size [ 1 ] = 1 ; fgsydcr0gf (
...
13 ; o3mnz0yuxu ( obj_p -> ByteOrder , success ) ; for ( success = 0 ;
success < 13 ; success ++ ) { obj_p -> ByteOrder -> data [ success ] = tmp_p
[ success ] ; } } static boolean_T pv5og4xv2t ( jlr2oc3akq * obj ) {
CoderChannel chImpl ; nd1ykmemr0 * obj_p ; int32_T success ; char_T errorID [
...
errorText [ 0 ] ) ; } } return b_value ; } static boolean_T djcnyk5csz (
jlr2oc3akq * obj ) { CoderChannel chImpl ; nd1ykmemr0 * obj_p ; int32_T
...
& errorID [ 0 ] , & errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } } return b_value ; }
static void dmpp4pm0lv ( jlr2oc3akq * obj ) { CoderChannel chImpl ;
kxhgzsud0w * b ; kxhgzsud0w * d ; kxhgzsud0w * g ; kxhgzsud0w *
options_FlowControl ; kxhgzsud0w * options_Parity ; kxhgzsud0w *
options_ServiceName ; lydzjepctw * obj_e ; nd1ykmemr0 * obj_p ; real_T c [ 2
] ; real_T e [ 2 ] ; real_T f [ 2 ] ; real_T out ; real_T out_e ; real_T
out_p ; int32_T b_kstr ; int32_T success ; char_T errorID [ 1024 ] ; char_T
errorText [ 1024 ] ; char_T b_b [ 13 ] ; boolean_T h [ 2 ] ; boolean_T i [ 2
] ; boolean_T j [ 2 ] ; boolean_T hasSyncError ; boolean_T
options_IsSharingExistingTimeout ; boolean_T options_IsSharingPort ;
boolean_T options_IsWriteOnly ; boolean_T result ; static const char_T tmp [
13 ] = { 'l' , 'i' , 't' , 't' , 'l' , 'e' , '-' , 'e' , 'n' , 'd' , 'i' ,
'a' , 'n' } ; static const char_T tmp_p [ 128 ] = { '\x00' , '\x01' , '\x02'
, '\x03' , '\x04' , '\x05' , '\x06' , '\a' , '\b' , '\t' , '\n' , '\v' , '\f'
...
, 'v' , 'w' , 'x' , 'y' , 'z' , '{' , '|' , '}' , '~' , '\x7f' } ; static
const char_T tmp_e [ 10 ] = { 'b' , 'i' , 'g' , '-' , 'e' , 'n' , 'd' , 'i' ,
'a' , 'n' } ; int32_T exitg1 ; boolean_T guard1 ; obj_p = obj ->
...
; } } ii514olh2i ( & options_ServiceName , 2 ) ; b_kstr = options_ServiceName
-> size [ 0 ] * options_ServiceName -> size [ 1 ] ; options_ServiceName ->
size [ 0 ] = 1 ; options_ServiceName -> size [ 1 ] = obj -> Port -> size [ 1
] ; o3mnz0yuxu ( options_ServiceName , b_kstr ) ; success = obj -> Port ->
size [ 1 ] ; for ( b_kstr = 0 ; b_kstr < success ; b_kstr ++ ) {
options_ServiceName -> data [ b_kstr ] = obj -> Port -> data [ b_kstr ] ; }
out = obj -> BaudRate ; ii514olh2i ( & options_Parity , 2 ) ; b_kstr =
options_Parity -> size [ 0 ] * options_Parity -> size [ 1 ] ; options_Parity
-> size [ 0 ] = 1 ; options_Parity -> size [ 1 ] = obj -> Parity -> size [ 1
] ; o3mnz0yuxu ( options_Parity , b_kstr ) ; success = obj -> Parity -> size
[ 1 ] ; for ( b_kstr = 0 ; b_kstr < success ; b_kstr ++ ) { options_Parity ->
data [ b_kstr ] = obj -> Parity -> data [ b_kstr ] ; } out_p = obj ->
StopBits ; out_e = obj -> DataBits ; ii514olh2i ( & options_FlowControl , 2 )
; b_kstr = options_FlowControl -> size [ 0 ] * options_FlowControl -> size [
1 ] ; options_FlowControl -> size [ 0 ] = 1 ; options_FlowControl -> size [ 1
] = obj -> FlowControl -> size [ 1 ] ; o3mnz0yuxu ( options_FlowControl ,
b_kstr ) ; success = obj -> FlowControl -> size [ 1 ] ; for ( b_kstr = 0 ;
b_kstr < success ; b_kstr ++ ) { options_FlowControl -> data [ b_kstr ] = obj
-> FlowControl -> data [ b_kstr ] ; } options_IsWriteOnly = obj ->
IsWriteOnly ; options_IsSharingPort = obj -> IsSharingPort ;
options_IsSharingExistingTimeout = obj -> IsSharingExistingTimeout ; obj_p =
obj -> AsyncIOChannel ; chImpl = obj_p -> ChannelImpl ; success =
coderChannelIsOpen ( chImpl , & result ) ; if ( success == 0 ) {
coderChannelHasSyncError ( chImpl , & hasSyncError ) ; if ( ! hasSyncError )
{ coderChannelGetLastError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ;
} else { coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , &
errorText [ 0 ] ) ; } } if ( ! result ) { chImpl = obj_p -> ChannelImpl ;
ii514olh2i ( & b , 2 ) ; if ( options_ServiceName -> size [ 1 ] == 1 ) {
b_kstr = b -> size [ 0 ] * b -> size [ 1 ] ; b -> size [ 0 ] = 1 ; b -> size
[ 1 ] = 2 ; o3mnz0yuxu ( b , b_kstr ) ; b -> data [ 0 ] = options_ServiceName
-> data [ 0 ] ; b -> data [ 1 ] = options_ServiceName -> data [ 0 ] ; } else
{ b_kstr = b -> size [ 0 ] * b -> size [ 1 ] ; b -> size [ 0 ] = 1 ; b ->
size [ 1 ] = options_ServiceName -> size [ 1 ] ; o3mnz0yuxu ( b , b_kstr ) ;
success = options_ServiceName -> size [ 1 ] ; if ( success - 1 >= 0 ) {
memcpy ( & b -> data [ 0 ] , & options_ServiceName -> data [ 0 ] , ( uint32_T
) success * sizeof ( char_T ) ) ; } } ii514olh2i ( & d , 2 ) ; if (
options_Parity -> size [ 1 ] == 1 ) { b_kstr = d -> size [ 0 ] * d -> size [
1 ] ; d -> size [ 0 ] = 1 ; d -> size [ 1 ] = 2 ; o3mnz0yuxu ( d , b_kstr ) ;
...
; o3mnz0yuxu ( d , b_kstr ) ; success = options_Parity -> size [ 1 ] ; if (
success - 1 >= 0 ) { memcpy ( & d -> data [ 0 ] , & options_Parity -> data [
0 ] , ( uint32_T ) success * sizeof ( char_T ) ) ; } } ii514olh2i ( & g , 2 )
; if ( options_FlowControl -> size [ 1 ] == 1 ) { b_kstr = g -> size [ 0 ] *
g -> size [ 1 ] ; g -> size [ 0 ] = 1 ; g -> size [ 1 ] = 2 ; o3mnz0yuxu ( g
...
options_FlowControl -> size [ 1 ] ; o3mnz0yuxu ( g , b_kstr ) ; success =
...
"logical" , 1 , & j [ 0 ] ) ; gkew4wu3pw ( & g ) ; gkew4wu3pw ( & d ) ;
gkew4wu3pw ( & b ) ; if ( success == 0 ) { coderChannelHasSyncError ( chImpl
, & hasSyncError ) ; if ( ! hasSyncError ) { coderChannelGetLastError (
chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] )
; } } } gkew4wu3pw ( & options_FlowControl ) ; gkew4wu3pw ( & options_Parity
) ; if ( obj -> IsSharingPort && ( ! obj -> IsSharingExistingTimeout ) &&
djcnyk5csz ( obj ) ) { out = clr3ajxix0 ( obj ) ; obj_p = obj ->
AsyncIOChannel ; chImpl = obj_p -> ChannelImpl ; success = coderChannelIsOpen
( chImpl , & result ) ; if ( success == 0 ) { coderChannelHasSyncError (
chImpl , & hasSyncError ) ; if ( ! hasSyncError ) { coderChannelGetLastError
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
...
while ( exitg1 == 0 ) ; } gkew4wu3pw ( & options_ServiceName ) ; if ( result
...
o3mnz0yuxu ( obj_e -> ByteOrder , b_kstr ) ; success -- ; for ( b_kstr = 0 ;
b_kstr <= success ; b_kstr ++ ) { obj_e -> ByteOrder -> data [ b_kstr ] = b_b
[ b_kstr ] ; } } static void mthjxpxvqr ( ay3g115f1i * obj ) { CoderChannel
chImpl ; kxhgzsud0w * out ; lydzjepctw * obj_e ; nd1ykmemr0 * obj_p ; real_T
...
pv5og4xv2t ( & obj -> SerialObj ) ) { obj_p = obj -> SerialObj .
...
[ 0 ] ) ; } } } obj -> SerialObj . DataBits = 8.0 ; if ( pv5og4xv2t ( & obj
...
o3mnz0yuxu ( obj -> SerialObj . Parity , success ) ; obj -> SerialObj .
Parity -> data [ 0 ] = 'n' ; obj -> SerialObj . Parity -> data [ 1 ] = 'o' ;
obj -> SerialObj . Parity -> data [ 2 ] = 'n' ; obj -> SerialObj . Parity ->
data [ 3 ] = 'e' ; if ( pv5og4xv2t ( & obj -> SerialObj ) ) { obj_p = obj ->
...
errorText [ 0 ] ) ; } } } obj -> SerialObj . StopBits = 1.0 ; if ( pv5og4xv2t
...
FlowControl -> size [ 1 ] = 4 ; o3mnz0yuxu ( obj -> SerialObj . FlowControl ,
...
0 ] = 1 ; obj_e -> ByteOrder -> size [ 1 ] = 13 ; o3mnz0yuxu ( obj_e ->
...
0 ; obj_e = obj -> SerialObj . TransportChannel ; ii514olh2i ( & out , 2 ) ;
success = out -> size [ 0 ] * out -> size [ 1 ] ; out -> size [ 0 ] = 1 ; out
-> size [ 1 ] = obj_e -> ByteOrder -> size [ 1 ] ; o3mnz0yuxu ( out , success
...
] ; o3mnz0yuxu ( obj -> SerialObj . ByteOrder , success ) ; loop_ub = out ->
size [ 1 ] - 1 ; for ( success = 0 ; success <= loop_ub ; success ++ ) { obj
-> SerialObj . ByteOrder -> data [ success ] = out -> data [ success ] ; }
gkew4wu3pw ( & out ) ; if ( ! obj -> SerialObj . IsSharingExistingTimeout ) {
...
[ 0 ] = 1 ; obj -> SerialObj . NativeDataType -> size [ 1 ] = 5 ; o3mnz0yuxu
...
SerialObj . DataFieldName -> size [ 1 ] = 4 ; o3mnz0yuxu ( obj -> SerialObj .
...
dmpp4pm0lv ( & obj -> SerialObj ) ; djcnyk5csz ( & obj -> SerialObj ) ; obj
-> isSetupComplete = true ; } static void n3xnmwkn3j2 ( escf2nogrso * pStruct
) { mnmu4or4it ( & pStruct -> PartialPacket , 2 ) ; mnmu4or4it ( & pStruct ->
ExampleData , 2 ) ; } static void fefajt5km02r ( lz2r3kxmyld * pStruct ) {
n3xnmwkn3j2 ( & pStruct -> InputStream ) ; mnmu4or4it ( & pStruct ->
PartialPacket , 2 ) ; } static void mg4ynbai1k3 ( lydzjepctwj * pStruct ) {
fefajt5km02r ( & pStruct -> UnreadDataBuffer ) ; ii514olh2i ( & pStruct ->
ByteOrder , 2 ) ; ii514olh2i ( & pStruct -> NativeDataType , 2 ) ; ii514olh2i
( & pStruct -> DataFieldName , 2 ) ; } static void fefajt5km02r0 (
nd1ykmemr0w * pStruct ) { n3xnmwkn3j2 ( & pStruct -> InputStream ) ; } static
void ovtkkflsbr0 ( jlr2oc3akq1 * pStruct ) { ii514olh2i ( & pStruct ->
ByteOrder , 2 ) ; ii514olh2i ( & pStruct -> NativeDataType , 2 ) ; ii514olh2i
( & pStruct -> DataFieldName , 2 ) ; ii514olh2i ( & pStruct -> Port , 2 ) ;
ii514olh2i ( & pStruct -> FlowControl , 2 ) ; ii514olh2i ( & pStruct ->
Parity , 2 ) ; mg4ynbai1k3 ( & pStruct -> _pobj0 ) ; fefajt5km02r0 ( &
pStruct -> _pobj1 ) ; } static void nze024knzp ( pzfkkiwufc * pStruct ) {
ovtkkflsbr0 ( & pStruct -> SerialObj ) ; } static real_T clr3ajxix0q (
jlr2oc3akq1 * obj ) { CoderChannel chImpl ; nd1ykmemr0w * obj_p ; real_T
...
& errorID [ 0 ] , & errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } } } return b_value ; }
static void ipykpg1fst ( dkgmwniqkw * * pEmxArray ) { if ( * pEmxArray != (
dkgmwniqkw * ) NULL ) { if ( ( ( * pEmxArray ) -> data != ( uint8_T * ) NULL
) && ( * pEmxArray ) -> canFreeData ) { free ( ( * pEmxArray ) -> data ) ; }
free ( ( * pEmxArray ) -> size ) ; free ( * pEmxArray ) ; * pEmxArray = (
dkgmwniqkw * ) NULL ; } } static void f1mkyd4ecjj ( jlr2oc3akq1 * obj ,
lydzjepctwj * iobj_0 , nd1ykmemr0w * iobj_1 ) { CoderChannel chImpl ;
CoderInputStream streamImpl ; CoderOutputStream streamImpl_p ; cj5bbeqbeda *
outputStream ; dkgmwniqkw * exampleData ; escf2nogrso * inputStream ;
kxhgzsud0w * b ; kxhgzsud0w * options_ServiceName ; lydzjepctwj * obj_p ;
nd1ykmemr0w * channel ; real_T e [ 2 ] ; real_T f [ 2 ] ; real_T varargin_8 [
2 ] ; real_T b_value ; int32_T loop_ub ; int32_T success ; char_T
...
static const jr22y2uzoh tmp = { true , true , true , true , true , 0.0 , 0ULL
...
converterPlugin_size_idx_1 ; ii514olh2i ( & options_ServiceName , 2 ) ;
success = options_ServiceName -> size [ 0 ] * options_ServiceName -> size [ 1
] ; options_ServiceName -> size [ 0 ] = 1 ; options_ServiceName -> size [ 1 ]
= obj -> Port -> size [ 1 ] ; o3mnz0yuxu ( options_ServiceName , success ) ;
...
ChannelImpl = chImpl ; chImpl = iobj_1 -> ChannelImpl ; ii514olh2i ( & b , 2
) ; if ( options_ServiceName -> size [ 1 ] == 1 ) { success = b -> size [ 0 ]
* b -> size [ 1 ] ; b -> size [ 0 ] = 1 ; b -> size [ 1 ] = 2 ; o3mnz0yuxu (
...
options_ServiceName -> size [ 1 ] ; o3mnz0yuxu ( b , success ) ; loop_ub =
...
gkew4wu3pw ( & b ) ; gkew4wu3pw ( & options_ServiceName ) ; if ( success == 0
...
if ( ( ! obj -> IsSharingPort ) || ( ! obj -> IsSharingExistingTimeout ) ) {
b_value = clr3ajxix0q ( obj ) ; outputStream = & obj -> AsyncIOChannel ->
...
] = 13 ; o3mnz0yuxu ( iobj_0 -> ByteOrder , success ) ; for ( success = 0 ;
...
0 ] = 1 ; iobj_0 -> DataFieldName -> size [ 1 ] = 4 ; o3mnz0yuxu ( iobj_0 ->
...
NativeDataType -> size [ 1 ] = 5 ; o3mnz0yuxu ( iobj_0 -> NativeDataType ,
...
"buffer.dll" , & localAbsPath [ 0 ] ) ; mxcdmm1lza ( localAbsPath ,
deviceFullPath_data , deviceFullPath_size ) ; if ( deviceFullPath_size [ 1 ]
!= 0 ) { success = deviceFullPath_size [ 1 ] ; loop_ub = deviceFullPath_size
[ 1 ] ; memcpy ( & devicePlugin_data [ 0 ] , & deviceFullPath_data [ 0 ] , (
uint32_T ) loop_ub * sizeof ( char_T ) ) ; } else { coderComputeAbsolutePath
...
InputStream . ExampleData -> size [ 1 ] = 1 ; fgsydcr0gf ( iobj_0 ->
...
fgsydcr0gf ( exampleData , success ) ; iobj_0 -> UnreadDataBuffer .
InputStream . PartialPacket -> size [ 0 ] = exampleData -> size [ 0 ] ;
ipykpg1fst ( & exampleData ) ; iobj_0 -> UnreadDataBuffer . InputStream .
...
size [ 1 ] = 5 ; o3mnz0yuxu ( obj_p -> NativeDataType , success ) ; for (
...
size [ 1 ] = 4 ; o3mnz0yuxu ( obj_p -> DataFieldName , success ) ; obj_p ->
DataFieldName -> data [ 0 ] = 'D' ; obj_p -> DataFieldName -> data [ 1 ] =
'a' ; obj_p -> DataFieldName -> data [ 2 ] = 't' ; obj_p -> DataFieldName ->
data [ 3 ] = 'a' ; } static boolean_T pv5og4xv2t1 ( jlr2oc3akq1 * obj ) {
CoderChannel chImpl ; nd1ykmemr0w * obj_p ; int32_T success ; char_T errorID
[ 1024 ] ; char_T errorText [ 1024 ] ; boolean_T b_value ; boolean_T
hasSyncError ; obj_p = obj -> AsyncIOChannel ; chImpl = obj_p -> ChannelImpl
; success = coderChannelIsOpen ( chImpl , & b_value ) ; if ( success == 0 ) {
coderChannelHasSyncError ( chImpl , & hasSyncError ) ; if ( ! hasSyncError )
...
errorText [ 0 ] ) ; } } return b_value ; } static boolean_T djcnyk5csz5 (
jlr2oc3akq1 * obj ) { CoderChannel chImpl ; nd1ykmemr0w * obj_p ; int32_T
success ; char_T errorID [ 1024 ] ; char_T errorText [ 1024 ] ; boolean_T
b_value ; boolean_T hasSyncError ; obj_p = obj -> AsyncIOChannel ; chImpl =
obj_p -> ChannelImpl ; success = coderChannelIsOpen ( chImpl , & hasSyncError
) ; if ( success == 0 ) { coderChannelHasSyncError ( chImpl , & hasSyncError
...
& errorID [ 0 ] , & errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } } return b_value ; }
static void dmpp4pm0lvf ( jlr2oc3akq1 * obj ) { CoderChannel chImpl ;
cj5bbeqbeda * outputStream ; escf2nogrso * inputStream ; kxhgzsud0w * b ;
kxhgzsud0w * d ; kxhgzsud0w * g ; kxhgzsud0w * options_FlowControl ;
kxhgzsud0w * options_Parity ; kxhgzsud0w * options_ServiceName ; lydzjepctwj
* obj_e ; nd1ykmemr0w * obj_p ; real_T c [ 2 ] ; real_T e [ 2 ] ; real_T f [
2 ] ; real_T out ; real_T out_e ; real_T out_p ; int32_T b_kstr ; int32_T
success ; char_T errorID [ 1024 ] ; char_T errorText [ 1024 ] ; char_T b_b [
13 ] ; boolean_T h [ 2 ] ; boolean_T i [ 2 ] ; boolean_T j [ 2 ] ; boolean_T
...
o3mnz0yuxu ( options_FlowControl , b_kstr ) ; success = obj -> FlowControl ->
size [ 1 ] ; for ( b_kstr = 0 ; b_kstr < success ; b_kstr ++ ) {
...
djcnyk5csz5 ( obj ) ) { out = clr3ajxix0q ( obj ) ; obj_p = obj ->
AsyncIOChannel ; chImpl = obj_p -> ChannelImpl ; success = coderChannelIsOpen
( chImpl , & result ) ; if ( success == 0 ) { coderChannelHasSyncError (
chImpl , & hasSyncError ) ; if ( ! hasSyncError ) { coderChannelGetLastError
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
...
! hasSyncError ) { coderChannelGetLastError ( chImpl , & errorID [ 0 ] , &
errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError ( chImpl , &
errorID [ 0 ] , & errorText [ 0 ] ) ; } } } out = clr3ajxix0q ( obj ) ;
...
o3mnz0yuxu ( options_ServiceName , b_kstr ) ; success = obj -> ByteOrder ->
size [ 1 ] ; for ( b_kstr = 0 ; b_kstr < success ; b_kstr ++ ) {
...
success ; o3mnz0yuxu ( obj_e -> ByteOrder , b_kstr ) ; success -- ; for (
...
o3mnz0yuxu ( options_ServiceName , b_kstr ) ; success = obj -> NativeDataType
-> size [ 1 ] ; for ( b_kstr = 0 ; b_kstr < success ; b_kstr ++ ) {
...
size [ 1 ] = options_ServiceName -> size [ 1 ] ; o3mnz0yuxu ( obj_e ->
...
options_ServiceName -> size [ 0 ] * options_ServiceName -> size [ 1 ] ;
options_ServiceName -> size [ 0 ] = 1 ; options_ServiceName -> size [ 1 ] =
obj -> DataFieldName -> size [ 1 ] ; o3mnz0yuxu ( options_ServiceName ,
...
o3mnz0yuxu ( obj_e -> DataFieldName , b_kstr ) ; success =
options_ServiceName -> size [ 1 ] - 1 ; for ( b_kstr = 0 ; b_kstr <= success
; b_kstr ++ ) { obj_e -> DataFieldName -> data [ b_kstr ] =
options_ServiceName -> data [ b_kstr ] ; } gkew4wu3pw ( & options_ServiceName
) ; } static void mthjxpxvqrf ( pzfkkiwufc * obj ) { CoderChannel chImpl ;
cj5bbeqbeda * outputStream ; escf2nogrso * inputStream ; kxhgzsud0w * out ;
lydzjepctwj * obj_e ; nd1ykmemr0w * obj_p ; real_T b [ 2 ] ; int32_T loop_ub
...
-> isSetupComplete = false ; obj -> isInitialized = 1 ; for ( success = 0 ;
...
[ 0 ] ) ; } } } obj -> SerialObj . DataBits = 8.0 ; if ( pv5og4xv2t1 ( & obj
-> SerialObj ) ) { obj_p = obj -> SerialObj . AsyncIOChannel ; chImpl = obj_p
-> ChannelImpl ; b_p [ 0 ] = 'n' ; b_p [ 1 ] = 'o' ; b_p [ 2 ] = 'n' ; b_p [
3 ] = 'e' ; success = coderChannelExecute ( chImpl , "SetParity" , 1 ,
"Parity" , "char" , 4 , & b_p [ 0 ] ) ; if ( success == 0 ) {
...
Parity -> data [ 0 ] = 'n' ; obj -> SerialObj . Parity -> data [ 1 ] = 'o' ;
obj -> SerialObj . Parity -> data [ 2 ] = 'n' ; obj -> SerialObj . Parity ->
data [ 3 ] = 'e' ; if ( pv5og4xv2t1 ( & obj -> SerialObj ) ) { obj_p = obj ->
SerialObj . AsyncIOChannel ; chImpl = obj_p -> ChannelImpl ; b [ 0 ] = 1.0 ;
b [ 1 ] = 1.0 ; success = coderChannelExecute ( chImpl , "SetStopBits" , 1 ,
"StopBits" , "double" , 1 , & b [ 0 ] ) ; if ( success == 0 ) {
coderChannelHasSyncError ( chImpl , & hasSyncError ) ; if ( ! hasSyncError )
...
= 1 ; obj -> SerialObj . FlowControl -> size [ 1 ] = 4 ; o3mnz0yuxu ( obj ->
...
o3mnz0yuxu ( obj_e -> ByteOrder , success ) ; for ( success = 0 ; success <
...
ii514olh2i ( & out , 2 ) ; success = out -> size [ 0 ] * out -> size [ 1 ] ;
out -> size [ 0 ] = 1 ; out -> size [ 1 ] = obj_e -> ByteOrder -> size [ 1 ]
; o3mnz0yuxu ( out , success ) ; loop_ub = obj_e -> ByteOrder -> size [ 1 ] ;
...
NativeDataType -> size [ 1 ] = 5 ; o3mnz0yuxu ( obj_e -> NativeDataType ,
...
DataFieldName -> size [ 0 ] = 1 ; obj -> SerialObj . DataFieldName -> size [
1 ] = 4 ; o3mnz0yuxu ( obj -> SerialObj . DataFieldName , success ) ; obj ->
...
o3mnz0yuxu ( obj_e -> DataFieldName , success ) ; obj_e -> DataFieldName ->
data [ 0 ] = 'D' ; obj_e -> DataFieldName -> data [ 1 ] = 'a' ; obj_e ->
DataFieldName -> data [ 2 ] = 't' ; obj_e -> DataFieldName -> data [ 3 ] =
'a' ; obj -> SerialObj . matlabCodegenIsDeleted = false ; dmpp4pm0lvf ( & obj
-> SerialObj ) ; djcnyk5csz5 ( & obj -> SerialObj ) ; obj -> isSetupComplete
= true ; obj -> TunablePropsChanged = false ; } static void fefajt5km02r0x (
lz2r3kxmyldm * pStruct ) { n3xnmwkn3j ( & pStruct -> InputStream ) ; } static
void mg4ynbai1k3u ( lydzjepctwjv * pStruct ) { fefajt5km02r0x ( & pStruct ->
UnreadDataBuffer ) ; ii514olh2i ( & pStruct -> ByteOrder , 2 ) ; } static
void fefajt5km02r0xf ( nd1ykmemr0wc * pStruct ) { n3xnmwkn3j ( & pStruct ->
InputStream ) ; } static void ovtkkflsbr0u ( jlr2oc3akq1q * pStruct ) {
ii514olh2i ( & pStruct -> ByteOrder , 2 ) ; ii514olh2i ( & pStruct ->
NativeDataType , 2 ) ; ii514olh2i ( & pStruct -> DataFieldName , 2 ) ;
ii514olh2i ( & pStruct -> Port , 2 ) ; ii514olh2i ( & pStruct -> FlowControl
, 2 ) ; ii514olh2i ( & pStruct -> Parity , 2 ) ; mg4ynbai1k3u ( & pStruct ->
_pobj0 ) ; fefajt5km02r0xf ( & pStruct -> _pobj1 ) ; } static void ei413zhxgv
( i4q10my5ye * pStruct ) { ovtkkflsbr0u ( & pStruct -> SerialObj ) ; } static
real_T clr3ajxix0qu ( jlr2oc3akq1q * obj ) { CoderChannel chImpl ;
nd1ykmemr0wc * obj_p ; real_T b_value ; int32_T success ; char_T errorID [
...
errorText [ 0 ] ) ; } } } return b_value ; } static void f1mkyd4ecjj3 (
jlr2oc3akq1q * obj , lydzjepctwjv * iobj_0 , nd1ykmemr0wc * iobj_1 ) {
CoderChannel chImpl ; CoderInputStream streamImpl ; CoderOutputStream
streamImpl_p ; cj5bbeqbeda * outputStream ; kxhgzsud0w * b ; kxhgzsud0w *
options_ServiceName ; lydzjepctwjv * obj_p ; nd1ykmemr0wc * channel ; real_T
e [ 2 ] ; real_T f [ 2 ] ; real_T varargin_8 [ 2 ] ; real_T b_value ; int32_T
loop_ub ; int32_T success ; char_T deviceFullPath_data [ 4096 ] ; char_T
devicePlugin_data [ 4096 ] ; char_T localAbsPath [ 4096 ] ; char_T errorID [
1024 ] ; char_T errorText [ 1024 ] ; char_T d [ 4 ] ; char_T g [ 4 ] ;
boolean_T hasSyncError ; boolean_T result ; static const jr22y2uzoh tmp = {
...
ExampleData -> size [ 1 ] = 1 ; fgsydcr0gf ( iobj_1 -> InputStream .
...
iobj_1 -> matlabCodegenIsDeleted = false ; obj -> AsyncIOChannel = iobj_1 ;
if ( ( ! obj -> IsSharingPort ) || ( ! obj -> IsSharingExistingTimeout ) ) {
b_value = clr3ajxix0qu ( obj ) ; outputStream = & obj -> AsyncIOChannel ->
...
13 ; o3mnz0yuxu ( obj_p -> ByteOrder , success ) ; for ( success = 0 ;
success < 13 ; success ++ ) { obj_p -> ByteOrder -> data [ success ] = tmp_p
[ success ] ; } } static boolean_T pv5og4xv2t1b ( jlr2oc3akq1q * obj ) {
CoderChannel chImpl ; nd1ykmemr0wc * obj_p ; int32_T success ; char_T errorID
[ 1024 ] ; char_T errorText [ 1024 ] ; boolean_T b_value ; boolean_T
hasSyncError ; obj_p = obj -> AsyncIOChannel ; chImpl = obj_p -> ChannelImpl
; success = coderChannelIsOpen ( chImpl , & b_value ) ; if ( success == 0 ) {
coderChannelHasSyncError ( chImpl , & hasSyncError ) ; if ( ! hasSyncError )
...
errorText [ 0 ] ) ; } } return b_value ; } static boolean_T djcnyk5csz50 (
jlr2oc3akq1q * obj ) { CoderChannel chImpl ; nd1ykmemr0wc * obj_p ; int32_T
success ; char_T errorID [ 1024 ] ; char_T errorText [ 1024 ] ; boolean_T
b_value ; boolean_T hasSyncError ; obj_p = obj -> AsyncIOChannel ; chImpl =
obj_p -> ChannelImpl ; success = coderChannelIsOpen ( chImpl , & hasSyncError
) ; if ( success == 0 ) { coderChannelHasSyncError ( chImpl , & hasSyncError
...
& errorID [ 0 ] , & errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } } return b_value ; }
static void dmpp4pm0lvff ( jlr2oc3akq1q * obj ) { CoderChannel chImpl ;
cj5bbeqbeda * outputStream ; kxhgzsud0w * b ; kxhgzsud0w * d ; kxhgzsud0w * g
; kxhgzsud0w * options_FlowControl ; kxhgzsud0w * options_Parity ; kxhgzsud0w
* options_ServiceName ; lydzjepctwjv * obj_e ; nd1ykmemr0wc * obj_p ; real_T
c [ 2 ] ; real_T e [ 2 ] ; real_T f [ 2 ] ; real_T out ; real_T out_e ;
real_T out_p ; int32_T b_kstr ; int32_T success ; char_T errorID [ 1024 ] ;
char_T errorText [ 1024 ] ; char_T b_b [ 13 ] ; boolean_T h [ 2 ] ; boolean_T
i [ 2 ] ; boolean_T j [ 2 ] ; boolean_T hasSyncError ; boolean_T
options_IsSharingExistingTimeout ; boolean_T options_IsSharingPort ;
boolean_T options_IsWriteOnly ; boolean_T result ; static const char_T tmp [
13 ] = { 'l' , 'i' , 't' , 't' , 'l' , 'e' , '-' , 'e' , 'n' , 'd' , 'i' ,
'a' , 'n' } ; static const char_T tmp_p [ 128 ] = { '\x00' , '\x01' , '\x02'
...
djcnyk5csz50 ( obj ) ) { out = clr3ajxix0qu ( obj ) ; obj_p = obj ->
AsyncIOChannel ; chImpl = obj_p -> ChannelImpl ; success = coderChannelIsOpen
( chImpl , & result ) ; if ( success == 0 ) { coderChannelHasSyncError (
chImpl , & hasSyncError ) ; if ( ! hasSyncError ) { coderChannelGetLastError
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
...
! hasSyncError ) { coderChannelGetLastError ( chImpl , & errorID [ 0 ] , &
errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError ( chImpl , &
errorID [ 0 ] , & errorText [ 0 ] ) ; } } } out = clr3ajxix0qu ( obj ) ;
...
b_kstr ++ ; } } else { result = true ; exitg1 = 1 ; } } while ( exitg1 == 0 )
; } gkew4wu3pw ( & options_ServiceName ) ; if ( result ) { success = 13 ; for
...
obj_e -> ByteOrder -> size [ 1 ] = success ; o3mnz0yuxu ( obj_e -> ByteOrder
, b_kstr ) ; success -- ; for ( b_kstr = 0 ; b_kstr <= success ; b_kstr ++ )
{ obj_e -> ByteOrder -> data [ b_kstr ] = b_b [ b_kstr ] ; } } static void
mthjxpxvqrfb ( i4q10my5ye * obj ) { CoderChannel chImpl ; cj5bbeqbeda *
outputStream ; kxhgzsud0w * out ; lydzjepctwjv * obj_e ; nd1ykmemr0wc * obj_p
...
SerialObj . Port , success ) ; obj -> SerialObj . Port -> data [ 0 ] = 'C' ;
obj -> SerialObj . Port -> data [ 1 ] = 'O' ; obj -> SerialObj . Port -> data
[ 2 ] = 'M' ; obj -> SerialObj . Port -> data [ 3 ] = '9' ; f1mkyd4ecjj3 ( &
obj -> SerialObj , & obj -> SerialObj . _pobj0 , & obj -> SerialObj . _pobj1
) ; if ( pv5og4xv2t1b ( & obj -> SerialObj ) ) { obj_p = obj -> SerialObj .
AsyncIOChannel ; chImpl = obj_p -> ChannelImpl ; b [ 0 ] = 9600.0 ; b [ 1 ] =
9600.0 ; success = coderChannelExecute ( chImpl , "SetBaudRate" , 1 ,
"BaudRate" , "double" , 1 , & b [ 0 ] ) ; if ( success == 0 ) {
coderChannelHasSyncError ( chImpl , & hasSyncError ) ; if ( ! hasSyncError )
...
errorText [ 0 ] ) ; } } } obj -> SerialObj . BaudRate = 9600.0 ; if (
pv5og4xv2t1b ( & obj -> SerialObj ) ) { obj_p = obj -> SerialObj .
AsyncIOChannel ; chImpl = obj_p -> ChannelImpl ; b [ 0 ] = 8.0 ; b [ 1 ] =
8.0 ; success = coderChannelExecute ( chImpl , "SetDataBits" , 1 , "DataBits"
, "double" , 1 , & b [ 0 ] ) ; if ( success == 0 ) { coderChannelHasSyncError
( chImpl , & hasSyncError ) ; if ( ! hasSyncError ) {
...
[ 0 ] ) ; } } } obj -> SerialObj . DataBits = 8.0 ; if ( pv5og4xv2t1b ( & obj
-> SerialObj ) ) { obj_p = obj -> SerialObj . AsyncIOChannel ; chImpl = obj_p
-> ChannelImpl ; b_p [ 0 ] = 'n' ; b_p [ 1 ] = 'o' ; b_p [ 2 ] = 'n' ; b_p [
3 ] = 'e' ; success = coderChannelExecute ( chImpl , "SetParity" , 1 ,
"Parity" , "char" , 4 , & b_p [ 0 ] ) ; if ( success == 0 ) {
...
Parity -> data [ 0 ] = 'n' ; obj -> SerialObj . Parity -> data [ 1 ] = 'o' ;
obj -> SerialObj . Parity -> data [ 2 ] = 'n' ; obj -> SerialObj . Parity ->
data [ 3 ] = 'e' ; if ( pv5og4xv2t1b ( & obj -> SerialObj ) ) { obj_p = obj
-> SerialObj . AsyncIOChannel ; chImpl = obj_p -> ChannelImpl ; b [ 0 ] = 1.0
; b [ 1 ] = 1.0 ; success = coderChannelExecute ( chImpl , "SetStopBits" , 1
, "StopBits" , "double" , 1 , & b [ 0 ] ) ; if ( success == 0 ) {
coderChannelHasSyncError ( chImpl , & hasSyncError ) ; if ( ! hasSyncError )
...
dmpp4pm0lvff ( & obj -> SerialObj ) ; djcnyk5csz50 ( & obj -> SerialObj ) ;
obj -> isSetupComplete = true ; obj -> TunablePropsChanged = false ; } static
void mscqpmuvwk ( m5lryued4q * obj ) { int32_T i ; real32_T cnt1 ; real32_T
...
i ] - 1 ] = 1000.0F - ( real32_T ) i ; } } static void gyaetsztlv ( real_T
newTime_tv_sec , real_T newTime_tv_nsec ) { coderTimespec b_timespec ; if ( !
rtDW . fqokmmydpq ) { if ( ! rtDW . io4vb4krek ) { rtDW . io4vb4krek = true ;
coderInitTimeFunctions ( & rtDW . coet15gpqm ) ; }
coderTimeClockGettimeMonotonic ( & b_timespec , rtDW . coet15gpqm ) ; rtDW .
fqokmmydpq = true ; } rtDW . hgtjzyscbh . tv_sec = newTime_tv_sec ; rtDW .
hgtjzyscbh . tv_nsec = newTime_tv_nsec ; } static void cgzq2cxjix ( void ) {
coderTimespec b_timespec ; if ( ! rtDW . io4vb4krek ) { rtDW . io4vb4krek =
true ; coderInitTimeFunctions ( & rtDW . coet15gpqm ) ; }
coderTimeClockGettimeMonotonic ( & b_timespec , rtDW . coet15gpqm ) ;
gyaetsztlv ( b_timespec . tv_sec , b_timespec . tv_nsec ) ; } static void
bkrg4vfz1n ( l3r0seotmm * * pEmxArray , int32_T numDimensions ) { l3r0seotmm
* emxArray ; int32_T i ; * pEmxArray = ( l3r0seotmm * ) malloc ( sizeof (
l3r0seotmm ) ) ; emxArray = * pEmxArray ; emxArray -> data = ( int32_T * )
...
gyaetsztlv1 ( real_T * outTime_tv_sec , real_T * outTime_tv_nsec ) {
coderTimespec b_timespec ; if ( ! rtDW . fqokmmydpq ) { if ( ! rtDW .
io4vb4krek ) { rtDW . io4vb4krek = true ; coderInitTimeFunctions ( & rtDW .
coet15gpqm ) ; } coderTimeClockGettimeMonotonic ( & b_timespec , rtDW .
coet15gpqm ) ; rtDW . hgtjzyscbh . tv_sec = b_timespec . tv_sec ; rtDW .
hgtjzyscbh . tv_nsec = b_timespec . tv_nsec ; } * outTime_tv_sec = rtDW .
hgtjzyscbh . tv_sec ; * outTime_tv_nsec = rtDW . hgtjzyscbh . tv_nsec ; }
static real_T extq512hka ( void ) { coderTimespec b_timespec ; real_T
tstart_tv_nsec ; real_T tstart_tv_sec ; gyaetsztlv1 ( & tstart_tv_sec , &
tstart_tv_nsec ) ; if ( ! rtDW . io4vb4krek ) { rtDW . io4vb4krek = true ;
coderInitTimeFunctions ( & rtDW . coet15gpqm ) ; }
coderTimeClockGettimeMonotonic ( & b_timespec , rtDW . coet15gpqm ) ; return
( b_timespec . tv_nsec - tstart_tv_nsec ) / 1.0E+9 + ( b_timespec . tv_sec -
tstart_tv_sec ) ; } static void odrsct0bpa ( const dkgmwniqkw * packet ,
real_T startIndex , real_T endIndex , dkgmwniqkw * result ) { int32_T e ;
...
size [ 0 ] = 1 ; result -> size [ 1 ] = e - f ; fgsydcr0gf ( result , i_p ) ;
...
fgsydcr0gf ( result , i_p ) ; e -= f ; for ( i_p = 0 ; i_p < e ; i_p ++ ) {
loop_ub = packet -> size [ 0 ] ; for ( i = 0 ; i < loop_ub ; i ++ ) { result
-> data [ i + result -> size [ 0 ] * i_p ] = packet -> data [ ( f + i_p ) *
packet -> size [ 0 ] + i ] ; } } } } static void odrsct0bpak ( const
dkgmwniqkw * packet , real_T endIndex , dkgmwniqkw * result ) { int32_T d ;
...
1 ] ; result -> size [ 0 ] = 1 ; result -> size [ 1 ] = d ; fgsydcr0gf (
...
result -> size [ 1 ] = d ; fgsydcr0gf ( result , i_p ) ; for ( i_p = 0 ; i_p
< d ; i_p ++ ) { loop_ub = packet -> size [ 0 ] ; for ( i = 0 ; i < loop_ub ;
i ++ ) { result -> data [ i + result -> size [ 0 ] * i_p ] = packet -> data [
packet -> size [ 0 ] * i_p + i ] ; } } } } static void nvre0b1z5s (
go2up1egww * * pEmxArray , int32_T numDimensions ) { go2up1egww * emxArray ;
int32_T i ; * pEmxArray = ( go2up1egww * ) malloc ( sizeof ( go2up1egww ) ) ;
emxArray = * pEmxArray ; emxArray -> data = ( fvknachgjd * ) NULL ; emxArray
...
) { emxArray -> size [ i ] = 0 ; } } static void cgzq2cxjix0 ( real_T *
tstart_tv_sec , real_T * tstart_tv_nsec ) { coderTimespec b_timespec ; if ( !
rtDW . io4vb4krek ) { rtDW . io4vb4krek = true ; coderInitTimeFunctions ( &
rtDW . coet15gpqm ) ; } coderTimeClockGettimeMonotonic ( & b_timespec , rtDW
. coet15gpqm ) ; * tstart_tv_sec = b_timespec . tv_sec ; * tstart_tv_nsec =
b_timespec . tv_nsec ; } static boolean_T f2ixltgxku ( const char_T a_data [
...
1 ; } } while ( exitg1 == 0 ) ; } return b_bool ; } static void egjz3gjn44 (
fvknachgjd * pStruct ) { mnmu4or4it ( & pStruct -> f1 , 2 ) ; } static void
fmgpjv2w42 ( go2up1egww * emxArray , int32_T fromIndex , int32_T toIndex ) {
int32_T i ; for ( i = fromIndex ; i < toIndex ; i ++ ) { egjz3gjn44 ( &
emxArray -> data [ i ] ) ; } } static void hnvmc54gzx ( fvknachgjd * pStruct
) { ipykpg1fst ( & pStruct -> f1 ) ; } static void lc413233ol ( go2up1egww *
emxArray , int32_T fromIndex , int32_T toIndex ) { int32_T i ; for ( i =
fromIndex ; i < toIndex ; i ++ ) { hnvmc54gzx ( & emxArray -> data [ i ] ) ;
} } static void l3hnsgnz1r ( go2up1egww * emxArray , int32_T oldNumel ) {
...
allocatedSize ) { i = emxArray -> allocatedSize ; if ( i < 16 ) { i = 16 ; }
while ( i < newNumel ) { if ( i > 1073741823 ) { i = MAX_int32_T ; } else { i
<<= 1 ; } } newData = calloc ( ( uint32_T ) i , sizeof ( fvknachgjd ) ) ; if
( emxArray -> data != NULL ) { memcpy ( newData , emxArray -> data , sizeof (
fvknachgjd ) * ( uint32_T ) oldNumel ) ; if ( emxArray -> canFreeData ) {
free ( emxArray -> data ) ; } } emxArray -> data = ( fvknachgjd * ) newData ;
emxArray -> allocatedSize = i ; emxArray -> canFreeData = true ; } if (
oldNumel > newNumel ) { lc413233ol ( emxArray , newNumel , oldNumel ) ; }
else if ( oldNumel < newNumel ) { fmgpjv2w42 ( emxArray , oldNumel , newNumel
) ; } } static void f5chb1ochr ( const escf2nogrso * obj , real_T
countRequested , go2up1egww * packets , real_T * countRead ) { CoderChannel
chImpl ; dkgmwniqkw * packet ; real_T bufferCounts [ 80 ] ; real_T
...
int32_T ) numBuffers ; l3hnsgnz1r ( packets , i ) ; for ( b_bufferIndex = 0 ;
...
b_bufferIndex ] . f1 -> size [ 1 ] = outsize ; fgsydcr0gf ( packets -> data [
...
- 1 ; mnmu4or4it ( & packet , 2 ) ; for ( b_bufferIndex = 0 ; b_bufferIndex
<= outsize ; b_bufferIndex ++ ) { i = packet -> size [ 0 ] * packet -> size [
1 ] ; packet -> size [ 0 ] = 1 ; success = packets -> data [ b_bufferIndex ]
. f1 -> size [ 1 ] ; packet -> size [ 1 ] = success ; fgsydcr0gf ( packet , i
...
-> size [ 0 ] * packets -> data [ b_bufferIndex ] . f1 -> size [ 1 ] ;
packets -> data [ b_bufferIndex ] . f1 -> size [ 0 ] = 1 ; packets -> data [
b_bufferIndex ] . f1 -> size [ 1 ] = packet -> size [ 1 ] ; fgsydcr0gf (
...
b_bufferIndex ] ; } ipykpg1fst ( & packet ) ; } static boolean_T f2ixltgxkug
...
f2ixltgxkug5 ( const char_T a_data [ ] , const int32_T a_size [ 2 ] ) {
...
; } } while ( exitg1 == 0 ) ; } return b_bool ; } static real_T extq512hkas (
real_T tstart_tv_sec , real_T tstart_tv_nsec ) { coderTimespec b_timespec ;
if ( ! rtDW . io4vb4krek ) { rtDW . io4vb4krek = true ;
coderInitTimeFunctions ( & rtDW . coet15gpqm ) ; }
coderTimeClockGettimeMonotonic ( & b_timespec , rtDW . coet15gpqm ) ; return
( b_timespec . tv_nsec - tstart_tv_nsec ) / 1.0E+9 + ( b_timespec . tv_sec -
tstart_tv_sec ) ; } static void bi1gsurois ( go2up1egww * * pEmxArray ) {
int32_T i ; int32_T numEl ; if ( * pEmxArray != ( go2up1egww * ) NULL ) { if
( ( * pEmxArray ) -> data != ( fvknachgjd * ) NULL ) { numEl = 1 ; for ( i =
0 ; i < ( * pEmxArray ) -> numDimensions ; i ++ ) { numEl *= ( * pEmxArray )
-> size [ i ] ; } for ( i = 0 ; i < numEl ; i ++ ) { hnvmc54gzx ( & ( *
pEmxArray ) -> data [ i ] ) ; } if ( ( * pEmxArray ) -> canFreeData ) { free
( ( * pEmxArray ) -> data ) ; } } free ( ( * pEmxArray ) -> size ) ; free ( *
pEmxArray ) ; * pEmxArray = ( go2up1egww * ) NULL ; } } static void
kzunah5v3t ( escf2nogrso * obj , real_T countRequested , dkgmwniqkw * data ,
...
; coderTimespec b_timespec_p ; dkgmwniqkw * exampleData ; dkgmwniqkw *
tempDataRead ; escf2nogrso * obj_p ; go2up1egww * packets ; real_T et ;
...
; dkgmwniqkw * data_e ; dkgmwniqkw * data_p ; int32_T status_size [ 2 ] ;
...
fgsydcr0gf ( obj -> ExampleData , iy ) ; obj -> ExampleData -> data [ 0 ] =
0U ; err_size [ 0 ] = 1 ; err_size [ 1 ] = 0 ; ppc = obj ->
PartialPacketCount ; mnmu4or4it ( & tempDataRead , 2 ) ; if ( ppc > 0.0 ) {
pps = obj -> PartialPacketStart ; if ( countRequested < ppc ) { odrsct0bpa (
...
odrsct0bpa ( obj -> PartialPacket , pps , ( pps + ppc ) - 1.0 , tempDataRead
) ; * countRead = ppc ; mnmu4or4it ( & exampleData , 2 ) ; iy = exampleData
-> size [ 0 ] * exampleData -> size [ 1 ] ; exampleData -> size [ 0 ] = obj
-> ExampleData -> size [ 0 ] ; fgsydcr0gf ( exampleData , iy ) ; obj ->
PartialPacket -> size [ 0 ] = exampleData -> size [ 0 ] ; ipykpg1fst ( &
exampleData ) ; obj -> PartialPacket -> size [ 1 ] = 0 ; obj ->
PartialPacketStart = 0.0 ; obj -> PartialPacketCount = 0.0 ; } odrsct0bpak (
tempDataRead , ( real_T ) tempDataRead -> size [ 1 ] , data ) ; } else { data
-> size [ 0 ] = 1 ; data -> size [ 1 ] = 0 ; * countRead = 0.0 ; } nvre0b1z5s
( & packets , 2 ) ; mnmu4or4it ( & data_p , 2 ) ; mnmu4or4it ( & data_e , 2 )
; if ( * countRead == countRequested ) { iy = data_e -> size [ 0 ] * data_e
-> size [ 1 ] ; data_e -> size [ 0 ] = data -> size [ 0 ] ; data_e -> size [
1 ] = data -> size [ 1 ] ; fgsydcr0gf ( data_e , iy ) ; success = data ->
size [ 0 ] * data -> size [ 1 ] - 1 ; if ( success >= 0 ) { memcpy ( & data_e
-> data [ 0 ] , & data -> data [ 0 ] , ( uint32_T ) ( success + 1 ) * sizeof
( uint8_T ) ) ; } odrsct0bpak ( data_e , ( real_T ) data -> size [ 1 ] , data
...
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] )
; } } hasSyncError = ( et > 0.0 ) ; cgzq2cxjix0 ( & pps , & startTic_tv_nsec
) ; while ( ( ! hasSyncError ) && ( ! done ) && ( ! timeout ) ) { et =
extq512hkas ( pps , startTic_tv_nsec ) ; if ( et < 1.0 ) { b_timespec_p .
tv_sec = 0.0 ; b_timespec_p . tv_nsec = 0.0 ; coderTimeSleep ( & b_timespec_p
) ; } else { b_timespec . tv_sec = 0.0 ; b_timespec . tv_nsec = 5.0E+6 ;
coderTimeSleep ( & b_timespec ) ; } et = extq512hkas ( pps , startTic_tv_nsec
...
if ( ! f2ixltgxku ( status_data , status_size ) ) { err_size [ 0 ] = 1 ;
err_size [ 1 ] = status_size [ 1 ] ; iy = status_size [ 1 ] ; if ( iy - 1 >=
0 ) { memcpy ( & err_data [ 0 ] , & status_data [ 0 ] , ( uint32_T ) iy *
sizeof ( char_T ) ) ; } if ( f2ixltgxkug ( status_data , status_size ) ) {
data -> size [ 0 ] = 1 ; data -> size [ 1 ] = 0 ; } else { if ( f2ixltgxkug5
( status_data , status_size ) ) { err_size [ 0 ] = 1 ; err_size [ 1 ] = 0 ; }
guard1 = true ; } exitg1 = 1 ; } else { guard11 = true ; } } else { guard11 =
true ; } if ( guard11 ) { f5chb1ochr ( obj , countRequested - * countRead ,
...
; tempDataRead -> size [ 1 ] = data -> size [ 1 ] ; fgsydcr0gf ( tempDataRead
...
-> size [ 0 ] ; data -> size [ 1 ] = tempDataRead -> size [ 1 ] ; fgsydcr0gf
...
ysize_idx_1 ; fgsydcr0gf ( data , iy ) ; iy = tempDataRead -> size [ 0 ] *
...
if ( guard1 ) { if ( * countRead > countRequested ) { odrsct0bpa ( data ,
...
PartialPacket -> size [ 1 ] = tempDataRead -> size [ 1 ] ; fgsydcr0gf ( obj
...
-> size [ 1 ] ; fgsydcr0gf ( data_p , iy ) ; success = data -> size [ 0 ] *
data -> size [ 1 ] - 1 ; if ( success >= 0 ) { memcpy ( & data_p -> data [ 0
] , & data -> data [ 0 ] , ( uint32_T ) ( success + 1 ) * sizeof ( uint8_T )
) ; } odrsct0bpak ( data_p , countRequested , data ) ; * countRead =
...
-> size [ 1 ] ; fgsydcr0gf ( obj -> PartialPacket , iy ) ; iy = data -> size
...
size [ 1 ] = 0 ; * countRead = 0.0 ; } } } ipykpg1fst ( & data_e ) ;
ipykpg1fst ( & data_p ) ; ipykpg1fst ( & tempDataRead ) ; bi1gsurois ( &
packets ) ; } static void c5bguvf3do ( hkhkhom4xnj * pStruct ) { mnmu4or4it (
& pStruct -> f1 , 2 ) ; } static void psnvefdcio ( ij0jf0t5ac * pEmxArray ) {
pEmxArray -> size = 0 ; } static void p4eqyxqrgu ( const cj5bbeqbeda * obj ,
...
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] )
; } } hasSyncError = ( et > 0.0 ) ; cgzq2cxjix0 ( & startTic_tv_sec , &
startTic_tv_nsec ) ; while ( ( ! hasSyncError ) && ( ! done ) && ( ! timeout
) ) { et = extq512hkas ( startTic_tv_sec , startTic_tv_nsec ) ; if ( et < 1.0
...
extq512hkas ( startTic_tv_sec , startTic_tv_nsec ) ; timeout = ( et >
...
tmp_p [ success ] ; } } } static void gx43grnn1n ( hkhkhom4xnj * data ,
int32_T fromIndex , int32_T toIndex ) { int32_T i ; for ( i = fromIndex ; i <
toIndex ; i ++ ) { c5bguvf3do ( data ) ; } } static void hmdk4nt3r0 (
hkhkhom4xnj * pStruct ) { ipykpg1fst ( & pStruct -> f1 ) ; } static void
j4kwcei1n4 ( hkhkhom4xnj * data , int32_T fromIndex , int32_T toIndex ) {
int32_T i ; for ( i = fromIndex ; i < toIndex ; i ++ ) { hmdk4nt3r0 ( data )
; } } static void bskbtgr1u1 ( hkhkhom4xnj * data , const int32_T * size ,
int32_T oldNumel ) { int32_T newNumel ; if ( oldNumel < 0 ) { oldNumel = 0 ;
} newNumel = * size ; if ( oldNumel > newNumel ) { j4kwcei1n4 ( data ,
newNumel , oldNumel ) ; } else if ( oldNumel < newNumel ) { gx43grnn1n ( data
, oldNumel , newNumel ) ; } } static void lnzocciadk ( dkgmwniqkw * * dst ,
dkgmwniqkw * const * src ) { int32_T i ; int32_T numElDst ; int32_T numElSrc
; numElDst = 1 ; numElSrc = 1 ; for ( i = 0 ; i < ( * dst ) -> numDimensions
; i ++ ) { numElDst *= ( * dst ) -> size [ i ] ; numElSrc *= ( * src ) ->
size [ i ] ; } for ( i = 0 ; i < ( * dst ) -> numDimensions ; i ++ ) { ( *
dst ) -> size [ i ] = ( * src ) -> size [ i ] ; } fgsydcr0gf ( * dst ,
numElDst ) ; for ( i = 0 ; i < numElSrc ; i ++ ) { ( * dst ) -> data [ i ] =
( * src ) -> data [ i ] ; } } static void b5o2xwrvus ( hkhkhom4xnj * dst ,
const hkhkhom4xnj * src ) { lnzocciadk ( & dst -> f1 , & src -> f1 ) ; }
static void hq0ez5t5pc ( ij0jf0t5ac * pEmxArray ) { int32_T i ; int32_T numEl
; numEl = 1 ; for ( i = 0 ; i < 1 ; i ++ ) { numEl *= pEmxArray -> size ; }
for ( i = 0 ; i < numEl ; i ++ ) { hmdk4nt3r0 ( & pEmxArray -> data ) ; } }
static void gxaefduqug ( lz2r3kxmyld * obj , const dkgmwniqkw * data ) {
CoderChannel chImpl ; CoderOutputStream streamImpl ; cj5bbeqbeda * obj_p ;
hkhkhom4xnj c ; ij0jf0t5ac c_p ; real_T count ; real_T countWritten ; real_T
...
countWritten = 0.0 ; c5bguvf3do ( & c ) ; success = c . f1 -> size [ 0 ] * c
. f1 -> size [ 1 ] ; c . f1 -> size [ 0 ] = data -> size [ 0 ] ; c . f1 ->
size [ 1 ] = data -> size [ 1 ] ; fgsydcr0gf ( c . f1 , success ) ; loop_ub =
data -> size [ 0 ] * data -> size [ 1 ] ; for ( success = 0 ; success <
loop_ub ; success ++ ) { c . f1 -> data [ success ] = data -> data [ success
] ; } packetStartIndex = 1.0 ; psnvefdcio ( & c_p ) ; exitg1 = false ; while
...
; } else { coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , &
errorText [ 0 ] ) ; } } guard1 = false ; if ( count == 0.0 ) { p4eqyxqrgu (
obj_p , status_data , status_size ) ; if ( ! f2ixltgxku ( status_data ,
...
size = 1 ; bskbtgr1u1 ( & c_p . data , & c_p . size , success ) ; b5o2xwrvus
...
= packetEndIndex ; } } hq0ez5t5pc ( & c_p ) ; hmdk4nt3r0 ( & c ) ;
countWritten = obj -> TotalElementsWritten + ( real_T ) data -> size [ 0 ] ;
obj -> TotalElementsWritten = countWritten ; } static real_T e5xq51aq1e (
const lz2r3kxmyld * obj ) { CoderChannel chImpl ; real_T count ; int32_T
success ; char_T errorID [ 1024 ] ; char_T errorText [ 1024 ] ; boolean_T
...
obj -> BytesPerElement ; } static void nonfr50pcl ( const lz2r3kxmyld * obj ,
real_T startIndex , real_T endIndex , dkgmwniqkw * result ) { int32_T e ;
...
f ; fgsydcr0gf ( result , i ) ; loop_ub = e - f ; for ( e = 0 ; e < loop_ub ;
...
PartialPacket -> size [ 0 ] ; result -> size [ 1 ] = e - f ; fgsydcr0gf (
...
; } } } } static void kzunah5v3td ( escf2nogrso * obj , real_T countRequested
, dkgmwniqkw * data ) { CoderChannel chImpl ; CoderInputStream streamImpl ;
coderTimespec b_timespec ; coderTimespec b_timespec_p ; dkgmwniqkw *
exampleData ; dkgmwniqkw * tempDataRead ; escf2nogrso * obj_p ; go2up1egww *
...
7 ] = { 't' , 'i' , 'm' , 'e' , 'o' , 'u' , 't' } ; dkgmwniqkw * data_e ;
dkgmwniqkw * data_p ; int32_T status_size [ 2 ] ; int32_T err_size_idx_1 ;
int32_T exitg1 ; boolean_T guard1 ; boolean_T guard11 ; iy = obj ->
ExampleData -> size [ 0 ] * obj -> ExampleData -> size [ 1 ] ; obj ->
ExampleData -> size [ 0 ] = 1 ; obj -> ExampleData -> size [ 1 ] = 1 ;
fgsydcr0gf ( obj -> ExampleData , iy ) ; obj -> ExampleData -> data [ 0 ] =
0U ; err_size_idx_1 = 0 ; ppc = obj -> PartialPacketCount ; mnmu4or4it ( &
tempDataRead , 2 ) ; if ( ppc > 0.0 ) { pps = obj -> PartialPacketStart ; if
( countRequested < ppc ) { odrsct0bpa ( obj -> PartialPacket , pps , ( pps +
...
ppc - countRequested ; } else { odrsct0bpa ( obj -> PartialPacket , pps , (
pps + ppc ) - 1.0 , tempDataRead ) ; b_countRead = ppc ; mnmu4or4it ( &
exampleData , 2 ) ; iy = exampleData -> size [ 0 ] * exampleData -> size [ 1
] ; exampleData -> size [ 0 ] = obj -> ExampleData -> size [ 0 ] ; fgsydcr0gf
( exampleData , iy ) ; obj -> PartialPacket -> size [ 0 ] = exampleData ->
size [ 0 ] ; ipykpg1fst ( & exampleData ) ; obj -> PartialPacket -> size [ 1
] = 0 ; obj -> PartialPacketStart = 0.0 ; obj -> PartialPacketCount = 0.0 ; }
odrsct0bpak ( tempDataRead , ( real_T ) tempDataRead -> size [ 1 ] , data ) ;
} else { data -> size [ 0 ] = 1 ; data -> size [ 1 ] = 0 ; b_countRead = 0.0
; } nvre0b1z5s ( & packets , 2 ) ; mnmu4or4it ( & data_p , 2 ) ; mnmu4or4it (
& data_e , 2 ) ; if ( b_countRead == countRequested ) { iy = data_e -> size [
0 ] * data_e -> size [ 1 ] ; data_e -> size [ 0 ] = data -> size [ 0 ] ;
data_e -> size [ 1 ] = data -> size [ 1 ] ; fgsydcr0gf ( data_e , iy ) ;
success = data -> size [ 0 ] * data -> size [ 1 ] - 1 ; if ( success >= 0 ) {
memcpy ( & data_e -> data [ 0 ] , & data -> data [ 0 ] , ( uint32_T ) (
success + 1 ) * sizeof ( uint8_T ) ) ; } odrsct0bpak ( data_e , ( real_T )
...
= 1 ; status_size [ 1 ] = 7 ; for ( ysize_idx_0 = 0 ; ysize_idx_0 < 7 ;
ysize_idx_0 ++ ) { status_data [ ysize_idx_0 ] = tmp_p [ ysize_idx_0 ] ; } }
if ( ! f2ixltgxku ( status_data , status_size ) ) { err_size_idx_1 =
status_size [ 1 ] ; if ( f2ixltgxkug ( status_data , status_size ) ) { data
-> size [ 0 ] = 1 ; data -> size [ 1 ] = 0 ; } else { if ( f2ixltgxkug5 (
status_data , status_size ) ) { err_size_idx_1 = 0 ; } guard1 = true ; }
exitg1 = 1 ; } else { guard11 = true ; } } else { guard11 = true ; } if (
guard11 ) { f5chb1ochr ( obj , countRequested - b_countRead , packets , & et
...
] = data -> size [ 1 ] ; fgsydcr0gf ( tempDataRead , iy ) ; iy = data -> size
...
-> size [ 1 ] = tempDataRead -> size [ 1 ] ; fgsydcr0gf ( data , iy ) ; iy =
...
fgsydcr0gf ( data , iy ) ; iy = tempDataRead -> size [ 0 ] * tempDataRead ->
...
b_countRead > countRequested ) { odrsct0bpa ( data , countRequested + 1.0 ,
...
tempDataRead -> size [ 1 ] ; fgsydcr0gf ( obj -> PartialPacket , iy ) ; iy =
...
; data -> size [ 1 ] = 0 ; } } } ipykpg1fst ( & data_e ) ; ipykpg1fst ( &
data_p ) ; ipykpg1fst ( & tempDataRead ) ; bi1gsurois ( & packets ) ; }
static void fhn3hzw3ov ( lz2r3kxmyld * obj , real_T numBytesToRead ,
dkgmwniqkw * data ) { CoderChannel chImpl ; dkgmwniqkw * rawData ; real_T
...
{ if ( numBytesToRead < obj -> PartialPacketCount ) { nonfr50pcl ( obj , obj
...
nonfr50pcl ( obj , obj -> PartialPacketStart , ( obj -> PartialPacketStart +
...
hasSyncError ) { coderChannelGetLastError ( chImpl , & errorID [ 0 ] , &
errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError ( chImpl , &
errorID [ 0 ] , & errorText [ 0 ] ) ; } } mnmu4or4it ( & rawData , 2 ) ;
kzunah5v3td ( & obj -> InputStream , obj -> InputStream . PartialPacketCount
...
PartialPacket -> size [ 1 ] = rawData -> size [ 1 ] ; fgsydcr0gf ( obj ->
...
PartialPacketCount ) { nonfr50pcl ( obj , obj -> PartialPacketStart , ( obj
-> PartialPacketStart + remainingCount ) - 1.0 , rawData ) ; obj ->
PartialPacketStart += remainingCount ; obj -> PartialPacketCount -=
remainingCount ; } else { nonfr50pcl ( obj , obj -> PartialPacketStart , (
...
data -> size [ 1 ] = result + result_p ; fgsydcr0gf ( data , tmp ) ; result
...
success ; data -> size [ 1 ] = result + result_p ; fgsydcr0gf ( data , tmp )
; result *= success ; success *= result_p ; for ( result_p = 0 ; result_p <
success ; result_p ++ ) { data -> data [ result_p + result ] = rawData ->
data [ result_p ] ; } } ipykpg1fst ( & rawData ) ; } } } static void
cng4zbur03 ( l3r0seotmm * emxArray , int32_T oldNumel ) { int32_T i ; int32_T
newNumel ; void * newData ; if ( oldNumel < 0 ) { oldNumel = 0 ; } newNumel =
1 ; for ( i = 0 ; i < emxArray -> numDimensions ; i ++ ) { newNumel *=
emxArray -> size [ i ] ; } if ( newNumel > emxArray -> allocatedSize ) { i =
emxArray -> allocatedSize ; if ( i < 16 ) { i = 16 ; } while ( i < newNumel )
...
allocatedSize = i ; emxArray -> canFreeData = true ; } } static void
irqghwolva ( avy5t05fil * * pEmxArray , int32_T numDimensions ) { avy5t05fil
* emxArray ; int32_T i ; * pEmxArray = ( avy5t05fil * ) malloc ( sizeof (
avy5t05fil ) ) ; emxArray = * pEmxArray ; emxArray -> data = ( uint16_T * )
NULL ; emxArray -> numDimensions = numDimensions ; emxArray -> size = (
int32_T * ) malloc ( sizeof ( int32_T ) * ( uint32_T ) numDimensions ) ;
emxArray -> allocatedSize = 0 ; emxArray -> canFreeData = true ; for ( i = 0
; i < numDimensions ; i ++ ) { emxArray -> size [ i ] = 0 ; } } static void
lcukdzp42v ( lydzjepctwj * obj , char_T status_data [ ] , int32_T status_size
[ 2 ] ) { CoderChannel chImpl ; CoderInputStream streamImpl ; coderTimespec
b_timespec ; coderTimespec b_timespec_p ; escf2nogrso * obj_p ; real_T et ;
...
et > 0.0 ) ; cgzq2cxjix0 ( & startTic_tv_sec , & startTic_tv_nsec ) ; while (
( ! hasSyncError ) && ( ! done ) && ( ! timeout ) ) { et = extq512hkas (
startTic_tv_sec , startTic_tv_nsec ) ; if ( et < 1.0 ) { b_timespec_p .
tv_sec = 0.0 ; b_timespec_p . tv_nsec = 0.0 ; coderTimeSleep ( & b_timespec_p
) ; } else { b_timespec . tv_sec = 0.0 ; b_timespec . tv_nsec = 5.0E+6 ;
coderTimeSleep ( & b_timespec ) ; } et = extq512hkas ( startTic_tv_sec ,
...
success ] ; } } } static void mso5evj0k4 ( coadmtcrth * pEmxArray ) {
pEmxArray -> size = 0 ; } static void adhv3xzbyc ( fvknachgjd * data ,
int32_T fromIndex , int32_T toIndex ) { int32_T i ; for ( i = fromIndex ; i <
toIndex ; i ++ ) { egjz3gjn44 ( data ) ; } } static void imk1yc2wkx (
fvknachgjd * data , int32_T fromIndex , int32_T toIndex ) { int32_T i ; for (
i = fromIndex ; i < toIndex ; i ++ ) { hnvmc54gzx ( data ) ; } } static void
ndz1kh5at3 ( fvknachgjd * data , const int32_T * size , int32_T oldNumel ) {
int32_T newNumel ; if ( oldNumel < 0 ) { oldNumel = 0 ; } newNumel = * size ;
if ( oldNumel > newNumel ) { imk1yc2wkx ( data , newNumel , oldNumel ) ; }
else if ( oldNumel < newNumel ) { adhv3xzbyc ( data , oldNumel , newNumel ) ;
} } static void hxo3e04w4s ( fvknachgjd * dst , const fvknachgjd * src ) {
lnzocciadk ( & dst -> f1 , & src -> f1 ) ; } static void nelzqkwogp (
coadmtcrth * pEmxArray ) { int32_T i ; int32_T numEl ; numEl = 1 ; for ( i =
0 ; i < 1 ; i ++ ) { numEl *= pEmxArray -> size ; } for ( i = 0 ; i < numEl ;
i ++ ) { hnvmc54gzx ( & pEmxArray -> data ) ; } } static void gxaefduqug4 (
lz2r3kxmyld * obj , const dkgmwniqkw * data ) { CoderChannel chImpl ;
CoderOutputStream streamImpl ; cj5bbeqbeda * obj_p ; coadmtcrth c_p ;
fvknachgjd c ; real_T count ; real_T countWritten ; real_T
countWrittenThisIteration ; real_T packetEndIndex ; real_T packetStartIndex ;
int32_T status_size [ 2 ] ; int32_T loop_ub ; int32_T success ; char_T
errorID [ 1024 ] ; char_T errorText [ 1024 ] ; char_T status_data [ 9 ] ;
boolean_T exitg1 ; boolean_T exitg2 ; boolean_T guard1 ; boolean_T
hasSyncError ; obj -> BytesPerElement = 1.0 ; obj_p = & obj -> OutputStream ;
countWritten = 0.0 ; egjz3gjn44 ( & c ) ; success = c . f1 -> size [ 0 ] * c
. f1 -> size [ 1 ] ; c . f1 -> size [ 0 ] = 1 ; c . f1 -> size [ 1 ] = data
-> size [ 1 ] ; fgsydcr0gf ( c . f1 , success ) ; loop_ub = data -> size [ 1
] ; for ( success = 0 ; success < loop_ub ; success ++ ) { c . f1 -> data [
success ] = data -> data [ success ] ; } packetStartIndex = 1.0 ; mso5evj0k4
( & c_p ) ; exitg1 = false ; while ( ( ! exitg1 ) && ( countWritten < data ->
size [ 1 ] ) ) { streamImpl = obj_p -> StreamImpl ; success =
coderStreamGetSpaceAvailable ( streamImpl , & count ) ; if ( success == 0 ) {
chImpl = coderStreamGetChannel ( streamImpl ) ; coderChannelHasSyncError (
chImpl , & hasSyncError ) ; if ( ! hasSyncError ) { coderChannelGetLastError
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] )
; } } guard1 = false ; if ( count == 0.0 ) { p4eqyxqrgu ( obj_p , status_data
, status_size ) ; if ( ! f2ixltgxku ( status_data , status_size ) ) { exitg1
= true ; } else { guard1 = true ; } } else { guard1 = true ; } if ( guard1 )
{ count = 0.0 ; packetEndIndex = packetStartIndex ; loop_ub = 0 ; exitg2 =
false ; while ( ( ! exitg2 ) && ( loop_ub <= ( int32_T ) ( ( 1.0 -
packetStartIndex ) + 1.0 ) - 1 ) ) { success = c_p . size ; c_p . size = 1 ;
ndz1kh5at3 ( & c_p . data , & c_p . size , success ) ; hxo3e04w4s ( & c_p .
data , & c ) ; streamImpl = obj_p -> StreamImpl ; success =
coderOutputStreamWriteTypedDataOld ( streamImpl , & countWrittenThisIteration
...
} } nelzqkwogp ( & c_p ) ; hnvmc54gzx ( & c ) ; countWritten = obj ->
TotalElementsWritten + 1.0 ; obj -> TotalElementsWritten = countWritten ; }
static void cuhbleb0ur ( l3r0seotmm * * pEmxArray ) { if ( * pEmxArray != (
l3r0seotmm * ) NULL ) { if ( ( ( * pEmxArray ) -> data != ( int32_T * ) NULL
) && ( * pEmxArray ) -> canFreeData ) { free ( ( * pEmxArray ) -> data ) ; }
free ( ( * pEmxArray ) -> size ) ; free ( * pEmxArray ) ; * pEmxArray = (
l3r0seotmm * ) NULL ; } } static void gcl3jfecc3 ( jlr2oc3akq1 * varargin_1 )
{ CoderChannel chImpl ; CoderInputStream streamImpl ; aeflheohnf obj_e ;
dkgmwniqkw * searchData ; dkgmwniqkw * searchData_p ; escf2nogrso * obj_p ;
kxhgzsud0w * searchDataChar ; l3r0seotmm * match_out ; l3r0seotmm * matches ;
lydzjepctwj * obj ; real_T a__3 ; real_T a__8 ; real_T count ; real_T
startTic_tv_nsec ; int32_T a__4_size [ 2 ] ; int32_T j ; int32_T loop_ub ;
int32_T match_idx ; int32_T success ; char_T errorID [ 1024 ] ; char_T
errorText [ 1024 ] ; char_T a__4_data [ 9 ] ; boolean_T guard1 ; boolean_T
hasSyncError ; boolean_T tokenFound ; pv5og4xv2t1 ( varargin_1 ) ; obj =
varargin_1 -> TransportChannel ; tokenFound = false ; obj_p = & obj ->
...
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] )
; } } count += obj_p -> PartialPacketCount ; mnmu4or4it ( & searchData , 2 )
...
PartialPacketCount ; kzunah5v3t ( & obj -> AsyncIOChannel -> InputStream ,
count , searchData , & a__3 , a__4_data , a__4_size ) ; gxaefduqug ( & obj ->
UnreadDataBuffer , searchData ) ; } count = e5xq51aq1e ( & obj ->
UnreadDataBuffer ) ; ii514olh2i ( & searchDataChar , 2 ) ; bkrg4vfz1n ( &
match_out , 2 ) ; bkrg4vfz1n ( & matches , 2 ) ; mnmu4or4it ( & searchData_p
, 2 ) ; guard1 = false ; if ( count != 0.0 ) { count = e5xq51aq1e ( & obj ->
UnreadDataBuffer ) ; if ( count != 0.0 ) { count = e5xq51aq1e ( & obj ->
UnreadDataBuffer ) ; if ( count == 0.0 ) { searchData -> size [ 0 ] = 0 ;
searchData -> size [ 1 ] = 0 ; } else { fhn3hzw3ov ( & obj ->
...
size [ 1 ] = searchData -> size [ 1 ] ; o3mnz0yuxu ( searchDataChar , j ) ;
...
-> size [ 1 ] = success ; cng4zbur03 ( matches , j ) ; match_idx = 0 ;
...
match_out -> size [ 1 ] = match_idx ; cng4zbur03 ( match_out , j ) ; if (
...
1 ] = match_out -> size [ 1 ] ; cng4zbur03 ( matches , j ) ; loop_ub =
...
searchData_p -> size [ 1 ] = match_idx - success ; fgsydcr0gf ( searchData_p
, j ) ; loop_ub = match_idx - success ; for ( match_idx = 0 ; match_idx <
loop_ub ; match_idx ++ ) { searchData_p -> data [ match_idx ] = searchData ->
data [ success + match_idx ] ; } gxaefduqug4 ( & obj -> UnreadDataBuffer ,
searchData_p ) ; } } else { gxaefduqug ( & obj -> UnreadDataBuffer ,
searchData ) ; guard1 = true ; } } else { guard1 = true ; } if ( guard1 ) {
cgzq2cxjix0 ( & a__3 , & startTic_tv_nsec ) ; while ( ! tokenFound ) {
lcukdzp42v ( obj , obj_e . data , obj_e . size ) ; obj_p = & obj ->
AsyncIOChannel -> InputStream ; streamImpl = obj_p -> StreamImpl ; success =
coderStreamGetDataAvailable ( streamImpl , & count ) ; if ( success == 0 ) {
chImpl = coderStreamGetChannel ( streamImpl ) ; coderChannelHasSyncError (
chImpl , & hasSyncError ) ; if ( ! hasSyncError ) { coderChannelGetLastError
...
errorText [ 0 ] ) ; } } count += obj_p -> PartialPacketCount ; kzunah5v3t ( &
obj -> AsyncIOChannel -> InputStream , count , searchData , & a__8 ,
a__4_data , a__4_size ) ; gxaefduqug ( & obj -> UnreadDataBuffer , searchData
) ; count = e5xq51aq1e ( & obj -> UnreadDataBuffer ) ; if ( count != 0.0 ) {
count = e5xq51aq1e ( & obj -> UnreadDataBuffer ) ; if ( count == 0.0 ) {
searchData -> size [ 0 ] = 0 ; searchData -> size [ 1 ] = 0 ; } else {
fhn3hzw3ov ( & obj -> UnreadDataBuffer , count * obj -> UnreadDataBuffer .
...
o3mnz0yuxu ( searchDataChar , j ) ; loop_ub = searchData -> size [ 0 ] *
...
cng4zbur03 ( matches , j ) ; match_idx = 0 ; loop_ub = success - 2 ; for (
...
cng4zbur03 ( match_out , j ) ; if ( loop_ub >= 0 ) { memcpy ( & match_out ->
...
cng4zbur03 ( matches , j ) ; loop_ub = match_out -> size [ 1 ] ; if ( loop_ub
...
size [ 1 ] = match_idx - success ; fgsydcr0gf ( searchData_p , j ) ; loop_ub
= match_idx - success ; for ( match_idx = 0 ; match_idx < loop_ub ; match_idx
++ ) { searchData_p -> data [ match_idx ] = searchData -> data [ success +
match_idx ] ; } gxaefduqug4 ( & obj -> UnreadDataBuffer , searchData_p ) ; }
} else { gxaefduqug ( & obj -> UnreadDataBuffer , searchData ) ; } }
extq512hkas ( a__3 , startTic_tv_nsec ) ; } } ipykpg1fst ( & searchData_p ) ;
cuhbleb0ur ( & matches ) ; cuhbleb0ur ( & match_out ) ; gkew4wu3pw ( &
searchDataChar ) ; ipykpg1fst ( & searchData ) ; } static void ar3bsdqspf (
lydzjepctwj * obj , real_T numToRead , dkgmwniqkw * data ) { real_T b_value ;
b_value = e5xq51aq1e ( & obj -> UnreadDataBuffer ) ; if ( numToRead > b_value
) { b_value = e5xq51aq1e ( & obj -> UnreadDataBuffer ) ; if ( b_value != 0.0
) { b_value = e5xq51aq1e ( & obj -> UnreadDataBuffer ) ; if ( b_value == 0.0
) { data -> size [ 0 ] = 0 ; data -> size [ 1 ] = 0 ; } else { fhn3hzw3ov ( &
obj -> UnreadDataBuffer , b_value * obj -> UnreadDataBuffer . BytesPerElement
, data ) ; } } else { data -> size [ 0 ] = 0 ; data -> size [ 1 ] = 0 ; } }
else { b_value = e5xq51aq1e ( & obj -> UnreadDataBuffer ) ; b_value =
muDoubleScalarMin ( numToRead , b_value ) ; if ( b_value == 0.0 ) { data ->
size [ 0 ] = 0 ; data -> size [ 1 ] = 0 ; } else { fhn3hzw3ov ( & obj ->
UnreadDataBuffer , b_value * obj -> UnreadDataBuffer . BytesPerElement , data
) ; } } } static void bfpfrm3zav ( jlr2oc3akq1 * varargin_1 , dkgmwniqkw *
data ) { CoderChannel chImpl ; CoderInputStream streamImpl ; coderTimespec
b_timespec ; dkgmwniqkw * b_rawData ; dkgmwniqkw * rawData ; dkgmwniqkw *
tempDataArray ; dkgmwniqkw * x ; escf2nogrso * obj_p ; lydzjepctwj * obj ;
lydzjepctwj * varargin_1_p ; real_T delayInt ; real_T numBytesToRead ; real_T
...
boolean_T hasEnoughData ; boolean_T hasSyncError ; pv5og4xv2t1 ( varargin_1 )
; varargin_1_p = varargin_1 -> TransportChannel ; obj = varargin_1_p ;
mnmu4or4it ( & rawData , 2 ) ; rawData -> size [ 0 ] = 0 ; rawData -> size [
1 ] = 0 ; numBytesToRead = e5xq51aq1e ( & varargin_1_p -> UnreadDataBuffer )
; if ( numBytesToRead >= 3602.0 ) { ar3bsdqspf ( varargin_1_p , 3602.0 ,
rawData ) ; } else { numBytesToRead = e5xq51aq1e ( & varargin_1_p ->
UnreadDataBuffer ) ; numBytesToRead = 3602.0 - numBytesToRead ; hasEnoughData
= false ; cgzq2cxjix0 ( & startTic_tv_sec , & startTic_tv_nsec ) ; exitg1 =
false ; while ( ( ! exitg1 ) && ( extq512hkas ( startTic_tv_sec ,
...
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] )
; } } delayInt += obj_p -> PartialPacketCount ; kzunah5v3t ( & obj ->
AsyncIOChannel -> InputStream , delayInt , rawData , & numBytesToRead ,
b_status_data , b_status_size ) ; gxaefduqug ( & obj -> UnreadDataBuffer ,
rawData ) ; ar3bsdqspf ( obj , 3602.0 , rawData ) ; } else if ( obj ->
...
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] )
; } } delayInt += obj_p -> PartialPacketCount ; mnmu4or4it ( & b_rawData , 2
) ; kzunah5v3t ( & obj -> AsyncIOChannel -> InputStream , delayInt ,
b_rawData , & numBytesToRead , b_status_data , b_status_size ) ; gxaefduqug (
& obj -> UnreadDataBuffer , b_rawData ) ; ipykpg1fst ( & b_rawData ) ; }
numBytesToRead = e5xq51aq1e ( & obj -> UnreadDataBuffer ) ; if (
numBytesToRead > 0.0 ) { numBytesToRead = e5xq51aq1e ( & obj ->
UnreadDataBuffer ) ; ar3bsdqspf ( obj , muDoubleScalarMin ( 3602.0 ,
numBytesToRead ) , rawData ) ; } } } if ( ( rawData -> size [ 0 ] == 0 ) || (
rawData -> size [ 1 ] == 0 ) ) { data -> size [ 0 ] = 0 ; data -> size [ 1 ]
= 0 ; } else { mnmu4or4it ( & x , 2 ) ; success = x -> size [ 0 ] * x -> size
[ 1 ] ; x -> size [ 0 ] = 1 ; x -> size [ 1 ] = rawData -> size [ 1 ] ;
fgsydcr0gf ( x , success ) ; loop_ub = rawData -> size [ 1 ] ; for ( success
= 0 ; success < loop_ub ; success ++ ) { x -> data [ success ] = rawData ->
data [ rawData -> size [ 0 ] * success ] ; } mnmu4or4it ( & tempDataArray , 2
) ; success = tempDataArray -> size [ 0 ] * tempDataArray -> size [ 1 ] ;
tempDataArray -> size [ 0 ] = 1 ; tempDataArray -> size [ 1 ] = rawData ->
size [ 1 ] ; fgsydcr0gf ( tempDataArray , success ) ; memcpy ( ( void * ) &
tempDataArray -> data [ 0 ] , ( void * ) & x -> data [ 0 ] , ( uint32_T ) ( (
size_t ) rawData -> size [ 1 ] * sizeof ( uint8_T ) ) ) ; ipykpg1fst ( & x )
; success = data -> size [ 0 ] * data -> size [ 1 ] ; data -> size [ 0 ] = 1
; data -> size [ 1 ] = tempDataArray -> size [ 1 ] ; fgsydcr0gf ( data ,
success ) ; loop_ub = tempDataArray -> size [ 1 ] ; memcpy ( & data -> data [
0 ] , & tempDataArray -> data [ 0 ] , ( uint32_T ) loop_ub * sizeof ( uint8_T
) ) ; ipykpg1fst ( & tempDataArray ) ; } ipykpg1fst ( & rawData ) ; } static
void mzzf3byge3 ( avy5t05fil * emxArray , int32_T oldNumel ) { int32_T i ;
int32_T newNumel ; void * newData ; if ( oldNumel < 0 ) { oldNumel = 0 ; }
newNumel = 1 ; for ( i = 0 ; i < emxArray -> numDimensions ; i ++ ) {
newNumel *= emxArray -> size [ i ] ; } if ( newNumel > emxArray ->
allocatedSize ) { i = emxArray -> allocatedSize ; if ( i < 16 ) { i = 16 ; }
...
void hkxf0y2w3t ( avy5t05fil * * pEmxArray ) { if ( * pEmxArray != (
avy5t05fil * ) NULL ) { if ( ( ( * pEmxArray ) -> data != ( uint16_T * ) NULL
) && ( * pEmxArray ) -> canFreeData ) { free ( ( * pEmxArray ) -> data ) ; }
free ( ( * pEmxArray ) -> size ) ; free ( * pEmxArray ) ; * pEmxArray = (
avy5t05fil * ) NULL ; } } static void bzz10kv3ft ( m5lryued4q * obj ,
...
- 1 ] = ind2 ; i *= 2.0F ; } } } static void aqjmcdusnj ( m5lryued4q * obj ,
real32_T i ) { real32_T ind1 ; real32_T ind2 ; real32_T temp ; boolean_T
exitg1 ; exitg1 = false ; while ( ( ! exitg1 ) && ( i <= obj ->
...
] = ind2 ; i *= 2.0F ; } } } static void cgzq2cxjix0x ( real_T *
tstart_tv_sec , real_T * tstart_tv_nsec ) { coderTimespec b_timespec ; if ( !
rtDW . iadb3xfqrn ) { rtDW . iadb3xfqrn = true ; coderInitTimeFunctions ( &
rtDW . arktuqbyhd ) ; } coderTimeClockGettimeMonotonic ( & b_timespec , rtDW
. arktuqbyhd ) ; * tstart_tv_sec = b_timespec . tv_sec ; * tstart_tv_nsec =
b_timespec . tv_nsec ; } static real_T extq512hkasr ( real_T tstart_tv_sec ,
real_T tstart_tv_nsec ) { coderTimespec b_timespec ; if ( ! rtDW . iadb3xfqrn
) { rtDW . iadb3xfqrn = true ; coderInitTimeFunctions ( & rtDW . arktuqbyhd )
; } coderTimeClockGettimeMonotonic ( & b_timespec , rtDW . arktuqbyhd ) ;
return ( b_timespec . tv_nsec - tstart_tv_nsec ) / 1.0E+9 + ( b_timespec .
tv_sec - tstart_tv_sec ) ; } static void elcxa00vnt ( jlr2oc3akq1q *
varargin_1 , const uint8_T varargin_2 [ 4 ] ) { CoderChannel chImpl ;
CoderOutputStream streamImpl ; cj5bbeqbeda * obj_i ; cj5bbeqbeda * obj_p ;
coderTimespec b_timespec ; coderTimespec b_timespec_p ; hkhkhom4xn b_data ;
hkhkhom4xn c ; lydzjepctwjv * obj ; lydzjepctwjv * varargin_1_p ;
nd1ykmemr0wc * obj_e ; real_T countWrittenThisIteration ; real_T et ; real_T
...
boolean_T exitg2 ; boolean_T guard1 ; pv5og4xv2t1b ( varargin_1 ) ;
...
cgzq2cxjix0x ( & countWrittenThisIteration , & startTic_tv_nsec ) ; while ( (
! hasSyncError ) && ( ! done ) && ( ! timeout ) ) { et = extq512hkasr (
...
= 5.0E+6 ; coderTimeSleep ( & b_timespec ) ; } et = extq512hkasr (
...
( real_T ) numBytesWritten ; } } static void a1z4odhlh0 ( const nd1ykmemr0 *
...
a1z4odhlh0k ( const lz2r3kxmyl * obj ) { CoderChannel chImpl ; int32_T
success ; char_T errorID [ 1024 ] ; char_T errorText [ 1024 ] ; boolean_T
...
hgxr25txlz ( escf2nogrs * pStruct ) { ipykpg1fst ( & pStruct -> ExampleData )
; } static void n4qs3gh3ji ( lz2r3kxmyl * pStruct ) { hgxr25txlz ( & pStruct
-> InputStream ) ; } static void gt02sxkqg0 ( lydzjepctw * pStruct ) {
n4qs3gh3ji ( & pStruct -> UnreadDataBuffer ) ; gkew4wu3pw ( & pStruct ->
ByteOrder ) ; } static void n4qs3gh3jir ( nd1ykmemr0 * pStruct ) { hgxr25txlz
( & pStruct -> InputStream ) ; } static void lr3h3inwym ( jlr2oc3akq *
pStruct ) { gkew4wu3pw ( & pStruct -> ByteOrder ) ; gkew4wu3pw ( & pStruct ->
NativeDataType ) ; gkew4wu3pw ( & pStruct -> DataFieldName ) ; gkew4wu3pw ( &
pStruct -> Port ) ; gkew4wu3pw ( & pStruct -> FlowControl ) ; gkew4wu3pw ( &
pStruct -> Parity ) ; gt02sxkqg0 ( & pStruct -> _pobj0 ) ; n4qs3gh3jir ( &
pStruct -> _pobj1 ) ; } static void n5frfhages ( ay3g115f1i * pStruct ) {
lr3h3inwym ( & pStruct -> SerialObj ) ; } static void a1z4odhlh0kh ( const
nd1ykmemr0w * obj ) { int32_T success ; char_T errorID [ 1024 ] ; char_T
...
0 ] , & errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError ( obj ->
ChannelImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } } } } static void
a1z4odhlh0khx ( lz2r3kxmyld * obj ) { CoderChannel chImpl ; int32_T success ;
...
errorText [ 0 ] ) ; } } } } static void hgxr25txlzb ( escf2nogrso * pStruct )
{ ipykpg1fst ( & pStruct -> PartialPacket ) ; ipykpg1fst ( & pStruct ->
ExampleData ) ; } static void n4qs3gh3jira ( lz2r3kxmyld * pStruct ) {
hgxr25txlzb ( & pStruct -> InputStream ) ; ipykpg1fst ( & pStruct ->
PartialPacket ) ; } static void gt02sxkqg0h ( lydzjepctwj * pStruct ) {
n4qs3gh3jira ( & pStruct -> UnreadDataBuffer ) ; gkew4wu3pw ( & pStruct ->
ByteOrder ) ; gkew4wu3pw ( & pStruct -> NativeDataType ) ; gkew4wu3pw ( &
pStruct -> DataFieldName ) ; } static void n4qs3gh3jirak ( nd1ykmemr0w *
pStruct ) { hgxr25txlzb ( & pStruct -> InputStream ) ; } static void
lr3h3inwymb ( jlr2oc3akq1 * pStruct ) { gkew4wu3pw ( & pStruct -> ByteOrder )
; gkew4wu3pw ( & pStruct -> NativeDataType ) ; gkew4wu3pw ( & pStruct ->
DataFieldName ) ; gkew4wu3pw ( & pStruct -> Port ) ; gkew4wu3pw ( & pStruct
-> FlowControl ) ; gkew4wu3pw ( & pStruct -> Parity ) ; gt02sxkqg0h ( &
pStruct -> _pobj0 ) ; n4qs3gh3jirak ( & pStruct -> _pobj1 ) ; } static void
k1usf3tvuh ( pzfkkiwufc * pStruct ) { lr3h3inwymb ( & pStruct -> SerialObj )
; } static void a1z4odhlh0khxk ( const nd1ykmemr0wc * obj ) { int32_T success
...
0 ] , & errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError ( obj ->
ChannelImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } } } } static void
a1z4odhlh0khxk3 ( const lz2r3kxmyldm * obj ) { CoderChannel chImpl ; int32_T
success ; char_T errorID [ 1024 ] ; char_T errorText [ 1024 ] ; boolean_T
hasSyncError ; boolean_T result ; success = coderChannelIsOpen ( obj ->
ChannelImpl , & result ) ; if ( success == 0 ) { coderChannelHasSyncError (
obj -> ChannelImpl , & hasSyncError ) ; if ( ! hasSyncError ) {
...
& errorID [ 0 ] , & errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } } } } static void
n4qs3gh3jirako ( lz2r3kxmyldm * pStruct ) { hgxr25txlz ( & pStruct ->
InputStream ) ; } static void gt02sxkqg0hn ( lydzjepctwjv * pStruct ) {
n4qs3gh3jirako ( & pStruct -> UnreadDataBuffer ) ; gkew4wu3pw ( & pStruct ->
ByteOrder ) ; } static void n4qs3gh3jirakod ( nd1ykmemr0wc * pStruct ) {
hgxr25txlz ( & pStruct -> InputStream ) ; } static void lr3h3inwymbk (
jlr2oc3akq1q * pStruct ) { gkew4wu3pw ( & pStruct -> ByteOrder ) ; gkew4wu3pw
( & pStruct -> NativeDataType ) ; gkew4wu3pw ( & pStruct -> DataFieldName ) ;
gkew4wu3pw ( & pStruct -> Port ) ; gkew4wu3pw ( & pStruct -> FlowControl ) ;
gkew4wu3pw ( & pStruct -> Parity ) ; gt02sxkqg0hn ( & pStruct -> _pobj0 ) ;
n4qs3gh3jirakod ( & pStruct -> _pobj1 ) ; } static void du3caa3v4d (
i4q10my5ye * pStruct ) { lr3h3inwymbk ( & pStruct -> SerialObj ) ; } void
MdlInitialize ( void ) { rtDW . bzptvq4u5r = rtP . UnitDelay_InitialCondition
; rtDW . lan4qrnmq2 = rtP . UnitDelay1_InitialCondition ; rtDW . fbrxmk2oa1 =
false ; rtDW . euzx5umukl = henc4kqddf ; if ( rtDW . lagiiszswb . pMID .
isInitialized == 1 ) { mscqpmuvwk ( & rtDW . lagiiszswb . pMID ) ; } } void
MdlStart ( void ) { c2skgq2wxz varSizes ; int32_T i ; { bool
...
"Copy_of_mcb_host_model_f28069m/Scope" ; static int_T rt_ScopeFrameData [ ] =
...
rtDW . etn3lcrlw2 . LoggedData [ 0 ] = rt_CreateStructLogVar (
...
. etn3lcrlw2 . LoggedData [ 0 ] == ( NULL ) ) return ; } { { { bool
isStreamoutAlreadyRegistered = false ; { sdiSignalSourceInfoU srcInfo ;
sdiLabelU loggedName = sdiGetLabelFromChars ( "Idc (amp)" ) ; sdiLabelU
origSigName = sdiGetLabelFromChars ( "Idc (amp)" ) ; sdiLabelU propName =
sdiGetLabelFromChars ( "" ) ; sdiLabelU blockPath = sdiGetLabelFromChars (
"Copy_of_mcb_host_model_f28069m/Serial Communication" ) ; sdiLabelU blockSID
= sdiGetLabelFromChars ( "" ) ; sdiLabelU subPath = sdiGetLabelFromChars ( ""
) ; sdiDims sigDims ; sdiLabelU sigName = sdiGetLabelFromChars ( "Idc (amp)"
...
2 ] = { 600 , 1 } ; sigDims . nDims = 2 ; sigDims . dimensions = sigDimsArray
...
signalName = sigName ; srcInfo . sigSourceUUID = 0 ; rtDW . inql0ffew5 .
AQHandles = sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo .
mmi . InstanceMap . fullPath , "b4ed55ba-7897-447f-b8cc-c241cd187bbf" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
sdiCompleteAsyncioQueueCreation ( rtDW . inql0ffew5 . AQHandles , hDT , &
srcInfo ) ; if ( rtDW . inql0ffew5 . AQHandles ) {
sdiSetSignalSampleTimeString ( rtDW . inql0ffew5 . AQHandles , "0.03" ,
0.030000000000000002 , ssGetTFinal ( rtS ) ) ; sdiSetSignalRefRate ( rtDW .
inql0ffew5 . AQHandles , 0.0 ) ; sdiSetRunStartTime ( rtDW . inql0ffew5 .
AQHandles , ssGetTaskTime ( rtS , 0 ) ) ; sdiAsyncRepoSetSignalExportSettings
( rtDW . inql0ffew5 . AQHandles , 1 , 50000 ) ;
sdiAsyncRepoSetSignalExportName ( rtDW . inql0ffew5 . AQHandles , loggedName
...
isStreamoutAlreadyRegistered = false ; { sdiSignalSourceInfoU srcInfo ;
sdiLabelU loggedName = sdiGetLabelFromChars ( "Speed_ref" ) ; sdiLabelU
origSigName = sdiGetLabelFromChars ( "Speed_ref" ) ; sdiLabelU propName =
sdiGetLabelFromChars ( "" ) ; sdiLabelU blockPath = sdiGetLabelFromChars (
"Copy_of_mcb_host_model_f28069m/Serial Communication" ) ; sdiLabelU blockSID
= sdiGetLabelFromChars ( "" ) ; sdiLabelU subPath = sdiGetLabelFromChars ( ""
) ; sdiDims sigDims ; sdiLabelU sigName = sdiGetLabelFromChars ( "Speed_ref"
) ; sdiAsyncRepoDataTypeHandle hDT = sdiAsyncRepoGetBuiltInDataTypeHandle (
DATA_TYPE_SINGLE ) ; { sdiComplexity sigComplexity = REAL ;
sdiSampleTimeContinuity stCont = SAMPLE_TIME_DISCRETE ; int_T sigDimsArray [
...
sigName ; srcInfo . sigSourceUUID = 0 ; rtDW . mpkmcxgjct . AQHandles =
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "b84fc5e0-6cde-4606-bd94-bd13cbed247b" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
sdiCompleteAsyncioQueueCreation ( rtDW . mpkmcxgjct . AQHandles , hDT , &
srcInfo ) ; if ( rtDW . mpkmcxgjct . AQHandles ) {
sdiSetSignalSampleTimeString ( rtDW . mpkmcxgjct . AQHandles , "0.03" ,
0.030000000000000002 , ssGetTFinal ( rtS ) ) ; sdiSetSignalRefRate ( rtDW .
mpkmcxgjct . AQHandles , 0.0 ) ; sdiSetRunStartTime ( rtDW . mpkmcxgjct .
AQHandles , ssGetTaskTime ( rtS , 0 ) ) ; sdiAsyncRepoSetSignalExportSettings
( rtDW . mpkmcxgjct . AQHandles , 1 , 50000 ) ;
sdiAsyncRepoSetSignalExportName ( rtDW . mpkmcxgjct . AQHandles , loggedName
, origSigName , propName ) ; } sdiFreeLabel ( sigName ) ; sdiFreeLabel (
loggedName ) ; sdiFreeLabel ( origSigName ) ; sdiFreeLabel ( propName ) ;
sdiFreeLabel ( blockPath ) ; sdiFreeLabel ( blockSID ) ; sdiFreeLabel (
subPath ) ; } } if ( ! isStreamoutAlreadyRegistered ) { } } } } { { { bool
isStreamoutAlreadyRegistered = false ; { sdiSignalSourceInfoU srcInfo ;
sdiLabelU loggedName = sdiGetLabelFromChars ( "Speed_fb" ) ; sdiLabelU
origSigName = sdiGetLabelFromChars ( "Speed_fb" ) ; sdiLabelU propName =
sdiGetLabelFromChars ( "" ) ; sdiLabelU blockPath = sdiGetLabelFromChars (
"Copy_of_mcb_host_model_f28069m/Serial Communication" ) ; sdiLabelU blockSID
= sdiGetLabelFromChars ( "" ) ; sdiLabelU subPath = sdiGetLabelFromChars ( ""
) ; sdiDims sigDims ; sdiLabelU sigName = sdiGetLabelFromChars ( "Speed_fb" )
; sdiAsyncRepoDataTypeHandle hDT = sdiAsyncRepoGetBuiltInDataTypeHandle (
DATA_TYPE_SINGLE ) ; { sdiComplexity sigComplexity = REAL ;
sdiSampleTimeContinuity stCont = SAMPLE_TIME_DISCRETE ; int_T sigDimsArray [
1 ] = { 600 } ; sigDims . nDims = 1 ; sigDims . dimensions = sigDimsArray ;
srcInfo . numBlockPathElems = 1 ; srcInfo . fullBlockPath = ( sdiFullBlkPathU
) & blockPath ; srcInfo . SID = ( sdiSignalIDU ) & blockSID ; srcInfo .
subPath = subPath ; srcInfo . portIndex = 2 + 1 ; srcInfo . signalName =
sigName ; srcInfo . sigSourceUUID = 0 ; rtDW . lxuh4dim3l . AQHandles =
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "5a5817f6-39f3-4437-a021-1fabe4ca693f" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
sdiCompleteAsyncioQueueCreation ( rtDW . lxuh4dim3l . AQHandles , hDT , &
srcInfo ) ; if ( rtDW . lxuh4dim3l . AQHandles ) {
sdiSetSignalSampleTimeString ( rtDW . lxuh4dim3l . AQHandles , "0.03" ,
0.030000000000000002 , ssGetTFinal ( rtS ) ) ; sdiSetSignalRefRate ( rtDW .
lxuh4dim3l . AQHandles , 0.0 ) ; sdiSetRunStartTime ( rtDW . lxuh4dim3l .
AQHandles , ssGetTaskTime ( rtS , 0 ) ) ; sdiAsyncRepoSetSignalExportSettings
( rtDW . lxuh4dim3l . AQHandles , 1 , 50000 ) ;
sdiAsyncRepoSetSignalExportName ( rtDW . lxuh4dim3l . AQHandles , loggedName
, origSigName , propName ) ; } sdiFreeLabel ( sigName ) ; sdiFreeLabel (
loggedName ) ; sdiFreeLabel ( origSigName ) ; sdiFreeLabel ( propName ) ;
sdiFreeLabel ( blockPath ) ; sdiFreeLabel ( blockSID ) ; sdiFreeLabel (
subPath ) ; } } if ( ! isStreamoutAlreadyRegistered ) { } } } } afehf3ozac (
& rtDW . nvmwqwiftq ) ; rtDW . nvmwqwiftq . SerialObj . _pobj1 . InputStream
. matlabCodegenIsDeleted = true ; rtDW . nvmwqwiftq . SerialObj . _pobj0 .
UnreadDataBuffer . InputStream . matlabCodegenIsDeleted = true ; rtDW .
nvmwqwiftq . SerialObj . _pobj1 . OutputStream . matlabCodegenIsDeleted =
true ; rtDW . nvmwqwiftq . SerialObj . _pobj0 . UnreadDataBuffer .
OutputStream . matlabCodegenIsDeleted = true ; rtDW . nvmwqwiftq . SerialObj
. _pobj1 . matlabCodegenIsDeleted = true ; rtDW . nvmwqwiftq . SerialObj .
_pobj0 . UnreadDataBuffer . matlabCodegenIsDeleted = true ; rtDW . nvmwqwiftq
. SerialObj . _pobj0 . matlabCodegenIsDeleted = true ; rtDW . nvmwqwiftq .
SerialObj . matlabCodegenIsDeleted = true ; rtDW . nvmwqwiftq . isInitialized
= 0 ; rtDW . nvmwqwiftq . matlabCodegenIsDeleted = false ; rtDW . os140yo3i0
= true ; mthjxpxvqr ( & rtDW . nvmwqwiftq ) ; nze024knzp ( & rtDW .
fnakjtbv2h ) ; rtDW . fnakjtbv2h . SerialObj . _pobj1 . InputStream .
matlabCodegenIsDeleted = true ; rtDW . fnakjtbv2h . SerialObj . _pobj0 .
UnreadDataBuffer . InputStream . matlabCodegenIsDeleted = true ; rtDW .
fnakjtbv2h . SerialObj . _pobj1 . OutputStream . matlabCodegenIsDeleted =
true ; rtDW . fnakjtbv2h . SerialObj . _pobj0 . UnreadDataBuffer .
OutputStream . matlabCodegenIsDeleted = true ; rtDW . fnakjtbv2h . SerialObj
. _pobj1 . matlabCodegenIsDeleted = true ; rtDW . fnakjtbv2h . SerialObj .
_pobj0 . UnreadDataBuffer . matlabCodegenIsDeleted = true ; rtDW . fnakjtbv2h
. SerialObj . _pobj0 . matlabCodegenIsDeleted = true ; rtDW . fnakjtbv2h .
SerialObj . matlabCodegenIsDeleted = true ; rtDW . fdiyjus4h5 = 0U ; rtDW .
p1qlkgqra2 = true ; rtDW . fnakjtbv2h . isInitialized = 0 ; rtDW . fnakjtbv2h
. matlabCodegenIsDeleted = false ; rtDW . h2w1aidhiz = true ; mthjxpxvqrf ( &
rtDW . fnakjtbv2h ) ; rtDW . lagiiszswb . matlabCodegenIsDeleted = false ;
rtDW . ck0hbmqpxs = true ; rtDW . lagiiszswb . isInitialized = 1 ; varSizes .
f1 [ 0 ] = 600U ; varSizes . f1 [ 1 ] = 1U ; for ( i = 0 ; i < 6 ; i ++ ) {
varSizes . f1 [ i + 2 ] = 1U ; } rtDW . lagiiszswb . inputVarSize = varSizes
; rtDW . lagiiszswb . NumChannels = 1 ; rtDW . lagiiszswb . pMID .
isInitialized = 0 ; rtDW . lagiiszswb . isSetupComplete = true ; ei413zhxgv (
& rtDW . klqnlcwipn ) ; rtDW . klqnlcwipn . SerialObj . _pobj1 . InputStream
. matlabCodegenIsDeleted = true ; rtDW . klqnlcwipn . SerialObj . _pobj0 .
UnreadDataBuffer . InputStream . matlabCodegenIsDeleted = true ; rtDW .
klqnlcwipn . SerialObj . _pobj1 . OutputStream . matlabCodegenIsDeleted =
true ; rtDW . klqnlcwipn . SerialObj . _pobj0 . UnreadDataBuffer .
OutputStream . matlabCodegenIsDeleted = true ; rtDW . klqnlcwipn . SerialObj
. _pobj1 . matlabCodegenIsDeleted = true ; rtDW . klqnlcwipn . SerialObj .
_pobj0 . UnreadDataBuffer . matlabCodegenIsDeleted = true ; rtDW . klqnlcwipn
. SerialObj . _pobj0 . matlabCodegenIsDeleted = true ; rtDW . klqnlcwipn .
SerialObj . matlabCodegenIsDeleted = true ; rtDW . bn4ms0hozr = 0U ; rtDW .
ajustef2fb = true ; rtDW . klqnlcwipn . isInitialized = 0 ; rtDW . klqnlcwipn
. matlabCodegenIsDeleted = false ; rtDW . hmady1j452 = true ; mthjxpxvqrfb (
& rtDW . klqnlcwipn ) ; MdlInitialize ( ) ; } void MdlOutputs ( int_T tid ) {
CoderChannel chImpl ; CoderInputStream streamImpl ; __m128 tmp_e ; avy5t05fil
* data ; coderTimespec b_timespec ; coderTimespec b_timespec_p ; dkgmwniqkw *
dataPlus ; dkgmwniqkw * outval ; dkgmwniqkw * searchData ; dv0mca3zy4 b_obj ;
dv0mca3zy4 * obj ; dw4mkzhvk4 dataAvailable ; dw4mkzhvk4 * dataAvailable_p ;
escf2nogrso * obj_e ; jlr2oc3akq1 * serialObject ; kxhgzsud0w *
searchDataChar ; l3r0seotmm * match_out ; l3r0seotmm * matches ; lydzjepctwj
* obj_p ; m5lryued4q * obj_i ; real_T delay ; real_T delayInt ; int32_T
a__6_size [ 2 ] ; int32_T b_idx_1 ; int32_T j ; int32_T match_idx ; int32_T
success ; real32_T b2vyll4xdz [ 600 ] ; real32_T tmp_p [ 600 ] ; real32_T p ;
real32_T pfvtfzsr5e ; real32_T temp ; real32_T vprev ; int16_T inSize [ 8 ] ;
uint16_T tmp [ 1800 ] ; uint16_T rowInput [ 2 ] ; char_T errorID [ 1024 ] ;
char_T errorText [ 1024 ] ; char_T a__6_data [ 9 ] ; uint8_T inputval [ 4 ] ;
boolean_T exitg1 ; boolean_T flag ; boolean_T guard1 ; boolean_T hasSyncError
; srClearBC ( rtDW . e2ixh5jayd ) ; if ( rtDW . fnakjtbv2h .
TunablePropsChanged ) { rtDW . fnakjtbv2h . TunablePropsChanged = false ; }
b_obj . matlabCodegenIsDeleted = false ; b_obj . contents = & rtDW .
fnakjtbv2h ; dataAvailable . contents = true ; dataAvailable_p = &
dataAvailable ; obj = & b_obj ; serialObject = & b_obj . contents ->
SerialObj ; flag = false ; cgzq2cxjix ( ) ; mnmu4or4it ( & searchData , 2 ) ;
ii514olh2i ( & searchDataChar , 2 ) ; bkrg4vfz1n ( & match_out , 2 ) ;
bkrg4vfz1n ( & matches , 2 ) ; exitg1 = false ; while ( ( ! exitg1 ) && (
extq512hka ( ) < clr3ajxix0q ( serialObject ) ) ) { pv5og4xv2t1 (
...
errorText [ 0 ] ) ; } } delayInt += obj_e -> PartialPacketCount ; kzunah5v3t
( & obj_p -> AsyncIOChannel -> InputStream , delayInt , searchData , & delay
, a__6_data , a__6_size ) ; gxaefduqug ( & obj_p -> UnreadDataBuffer ,
searchData ) ; } delayInt = e5xq51aq1e ( & obj_p -> UnreadDataBuffer ) ; if (
delayInt != 0.0 ) { delayInt = e5xq51aq1e ( & obj_p -> UnreadDataBuffer ) ;
if ( delayInt != 0.0 ) { delayInt = e5xq51aq1e ( & obj_p -> UnreadDataBuffer
) ; if ( delayInt == 0.0 ) { searchData -> size [ 0 ] = 0 ; searchData ->
size [ 1 ] = 0 ; } else { fhn3hzw3ov ( & obj_p -> UnreadDataBuffer , delayInt
...
searchData -> size [ 1 ] ; o3mnz0yuxu ( searchDataChar , j ) ; j = searchData
...
1 ; matches -> size [ 1 ] = success ; cng4zbur03 ( matches , j ) ; match_idx
...
1 ; match_out -> size [ 1 ] = match_idx ; cng4zbur03 ( match_out , j ) ; if (
...
] ; cng4zbur03 ( matches , j ) ; } flag = ( matches -> size [ 1 ] != 0 ) ;
gxaefduqug ( & obj_p -> UnreadDataBuffer , searchData ) ; } if ( flag ) {
exitg1 = true ; } else { b_timespec . tv_sec = 0.0 ; b_timespec . tv_nsec =
1.0E+7 ; coderTimeSleep ( & b_timespec ) ; } } mnmu4or4it ( & outval , 2 ) ;
mnmu4or4it ( & dataPlus , 2 ) ; irqghwolva ( & data , 2 ) ; if ( ! flag ) {
dataAvailable_p -> contents = false ; for ( match_idx = 0 ; match_idx < 1800
; match_idx ++ ) { tmp [ match_idx ] = obj -> contents -> SaveOutput [
match_idx ] ; } } else { gcl3jfecc3 ( & obj -> contents -> SerialObj ) ;
serialObject = & obj -> contents -> SerialObj ; j = match_out -> size [ 0 ] *
match_out -> size [ 1 ] ; match_out -> size [ 0 ] = 1 ; match_out -> size [ 1
] = 1 ; cng4zbur03 ( match_out , j ) ; match_out -> data [ 0 ] = 0 ; flag =
false ; cgzq2cxjix ( ) ; exitg1 = false ; while ( ( ! exitg1 ) && (
extq512hka ( ) < clr3ajxix0q ( serialObject ) ) ) { pv5og4xv2t1 (
serialObject ) ; obj_p = serialObject -> TransportChannel ; j = match_out ->
size [ 0 ] * match_out -> size [ 1 ] ; match_out -> size [ 0 ] = 1 ;
match_out -> size [ 1 ] = 1 ; cng4zbur03 ( match_out , j ) ; match_out ->
...
( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ; } else {
coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] )
; } } delayInt += obj_e -> PartialPacketCount ; kzunah5v3t ( & obj_p ->
AsyncIOChannel -> InputStream , delayInt , searchData , & delay , a__6_data ,
a__6_size ) ; gxaefduqug ( & obj_p -> UnreadDataBuffer , searchData ) ; }
delayInt = e5xq51aq1e ( & obj_p -> UnreadDataBuffer ) ; if ( delayInt != 0.0
) { delayInt = e5xq51aq1e ( & obj_p -> UnreadDataBuffer ) ; if ( delayInt !=
0.0 ) { delayInt = e5xq51aq1e ( & obj_p -> UnreadDataBuffer ) ; if ( delayInt
== 0.0 ) { searchData -> size [ 0 ] = 0 ; searchData -> size [ 1 ] = 0 ; }
else { fhn3hzw3ov ( & obj_p -> UnreadDataBuffer , delayInt * obj_p ->
...
[ 1 ] ; o3mnz0yuxu ( searchDataChar , j ) ; j = searchData -> size [ 0 ] *
...
searchDataChar -> size [ 1 ] ; j = matches -> size [ 0 ] * matches -> size [
1 ] ; matches -> size [ 0 ] = 1 ; matches -> size [ 1 ] = success ;
cng4zbur03 ( matches , j ) ; match_idx = 0 ; b_idx_1 = success - 2 ; for (
...
cng4zbur03 ( match_out , j ) ; if ( b_idx_1 >= 0 ) { memcpy ( & match_out ->
data [ 0 ] , & matches -> data [ 0 ] , ( uint32_T ) ( b_idx_1 + 1 ) * sizeof
( int32_T ) ) ; } j = matches -> size [ 0 ] * matches -> size [ 1 ] ; matches
-> size [ 0 ] = 1 ; matches -> size [ 1 ] = match_out -> size [ 1 ] ;
cng4zbur03 ( matches , j ) ; j = match_out -> size [ 1 ] ; if ( j - 1 >= 0 )
...
-> size [ 1 ] ; cng4zbur03 ( match_out , j ) ; j = matches -> size [ 1 ] ; if
( j - 1 >= 0 ) { memcpy ( & match_out -> data [ 0 ] , & matches -> data [ 0 ]
, ( uint32_T ) j * sizeof ( int32_T ) ) ; } flag = ( matches -> size [ 1 ] !=
0 ) ; gxaefduqug ( & obj_p -> UnreadDataBuffer , searchData ) ; } if ( flag )
...
bfpfrm3zav ( & obj -> contents -> SerialObj , dataPlus ) ; if ( dataPlus ->
size [ 1 ] - 2 < 1 ) { success = 0 ; } else { success = dataPlus -> size [ 1
] - 2 ; } j = outval -> size [ 0 ] * outval -> size [ 1 ] ; outval -> size [
0 ] = 1 ; outval -> size [ 1 ] = success ; fgsydcr0gf ( outval , j ) ; if (
...
match_idx ; mzzf3byge3 ( data , j ) ; memcpy ( ( void * ) & data -> data [ 0
...
match_idx ] ; } } } cuhbleb0ur ( & matches ) ; cuhbleb0ur ( & match_out ) ;
gkew4wu3pw ( & searchDataChar ) ; ipykpg1fst ( & searchData ) ; hkxf0y2w3t (
& data ) ; ipykpg1fst ( & dataPlus ) ; ipykpg1fst ( & outval ) ; if (
...
duaporaq5z_mbvzarwird [ match_idx ] = ( real32_T ) ( int16_T ) tmp [
match_idx ] * 0.000244140625F ; } rtDW . euzx5umukl = henc4kqddf ; for (
match_idx = 0 ; match_idx <= 596 ; match_idx += 4 ) { tmp_e = _mm_loadu_ps (
& rtB . duaporaq5z_mbvzarwird [ match_idx + 1200 ] ) ; _mm_storeu_ps ( &
...
( rtDW . lagiiszswb . inputVarSize . f1 [ success ] != ( uint32_T ) inSize [
success ] ) { for ( match_idx = 0 ; match_idx < 8 ; match_idx ++ ) { rtDW .
lagiiszswb . inputVarSize . f1 [ match_idx ] = ( uint32_T ) inSize [
match_idx ] ; } exitg1 = true ; } else { success ++ ; } } obj_i = & rtDW .
lagiiszswb . pMID ; if ( rtDW . lagiiszswb . pMID . isInitialized != 1 ) {
rtDW . lagiiszswb . pMID . isInitialized = 1 ; rtDW . lagiiszswb . pMID .
isSetupComplete = true ; mscqpmuvwk ( & rtDW . lagiiszswb . pMID ) ; } for (
success = 0 ; success < 600 ; success ++ ) { vprev = obj_i -> pBuf [ (
int32_T ) obj_i -> pIdx - 1 ] ; pfvtfzsr5e = b2vyll4xdz [ success ] ; obj_i
-> pBuf [ ( int32_T ) obj_i -> pIdx - 1 ] = pfvtfzsr5e ; p = obj_i -> pPos [
( int32_T ) obj_i -> pIdx - 1 ] ; obj_i -> pIdx ++ ; if ( obj_i -> pWinLen +
1.0F == obj_i -> pIdx ) { obj_i -> pIdx = 1.0F ; } if ( p > obj_i -> pMidHeap
) { if ( vprev < pfvtfzsr5e ) { vprev = p - obj_i -> pMidHeap ; aqjmcdusnj (
...
true ; } else { p = vprev + obj_i -> pMidHeap ; pfvtfzsr5e = truncf ( vprev /
2.0F ) + obj_i -> pMidHeap ; temp = obj_i -> pHeap [ ( int32_T ) p - 1 ] ;
obj_i -> pHeap [ ( int32_T ) p - 1 ] = obj_i -> pHeap [ ( int32_T )
pfvtfzsr5e - 1 ] ; obj_i -> pHeap [ ( int32_T ) pfvtfzsr5e - 1 ] = temp ;
obj_i -> pPos [ ( int32_T ) obj_i -> pHeap [ ( int32_T ) p - 1 ] - 1 ] = p ;
obj_i -> pPos [ ( int32_T ) obj_i -> pHeap [ ( int32_T ) pfvtfzsr5e - 1 ] - 1
] = pfvtfzsr5e ; vprev = truncf ( vprev / 2.0F ) ; } } if ( vprev == 0.0F ) {
bzz10kv3ft ( obj_i , - 1.0F ) ; } } } else if ( p < obj_i -> pMidHeap ) { if
( pfvtfzsr5e < vprev ) { vprev = p - obj_i -> pMidHeap ; bzz10kv3ft ( obj_i ,
...
pfvtfzsr5e = vprev + obj_i -> pMidHeap ; temp = obj_i -> pHeap [ ( int32_T )
p - 1 ] ; obj_i -> pHeap [ ( int32_T ) p - 1 ] = obj_i -> pHeap [ ( int32_T )
pfvtfzsr5e - 1 ] ; obj_i -> pHeap [ ( int32_T ) pfvtfzsr5e - 1 ] = temp ;
obj_i -> pPos [ ( int32_T ) obj_i -> pHeap [ ( int32_T ) p - 1 ] - 1 ] = p ;
obj_i -> pPos [ ( int32_T ) obj_i -> pHeap [ ( int32_T ) pfvtfzsr5e - 1 ] - 1
] = pfvtfzsr5e ; vprev = truncf ( vprev / 2.0F ) ; } } if ( vprev == 0.0F ) {
aqjmcdusnj ( obj_i , 1.0F ) ; } } } else { if ( obj_i -> pMaxHeapLength !=
0.0F ) { bzz10kv3ft ( obj_i , - 1.0F ) ; } if ( obj_i -> pMinHeapLength >
0.0F ) { aqjmcdusnj ( obj_i , 1.0F ) ; } } vprev = obj_i -> pBuf [ ( int32_T
) obj_i -> pHeap [ ( int32_T ) obj_i -> pMidHeap - 1 ] - 1 ] ; vprev += obj_i
-> pBuf [ ( int32_T ) obj_i -> pHeap [ ( int32_T ) ( obj_i -> pMidHeap - 1.0F
) - 1 ] - 1 ] ; tmp_p [ success ] = vprev / 2.0F ; } rtB . a5dep54jil = rtP .
SpeeddemandRPM_Value ; for ( match_idx = 0 ; match_idx <= 596 ; match_idx +=
4 ) { tmp_e = _mm_loadu_ps ( & tmp_p [ match_idx ] ) ; _mm_storeu_ps ( & rtB
. cyhkbxldl2 [ match_idx ] , tmp_e ) ; tmp_e = _mm_loadu_ps ( & rtB .
duaporaq5z_mbvzarwird [ match_idx ] ) ; _mm_storeu_ps ( & rtB . cu4jpdatha [
match_idx ] , _mm_mul_ps ( _mm_set1_ps ( rtP . Gain1_Gain ) , tmp_e ) ) ; }
if ( ssGetLogOutput ( rtS ) ) { StructLogVar * svar = ( StructLogVar * ) rtDW
. etn3lcrlw2 . LoggedData [ 0 ] ; LogVar * var = svar -> signals . values ; {
double locTime = ssGetTaskTime ( rtS , 0 ) ; rt_UpdateLogVar ( ( LogVar * )
svar -> time , & locTime , 0 ) ; } { real32_T up0 [ 600 ] ; ( void ) memcpy (
& up0 [ 0 ] , & rtB . cyhkbxldl2 [ 0 ] , 600 * sizeof ( real32_T ) ) ;
rt_UpdateLogVar ( ( LogVar * ) var , up0 , 0 ) ; var = var -> next ; } {
real32_T up1 [ 1 ] ; up1 [ 0 ] = rtB . a5dep54jil ; rt_UpdateLogVar ( (
LogVar * ) var , up1 , 0 ) ; var = var -> next ; } { real32_T up2 [ 600 ] ; (
void ) memcpy ( & up2 [ 0 ] , & rtB . cu4jpdatha [ 0 ] , 600 * sizeof (
real32_T ) ) ; rt_UpdateLogVar ( ( LogVar * ) var , up2 , 0 ) ; } } { if (
rtDW . inql0ffew5 . AQHandles && ssGetLogOutput ( rtS ) ) { sdiWriteSignal (
rtDW . inql0ffew5 . AQHandles , ssGetTaskTime ( rtS , 0 ) , ( char * ) & rtB
. cyhkbxldl2 [ 0 ] + 0 ) ; } } { if ( rtDW . mpkmcxgjct . AQHandles &&
ssGetLogOutput ( rtS ) ) { sdiWriteSignal ( rtDW . mpkmcxgjct . AQHandles ,
ssGetTaskTime ( rtS , 0 ) , ( char * ) & rtB . a5dep54jil + 0 ) ; } } { if (
rtDW . lxuh4dim3l . AQHandles && ssGetLogOutput ( rtS ) ) { sdiWriteSignal (
rtDW . lxuh4dim3l . AQHandles , ssGetTaskTime ( rtS , 0 ) , ( char * ) & rtB
. cu4jpdatha [ 0 ] + 0 ) ; } } rtB . ewlk1dxko2 = rtP . Gain_Gain * rtB .
a5dep54jil ; if ( ( rtB . ewlk1dxko2 != rtDW . bzptvq4u5r ) || ( rtDW .
lan4qrnmq2 != rtP . MotorStartStop_Value ) ) { if ( rtDW . klqnlcwipn .
TunablePropsChanged ) { rtDW . klqnlcwipn . TunablePropsChanged = false ; }
vprev = truncf ( rtB . ewlk1dxko2 * 4096.0F ) ; if ( muSingleScalarIsNaN (
vprev ) || muSingleScalarIsInf ( vprev ) ) { vprev = 0.0F ; } else { vprev =
muSingleScalarRem ( vprev , 65536.0F ) ; } if ( vprev < 0.0F ) { rowInput [ 0
] = ( uint16_T ) - ( int16_T ) ( uint16_T ) - vprev ; } else { rowInput [ 0 ]
= ( uint16_T ) vprev ; } vprev = truncf ( rtP . MotorStartStop_Value *
4096.0F ) ; if ( muSingleScalarIsNaN ( vprev ) || muSingleScalarIsInf ( vprev
) ) { vprev = 0.0F ; } else { vprev = muSingleScalarRem ( vprev , 65536.0F )
; } if ( vprev < 0.0F ) { rowInput [ 1 ] = ( uint16_T ) - ( int16_T ) (
uint16_T ) - vprev ; } else { rowInput [ 1 ] = ( uint16_T ) vprev ; } memcpy
( ( void * ) & inputval [ 0 ] , ( void * ) & rowInput [ 0 ] , ( uint32_T ) (
( size_t ) 4 * sizeof ( uint8_T ) ) ) ; elcxa00vnt ( & rtDW . klqnlcwipn .
SerialObj , inputval ) ; srUpdateBC ( rtDW . e2ixh5jayd ) ; }
UNUSED_PARAMETER ( tid ) ; } void MdlOutputsTID1 ( int_T tid ) {
UNUSED_PARAMETER ( tid ) ; } void MdlUpdate ( int_T tid ) { rtDW . bzptvq4u5r
= rtB . ewlk1dxko2 ; rtDW . lan4qrnmq2 = rtP . MotorStartStop_Value ;
UNUSED_PARAMETER ( tid ) ; } void MdlUpdateTID1 ( int_T tid ) {
UNUSED_PARAMETER ( tid ) ; } void MdlTerminate ( void ) { CoderChannel chImpl
; cj5bbeqbed * obj_m ; cj5bbeqbeda * obj_b ; escf2nogrs * obj_g ; escf2nogrso
* obj_n ; jlr2oc3akq * obj ; jlr2oc3akq1 * obj_j ; jlr2oc3akq1q * obj_l ;
lydzjepctw * obj_p ; lydzjepctwj * obj_f ; lydzjepctwjv * obj_d ; lz2r3kxmyl
* obj_e ; lz2r3kxmyld * obj_c ; lz2r3kxmyldm * obj_o ; nd1ykmemr0 * obj_i ;
nd1ykmemr0w * obj_k ; nd1ykmemr0wc * obj_dz ; int32_T success ; char_T
errorID [ 1024 ] ; char_T errorText [ 1024 ] ; boolean_T hasSyncError ;
boolean_T result ; if ( ! rtDW . nvmwqwiftq . matlabCodegenIsDeleted ) { rtDW
. nvmwqwiftq . matlabCodegenIsDeleted = true ; if ( ( rtDW . nvmwqwiftq .
isInitialized == 1 ) && rtDW . nvmwqwiftq . isSetupComplete ) { a1z4odhlh0 (
rtDW . nvmwqwiftq . SerialObj . AsyncIOChannel ) ; } } obj = & rtDW .
nvmwqwiftq . SerialObj ; if ( ! obj -> matlabCodegenIsDeleted ) { obj ->
matlabCodegenIsDeleted = true ; a1z4odhlh0 ( obj -> AsyncIOChannel ) ; }
obj_p = & rtDW . nvmwqwiftq . SerialObj . _pobj0 ; if ( ! obj_p ->
matlabCodegenIsDeleted ) { obj_p -> matlabCodegenIsDeleted = true ;
a1z4odhlh0k ( & obj_p -> UnreadDataBuffer ) ; } obj_e = & rtDW . nvmwqwiftq .
SerialObj . _pobj0 . UnreadDataBuffer ; if ( ! obj_e ->
matlabCodegenIsDeleted ) { obj_e -> matlabCodegenIsDeleted = true ; chImpl =
obj_e -> ChannelImpl ; success = coderChannelIsOpen ( chImpl , & result ) ;
if ( success == 0 ) { coderChannelHasSyncError ( chImpl , & hasSyncError ) ;
if ( ! hasSyncError ) { coderChannelGetLastError ( chImpl , & errorID [ 0 ] ,
& errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError ( chImpl , &
errorID [ 0 ] , & errorText [ 0 ] ) ; } } if ( result ) { a1z4odhlh0k ( obj_e
) ; } if ( ! ( obj_e -> ChannelImpl == 0 ) ) { chImpl = obj_e -> ChannelImpl
; success = coderChannelIsOpen ( chImpl , & result ) ; if ( success == 0 ) {
coderChannelHasSyncError ( chImpl , & hasSyncError ) ; if ( ! hasSyncError )
{ coderChannelGetLastError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ;
} else { coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , &
errorText [ 0 ] ) ; } } if ( result ) { a1z4odhlh0k ( obj_e ) ; } chImpl =
...
rtDW . nvmwqwiftq . SerialObj . _pobj1 ; if ( ! obj_i ->
...
errorText [ 0 ] ) ; } } if ( result ) { a1z4odhlh0 ( obj_i ) ; } chImpl =
...
rtDW . nvmwqwiftq . SerialObj . _pobj0 . UnreadDataBuffer . OutputStream ; if
( ! obj_m -> matlabCodegenIsDeleted ) { obj_m -> matlabCodegenIsDeleted =
true ; } obj_m = & rtDW . nvmwqwiftq . SerialObj . _pobj1 . OutputStream ; if
( ! obj_m -> matlabCodegenIsDeleted ) { obj_m -> matlabCodegenIsDeleted =
true ; } obj_g = & rtDW . nvmwqwiftq . SerialObj . _pobj0 . UnreadDataBuffer
. InputStream ; if ( ! obj_g -> matlabCodegenIsDeleted ) { obj_g ->
matlabCodegenIsDeleted = true ; } obj_g = & rtDW . nvmwqwiftq . SerialObj .
_pobj1 . InputStream ; if ( ! obj_g -> matlabCodegenIsDeleted ) { obj_g ->
matlabCodegenIsDeleted = true ; } n5frfhages ( & rtDW . nvmwqwiftq ) ; if ( !
rtDW . fnakjtbv2h . matlabCodegenIsDeleted ) { rtDW . fnakjtbv2h .
matlabCodegenIsDeleted = true ; if ( ( rtDW . fnakjtbv2h . isInitialized == 1
) && rtDW . fnakjtbv2h . isSetupComplete ) { a1z4odhlh0kh ( rtDW . fnakjtbv2h
. SerialObj . AsyncIOChannel ) ; } } obj_j = & rtDW . fnakjtbv2h . SerialObj
; if ( ! obj_j -> matlabCodegenIsDeleted ) { obj_j -> matlabCodegenIsDeleted
= true ; a1z4odhlh0kh ( obj_j -> AsyncIOChannel ) ; } obj_f = & rtDW .
fnakjtbv2h . SerialObj . _pobj0 ; if ( ! obj_f -> matlabCodegenIsDeleted ) {
obj_f -> matlabCodegenIsDeleted = true ; a1z4odhlh0khx ( & obj_f ->
UnreadDataBuffer ) ; } obj_c = & rtDW . fnakjtbv2h . SerialObj . _pobj0 .
...
errorText [ 0 ] ) ; } } if ( result ) { a1z4odhlh0khx ( obj_c ) ; } if ( ! (
obj_c -> ChannelImpl == 0 ) ) { chImpl = obj_c -> ChannelImpl ; success =
coderChannelIsOpen ( chImpl , & result ) ; if ( success == 0 ) {
coderChannelHasSyncError ( chImpl , & hasSyncError ) ; if ( ! hasSyncError )
{ coderChannelGetLastError ( chImpl , & errorID [ 0 ] , & errorText [ 0 ] ) ;
} else { coderChannelGetLastSyncError ( chImpl , & errorID [ 0 ] , &
errorText [ 0 ] ) ; } } if ( result ) { a1z4odhlh0khx ( obj_c ) ; } chImpl =
...
rtDW . fnakjtbv2h . SerialObj . _pobj1 ; if ( ! obj_k ->
...
errorText [ 0 ] ) ; } } if ( result ) { a1z4odhlh0kh ( obj_k ) ; } chImpl =
...
rtDW . fnakjtbv2h . SerialObj . _pobj0 . UnreadDataBuffer . OutputStream ; if
( ! obj_b -> matlabCodegenIsDeleted ) { obj_b -> matlabCodegenIsDeleted =
true ; } obj_b = & rtDW . fnakjtbv2h . SerialObj . _pobj1 . OutputStream ; if
( ! obj_b -> matlabCodegenIsDeleted ) { obj_b -> matlabCodegenIsDeleted =
true ; } obj_n = & rtDW . fnakjtbv2h . SerialObj . _pobj0 . UnreadDataBuffer
. InputStream ; if ( ! obj_n -> matlabCodegenIsDeleted ) { obj_n ->
matlabCodegenIsDeleted = true ; } obj_n = & rtDW . fnakjtbv2h . SerialObj .
_pobj1 . InputStream ; if ( ! obj_n -> matlabCodegenIsDeleted ) { obj_n ->
matlabCodegenIsDeleted = true ; } k1usf3tvuh ( & rtDW . fnakjtbv2h ) ; if ( !
rtDW . lagiiszswb . matlabCodegenIsDeleted ) { rtDW . lagiiszswb .
matlabCodegenIsDeleted = true ; if ( ( rtDW . lagiiszswb . isInitialized == 1
) && rtDW . lagiiszswb . isSetupComplete ) { rtDW . lagiiszswb . NumChannels
= - 1 ; if ( rtDW . lagiiszswb . pMID . isInitialized == 1 ) { rtDW .
lagiiszswb . pMID . isInitialized = 2 ; } } } if ( ! rtDW . klqnlcwipn .
matlabCodegenIsDeleted ) { rtDW . klqnlcwipn . matlabCodegenIsDeleted = true
; if ( ( rtDW . klqnlcwipn . isInitialized == 1 ) && rtDW . klqnlcwipn .
isSetupComplete ) { a1z4odhlh0khxk ( rtDW . klqnlcwipn . SerialObj .
AsyncIOChannel ) ; } } obj_l = & rtDW . klqnlcwipn . SerialObj ; if ( ! obj_l
-> matlabCodegenIsDeleted ) { obj_l -> matlabCodegenIsDeleted = true ;
a1z4odhlh0khxk ( obj_l -> AsyncIOChannel ) ; } obj_d = & rtDW . klqnlcwipn .
SerialObj . _pobj0 ; if ( ! obj_d -> matlabCodegenIsDeleted ) { obj_d ->
matlabCodegenIsDeleted = true ; a1z4odhlh0khxk3 ( & obj_d -> UnreadDataBuffer
) ; } obj_o = & rtDW . klqnlcwipn . SerialObj . _pobj0 . UnreadDataBuffer ;
...
a1z4odhlh0khxk3 ( obj_o ) ; } if ( ! ( obj_o -> ChannelImpl == 0 ) ) { chImpl
= obj_o -> ChannelImpl ; success = coderChannelIsOpen ( chImpl , & result ) ;
if ( success == 0 ) { coderChannelHasSyncError ( chImpl , & hasSyncError ) ;
if ( ! hasSyncError ) { coderChannelGetLastError ( chImpl , & errorID [ 0 ] ,
& errorText [ 0 ] ) ; } else { coderChannelGetLastSyncError ( chImpl , &
errorID [ 0 ] , & errorText [ 0 ] ) ; } } if ( result ) { a1z4odhlh0khxk3 (
...
obj_dz = & rtDW . klqnlcwipn . SerialObj . _pobj1 ; if ( ! obj_dz ->
...
errorText [ 0 ] ) ; } } if ( result ) { a1z4odhlh0khxk ( obj_dz ) ; } chImpl
...
rtDW . klqnlcwipn . SerialObj . _pobj0 . UnreadDataBuffer . OutputStream ; if
( ! obj_b -> matlabCodegenIsDeleted ) { obj_b -> matlabCodegenIsDeleted =
true ; } obj_b = & rtDW . klqnlcwipn . SerialObj . _pobj1 . OutputStream ; if
( ! obj_b -> matlabCodegenIsDeleted ) { obj_b -> matlabCodegenIsDeleted =
true ; } obj_g = & rtDW . klqnlcwipn . SerialObj . _pobj0 . UnreadDataBuffer
. InputStream ; if ( ! obj_g -> matlabCodegenIsDeleted ) { obj_g ->
matlabCodegenIsDeleted = true ; } obj_g = & rtDW . klqnlcwipn . SerialObj .
_pobj1 . InputStream ; if ( ! obj_g -> matlabCodegenIsDeleted ) { obj_g ->
matlabCodegenIsDeleted = true ; } du3caa3v4d ( & rtDW . klqnlcwipn ) ; { if (
rtDW . inql0ffew5 . AQHandles ) { sdiTerminateStreaming ( & rtDW . inql0ffew5
. AQHandles ) ; } } { if ( rtDW . mpkmcxgjct . AQHandles ) {
sdiTerminateStreaming ( & rtDW . mpkmcxgjct . AQHandles ) ; } } { if ( rtDW .
lxuh4dim3l . AQHandles ) { sdiTerminateStreaming ( & rtDW . lxuh4dim3l .
AQHandles ) ; } } } static void
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( mxArray * destArray ,
...
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( void * destData ,
const mxArray * srcArray , mwIndex i , int j , size_t numBytes ) ; static
void mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( void *
destData , const mxArray * srcArray , mwIndex i , int j , size_t numBytes ) {
memcpy ( ( uint8_T * ) destData , ( const uint8_T * ) mxGetData (
mxGetFieldByNumber ( srcArray , i , j ) ) , numBytes ) ; } static void
mr_Copy_of_mcb_host_model_f28069m_cacheBitFieldToMxArray ( mxArray *
...
uint_T mr_Copy_of_mcb_host_model_f28069m_extractBitFieldFromMxArray ( const
mxArray * srcArray , mwIndex i , int j , uint_T numBits ) ; static uint_T
mr_Copy_of_mcb_host_model_f28069m_extractBitFieldFromMxArray ( const mxArray
* srcArray , mwIndex i , int j , uint_T numBits ) { const uint_T varVal = (
uint_T ) mxGetScalar ( mxGetFieldByNumber ( srcArray , i , j ) ) ; return
varVal & ( ( 1u << numBits ) - 1u ) ; } static void
mr_Copy_of_mcb_host_model_f28069m_cacheDataToMxArrayWithOffset ( mxArray *
...
void mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArrayWithOffset (
void * destData , const mxArray * srcArray , mwIndex i , int j , mwIndex
offset , size_t numBytes ) ; static void
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArrayWithOffset ( void *
destData , const mxArray * srcArray , mwIndex i , int j , mwIndex offset ,
size_t numBytes ) { const uint8_T * varData = ( const uint8_T * ) mxGetData (
mxGetFieldByNumber ( srcArray , i , j ) ) ; memcpy ( ( uint8_T * ) destData ,
( const uint8_T * ) & varData [ offset * numBytes ] , numBytes ) ; } static
void mr_Copy_of_mcb_host_model_f28069m_cacheBitFieldToCellArrayWithOffset (
mxArray * destArray , mwIndex i , int j , mwIndex offset , uint_T fieldVal )
; static void
mr_Copy_of_mcb_host_model_f28069m_cacheBitFieldToCellArrayWithOffset (
mxArray * destArray , mwIndex i , int j , mwIndex offset , uint_T fieldVal )
{ mxSetCell ( mxGetFieldByNumber ( destArray , i , j ) , offset ,
mxCreateDoubleScalar ( ( real_T ) fieldVal ) ) ; } static uint_T
mr_Copy_of_mcb_host_model_f28069m_extractBitFieldFromCellArrayWithOffset (
...
mr_Copy_of_mcb_host_model_f28069m_GetDWork ( ) { static const char_T *
ssDWFieldNames [ 3 ] = { "rtB" , "rtDW" , "NULL_PrevZCX" , } ; mxArray * ssDW
= mxCreateStructMatrix ( 1 , 1 , 3 , ssDWFieldNames ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( ssDW , 0 , 0 , ( const
void * ) & ( rtB ) , sizeof ( rtB ) ) ; { static const char_T *
rtdwDataFieldNames [ 24 ] = { "rtDW.lagiiszswb" , "rtDW.fnakjtbv2h" ,
"rtDW.klqnlcwipn" , "rtDW.nvmwqwiftq" , "rtDW.hgtjzyscbh" , "rtDW.arktuqbyhd"
, "rtDW.coet15gpqm" , "rtDW.bzptvq4u5r" , "rtDW.lan4qrnmq2" ,
"rtDW.euzx5umukl" , "rtDW.e2ixh5jayd" , "rtDW.bn4ms0hozr" , "rtDW.dfnk3hn4hf"
, "rtDW.fdiyjus4h5" , "rtDW.hmady1j452" , "rtDW.iadb3xfqrn" ,
"rtDW.ajustef2fb" , "rtDW.ck0hbmqpxs" , "rtDW.fbrxmk2oa1" , "rtDW.h2w1aidhiz"
, "rtDW.io4vb4krek" , "rtDW.p1qlkgqra2" , "rtDW.fqokmmydpq" ,
"rtDW.os140yo3i0" , } ; mxArray * rtdwData = mxCreateStructMatrix ( 1 , 1 ,
24 , rtdwDataFieldNames ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 0 , (
const void * ) & ( rtDW . lagiiszswb ) , sizeof ( rtDW . lagiiszswb ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 1 , (
const void * ) & ( rtDW . fnakjtbv2h ) , sizeof ( rtDW . fnakjtbv2h ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 2 , (
const void * ) & ( rtDW . klqnlcwipn ) , sizeof ( rtDW . klqnlcwipn ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 3 , (
const void * ) & ( rtDW . nvmwqwiftq ) , sizeof ( rtDW . nvmwqwiftq ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 4 , (
const void * ) & ( rtDW . hgtjzyscbh ) , sizeof ( rtDW . hgtjzyscbh ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 5 , (
const void * ) & ( rtDW . arktuqbyhd ) , sizeof ( rtDW . arktuqbyhd ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 6 , (
const void * ) & ( rtDW . coet15gpqm ) , sizeof ( rtDW . coet15gpqm ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 7 , (
const void * ) & ( rtDW . bzptvq4u5r ) , sizeof ( rtDW . bzptvq4u5r ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 8 , (
const void * ) & ( rtDW . lan4qrnmq2 ) , sizeof ( rtDW . lan4qrnmq2 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 9 , (
const void * ) & ( rtDW . euzx5umukl ) , sizeof ( rtDW . euzx5umukl ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 10 , (
const void * ) & ( rtDW . e2ixh5jayd ) , sizeof ( rtDW . e2ixh5jayd ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 11 , (
const void * ) & ( rtDW . bn4ms0hozr ) , sizeof ( rtDW . bn4ms0hozr ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 12 , (
const void * ) & ( rtDW . dfnk3hn4hf ) , sizeof ( rtDW . dfnk3hn4hf ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 13 , (
const void * ) & ( rtDW . fdiyjus4h5 ) , sizeof ( rtDW . fdiyjus4h5 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 14 , (
const void * ) & ( rtDW . hmady1j452 ) , sizeof ( rtDW . hmady1j452 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 15 , (
const void * ) & ( rtDW . iadb3xfqrn ) , sizeof ( rtDW . iadb3xfqrn ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 16 , (
const void * ) & ( rtDW . ajustef2fb ) , sizeof ( rtDW . ajustef2fb ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 17 , (
const void * ) & ( rtDW . ck0hbmqpxs ) , sizeof ( rtDW . ck0hbmqpxs ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 18 , (
const void * ) & ( rtDW . fbrxmk2oa1 ) , sizeof ( rtDW . fbrxmk2oa1 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 19 , (
const void * ) & ( rtDW . h2w1aidhiz ) , sizeof ( rtDW . h2w1aidhiz ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 20 , (
const void * ) & ( rtDW . io4vb4krek ) , sizeof ( rtDW . io4vb4krek ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 21 , (
const void * ) & ( rtDW . p1qlkgqra2 ) , sizeof ( rtDW . p1qlkgqra2 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 22 , (
const void * ) & ( rtDW . fqokmmydpq ) , sizeof ( rtDW . fqokmmydpq ) ) ;
mr_Copy_of_mcb_host_model_f28069m_cacheDataAsMxArray ( rtdwData , 0 , 23 , (
const void * ) & ( rtDW . os140yo3i0 ) , sizeof ( rtDW . os140yo3i0 ) ) ;
mxSetFieldByNumber ( ssDW , 0 , 1 , rtdwData ) ; } return ssDW ; } void
mr_Copy_of_mcb_host_model_f28069m_SetDWork ( const mxArray * ssDW ) { ( void
) ssDW ; mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void *
) & ( rtB ) , ssDW , 0 , 0 , sizeof ( rtB ) ) ; { const mxArray * rtdwData =
mxGetFieldByNumber ( ssDW , 0 , 1 ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . lagiiszswb ) , rtdwData , 0 , 0 , sizeof ( rtDW . lagiiszswb ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . fnakjtbv2h ) , rtdwData , 0 , 1 , sizeof ( rtDW . fnakjtbv2h ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . klqnlcwipn ) , rtdwData , 0 , 2 , sizeof ( rtDW . klqnlcwipn ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . nvmwqwiftq ) , rtdwData , 0 , 3 , sizeof ( rtDW . nvmwqwiftq ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . hgtjzyscbh ) , rtdwData , 0 , 4 , sizeof ( rtDW . hgtjzyscbh ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . arktuqbyhd ) , rtdwData , 0 , 5 , sizeof ( rtDW . arktuqbyhd ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . coet15gpqm ) , rtdwData , 0 , 6 , sizeof ( rtDW . coet15gpqm ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . bzptvq4u5r ) , rtdwData , 0 , 7 , sizeof ( rtDW . bzptvq4u5r ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . lan4qrnmq2 ) , rtdwData , 0 , 8 , sizeof ( rtDW . lan4qrnmq2 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . euzx5umukl ) , rtdwData , 0 , 9 , sizeof ( rtDW . euzx5umukl ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . e2ixh5jayd ) , rtdwData , 0 , 10 , sizeof ( rtDW . e2ixh5jayd ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . bn4ms0hozr ) , rtdwData , 0 , 11 , sizeof ( rtDW . bn4ms0hozr ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . dfnk3hn4hf ) , rtdwData , 0 , 12 , sizeof ( rtDW . dfnk3hn4hf ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . fdiyjus4h5 ) , rtdwData , 0 , 13 , sizeof ( rtDW . fdiyjus4h5 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . hmady1j452 ) , rtdwData , 0 , 14 , sizeof ( rtDW . hmady1j452 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . iadb3xfqrn ) , rtdwData , 0 , 15 , sizeof ( rtDW . iadb3xfqrn ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . ajustef2fb ) , rtdwData , 0 , 16 , sizeof ( rtDW . ajustef2fb ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . ck0hbmqpxs ) , rtdwData , 0 , 17 , sizeof ( rtDW . ck0hbmqpxs ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . fbrxmk2oa1 ) , rtdwData , 0 , 18 , sizeof ( rtDW . fbrxmk2oa1 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . h2w1aidhiz ) , rtdwData , 0 , 19 , sizeof ( rtDW . h2w1aidhiz ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . io4vb4krek ) , rtdwData , 0 , 20 , sizeof ( rtDW . io4vb4krek ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . p1qlkgqra2 ) , rtdwData , 0 , 21 , sizeof ( rtDW . p1qlkgqra2 ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . fqokmmydpq ) , rtdwData , 0 , 22 , sizeof ( rtDW . fqokmmydpq ) ) ;
mr_Copy_of_mcb_host_model_f28069m_restoreDataFromMxArray ( ( void * ) & (
rtDW . os140yo3i0 ) , rtdwData , 0 , 23 , sizeof ( rtDW . os140yo3i0 ) ) ; }
...
blockPath [ 5 ] = { "Copy_of_mcb_host_model_f28069m/Scope" ,
"Copy_of_mcb_host_model_f28069m/Host Serial Setup" ,
"Copy_of_mcb_host_model_f28069m/Serial Communication/Host Serial Receive" ,
"Copy_of_mcb_host_model_f28069m/Serial Communication/Median Filter" ,
 "Copy_of_mcb_host_model_f28069m/Serial Communication/SCI_TX/Host Serial Transmit"
, } ; static const int reason [ 5 ] = { 0 , 6 , 6 , 6 , 6 , } ; for ( subs [
...
raccel_set_checksum ( ) { ssSetChecksumVal ( rtS , 0 , 2666190402U ) ;
ssSetChecksumVal ( rtS , 1 , 1715227433U ) ; ssSetChecksumVal ( rtS , 2 ,
3955249676U ) ; ssSetChecksumVal ( rtS , 3 , 2579154022U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
Copy_of_mcb_host_model_f28069m_InitializeDataMapInfo ( ) ;
ssSetIsRapidAcceleratorActive ( rtS , true ) ; ssSetRootSS ( rtS , rtS ) ;
ssSetVersion ( rtS , SIMSTRUCT_VERSION_LEVEL2 ) ; ssSetModelName ( rtS ,
"Copy_of_mcb_host_model_f28069m" ) ; ssSetPath ( rtS ,
"Copy_of_mcb_host_model_f28069m" ) ; ssSetTStart ( rtS , 0.0 ) ; ssSetTFinal
( rtS , rtInf ) ; ssSetStepSize ( rtS , 0.030000000000000002 ) ;
ssSetFixedStepSize ( rtS , 0.030000000000000002 ) ; { static RTWLogInfo
...
"Copy_of_mcb_host_model_f28069m/Serial Communication/Unit Delay1" } ; static
const char_T * rt_LoggedStateNames [ ] = { "DSTATE" , "DSTATE" } ; static
boolean_T rt_LoggedStateCrossMdlRef [ ] = { 0 , 0 } ; static
RTWLogDataTypeConvert rt_RTWLogDataTypeConvert [ ] = { { 0 , SS_SINGLE ,
SS_SINGLE , 0 , 0 , 0 , 1.0 , 0 , 0.0 } , { 0 , SS_SINGLE , SS_SINGLE , 0 , 0
, 0 , 1.0 , 0 , 0.0 } } ; static int_T rt_LoggedStateIdxList [ ] = { 11 , 12
...
) ; rt_LoggedStateSignalPtrs [ 0 ] = ( void * ) & rtDW . bzptvq4u5r ;
rt_LoggedStateSignalPtrs [ 1 ] = ( void * ) & rtDW . lan4qrnmq2 ; }
...
2666190402U ) ; ssSetChecksumVal ( rtS , 1 , 1715227433U ) ; ssSetChecksumVal
( rtS , 2 , 3955249676U ) ; ssSetChecksumVal ( rtS , 3 , 2579154022U ) ; {
...
sysRanDType * ) & rtDW . e2ixh5jayd ; systemRan [ 6 ] = ( sysRanDType * ) &
rtDW . e2ixh5jayd ; rteiSetModelMappingInfoPtr ( ssGetRTWExtModeInfo ( rtS )
...
mr_Copy_of_mcb_host_model_f28069m_GetSimStateDisallowedBlocks ) ;
slsaGetWorkFcnForSimTargetOP ( rtS ,
mr_Copy_of_mcb_host_model_f28069m_GetDWork ) ; slsaSetWorkFcnForSimTargetOP (
rtS , mr_Copy_of_mcb_host_model_f28069m_SetDWork ) ;
