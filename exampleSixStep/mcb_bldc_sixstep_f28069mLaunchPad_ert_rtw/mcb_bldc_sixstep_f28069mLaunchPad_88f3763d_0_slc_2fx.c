...
#include "mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_2_sys_struct.h"
...
int32_T mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_2fx(const
  SwitchedLinearClump *sys, const NeDynamicSystemInput *t7, SlcMethodOutput *t8)
{
  ...
  if (M_idx_6 != 0) {
    ...
    t1 = X_idx_1 - X_idx_8 * 0.0103;
  }

  if (M_idx_7 != 0) {
    t2 = -X_idx_1 - X_idx_5 * 0.0103;
  } else {
    t2 = -X_idx_1 * 1.0E-5 - X_idx_5;
  }

  if (M_idx_8 != 0) {
    X_idx_9 = -X_idx_1 - X_idx_9;
  } else {
    X_idx_9 = -X_idx_1 - X_idx_9 * 0.0103;
  }

  if (M_idx_9 != 0) {
    X_idx_5 = X_idx_1 - X_idx_7 * 0.0103;
  } else {
    X_idx_5 = X_idx_1 * 1.0E-5 - X_idx_7;
  }
  ...
  out.mX[4] = X_idx_5;
  out.mX[5] = X_idx_6;
  out.mX[6] = X_idx_2 - X_idx_1 * 1.0E-12;
  (void)sys;
  (void)t8;
  return 0;
}
