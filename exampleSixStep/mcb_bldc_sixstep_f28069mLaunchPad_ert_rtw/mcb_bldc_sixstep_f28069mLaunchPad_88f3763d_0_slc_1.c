...
#include "mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_1fx.h"
...
static int32_T slc_mode(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out);
SwitchedLinearClump *mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_1
  (PmAllocator *allocator)
{
  ...
  static size_t selector_M_[10] = { 2U, 3U, 8U, 9U, 19U, 20U, 21U, 22U, 28U, 29U
  };
  ...
  static size_t selector_U_[2] = { 4U, 5U };

  static PmSizeVector selector_U = { 2U, selector_U_ };

  static PmSizeVector selector_V = { 0U, NULL };

  static size_t selector_X_[10] = { 13U, 11U, 2U, 15U, 16U, 24U, 7U, 8U, 25U,
    26U };
  ...
  static int32_T m_ref_indices_[4] = { 0, 1, 8, 9 };
  ...
  slc.mMethods[SLC_METHOD_J] =
    mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_1j;
  slc.mMethods[SLC_METHOD_FX] =
    mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_1fx;
