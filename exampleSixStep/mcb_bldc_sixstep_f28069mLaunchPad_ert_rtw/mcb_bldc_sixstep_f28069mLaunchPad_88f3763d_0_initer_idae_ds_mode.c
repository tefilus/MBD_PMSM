  ...
  NeDynamicSystem *LC, const NeDynamicSystemInput *t1, NeDsMethodOutput *t2)
{
  ...
  out = t2->mMODE;
  out.mX[0] = (int32_T)(X_idx_19 < 0.0);
  out.mX[1] = (int32_T)(U_idx_6 > 0.7);
  out.mX[2] = (int32_T)(X_idx_26 < 0.0);
  out.mX[3] = (int32_T)(U_idx_5 > 0.7);
  out.mX[4] = (int32_T)(X_idx_20 < 0.0);
  out.mX[5] = (int32_T)(U_idx_1 > 0.7);
  out.mX[6] = (int32_T)(X_idx_22 < 0.0);
  out.mX[7] = (int32_T)(U_idx_2 > 0.7);
  out.mX[8] = (int32_T)(X_idx_23 < 0.0);
  out.mX[9] = (int32_T)(U_idx_3 > 0.7);
  out.mX[10] = (int32_T)(X_idx_25 < 0.0);
  out.mX[11] = (int32_T)(U_idx_4 > 0.7);
  (void)LC;
  (void)t2;
  return 0;
}
