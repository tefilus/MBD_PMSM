...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("C:/Program Files/MATLAB/R2023b/toolbox/c2b/tic2000/src/blapp_support.c")
...
;	D:\TiC2000_Install\CCS\ccs\tools\compiler\ti-cgt-c2000_22.6.0.LTS\bin\ac2000.exe -@C:\\Users\\21145\\AppData\\Local\\Temp\\{9978FF38-C4B7-4802-8EFF-2B5064E5456D} 
	.sect	".text"
	.clink
	.global	_bootloaderBackgroundTask

$C$DW$1	.dwtag  DW_TAG_subprogram
	.dwattr $C$DW$1, DW_AT_name("bootloaderBackgroundTask")
	.dwattr $C$DW$1, DW_AT_low_pc(_bootloaderBackgroundTask)
	.dwattr $C$DW$1, DW_AT_high_pc(0x00)
	.dwattr $C$DW$1, DW_AT_TI_symbol_name("_bootloaderBackgroundTask")
	.dwattr $C$DW$1, DW_AT_external
	.dwattr $C$DW$1, DW_AT_TI_begin_file("C:/Program Files/MATLAB/R2023b/toolbox/c2b/tic2000/src/blapp_support.c")
	.dwattr $C$DW$1, DW_AT_TI_begin_line(0x16)
	.dwattr $C$DW$1, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$1, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "C:/Program Files/MATLAB/R2023b/toolbox/c2b/tic2000/src/blapp_support.c",line 23,column 1,is_stmt,address _bootloaderBackgroundTask,isa 0

	.dwfde $C$DW$CIE, _bootloaderBackgroundTask
;----------------------------------------------------------------------
;  22 | void bootloaderBackgroundTask(void)                                    
;----------------------------------------------------------------------

;***************************************************************
;* FNAME: _bootloaderBackgroundTask     FR SIZE:   0           *
;*                                                             *
...
_bootloaderBackgroundTask:
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwpsn	file "C:/Program Files/MATLAB/R2023b/toolbox/c2b/tic2000/src/blapp_support.c",line 24,column 1,is_stmt,isa 0
$C$DW$2	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$2, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$1, DW_AT_TI_end_file("C:/Program Files/MATLAB/R2023b/toolbox/c2b/tic2000/src/blapp_support.c")
...
$C$DW$3	.dwtag  DW_TAG_subprogram
	.dwattr $C$DW$3, DW_AT_name("bootloaderInit")
	.dwattr $C$DW$3, DW_AT_low_pc(_bootloaderInit)
	.dwattr $C$DW$3, DW_AT_high_pc(0x00)
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_bootloaderInit")
	.dwattr $C$DW$3, DW_AT_external
	.dwattr $C$DW$3, DW_AT_TI_begin_file("C:/Program Files/MATLAB/R2023b/toolbox/c2b/tic2000/src/blapp_support.c")
	.dwattr $C$DW$3, DW_AT_TI_begin_line(0x19)
	.dwattr $C$DW$3, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$3, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "C:/Program Files/MATLAB/R2023b/toolbox/c2b/tic2000/src/blapp_support.c",line 26,column 1,is_stmt,address _bootloaderInit,isa 0

	.dwfde $C$DW$CIE, _bootloaderInit
;----------------------------------------------------------------------
;  25 | void bootloaderInit(void)                                              
;----------------------------------------------------------------------

;***************************************************************
;* FNAME: _bootloaderInit               FR SIZE:   0           *
;*                                                             *
;* FUNCTION ENVIRONMENT                                        *
;*                                                             *
;* FUNCTION PROPERTIES                                         *
...
_bootloaderInit:
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwpsn	file "C:/Program Files/MATLAB/R2023b/toolbox/c2b/tic2000/src/blapp_support.c",line 27,column 1,is_stmt,isa 0
$C$DW$4	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$4, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$3, DW_AT_TI_end_file("C:/Program Files/MATLAB/R2023b/toolbox/c2b/tic2000/src/blapp_support.c")
...
$C$DW$47	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$47, DW_AT_name("R1H")
	.dwattr $C$DW$47, DW_AT_location[DW_OP_regx 0x2f]

$C$DW$48	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$48, DW_AT_name("R2H")
	.dwattr $C$DW$48, DW_AT_location[DW_OP_regx 0x33]

$C$DW$49	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$49, DW_AT_name("R3H")
	.dwattr $C$DW$49, DW_AT_location[DW_OP_regx 0x37]

$C$DW$50	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$50, DW_AT_name("R4H")
	.dwattr $C$DW$50, DW_AT_location[DW_OP_regx 0x3b]

$C$DW$51	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$51, DW_AT_name("R5H")
	.dwattr $C$DW$51, DW_AT_location[DW_OP_regx 0x3f]

$C$DW$52	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$52, DW_AT_name("R6H")
	.dwattr $C$DW$52, DW_AT_location[DW_OP_regx 0x43]

$C$DW$53	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$53, DW_AT_name("R7H")
	.dwattr $C$DW$53, DW_AT_location[DW_OP_regx 0x47]

$C$DW$54	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$54, DW_AT_name("RB")
	.dwattr $C$DW$54, DW_AT_location[DW_OP_regx 0x4a]

$C$DW$55	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$55, DW_AT_name("STF")
	.dwattr $C$DW$55, DW_AT_location[DW_OP_regx 0x28]

$C$DW$56	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$56, DW_AT_name("FPUHAZ")
	.dwattr $C$DW$56, DW_AT_location[DW_OP_reg27]

$C$DW$57	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$57, DW_AT_name("STF_HWDIV")
	.dwattr $C$DW$57, DW_AT_location[DW_OP_regx 0x4f]
