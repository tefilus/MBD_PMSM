/*
 * File: Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_button.c
 *
...
#include "Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_button.h"
#include "Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_button_private.h"
#include "rtwtypes.h"
#include <math.h>
 ...
 */
void Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_button_SetEventsForThisBaseStep
...
void Copy_of_mcb__CurrentControl(void)
{
  ...
  Copy_of_mcb_bldc_sixstep_f280_B.DataTypeConversion_b[1] =
    Copy_of_mcb_bldc_sixstep_f280_B.IAIBMeasurement_p[1];
  Copy_of_mcb_bldc_sixstep_f280_B.DataTypeConversion_b[2] =
    Copy_of_mcb_bldc_sixstep_f280_B.ICMeasurement_l;
  ...
  Copy_of_mcb_bldc_sixstep_f280_B.DataTypeConversion_l[1] = (int16_T)
    (Copy_of_mcb_bldc_sixstep_f280_B.DataTypeConversion[0] * 4096.0F);
  ...
  /* Outputs for Iterator SubSystem: '<S12>/CodeGeneration' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S12>/CodeGeneration' */
...
void Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_button_step0(void) /* Sample time: [0.0005s, 0.0s] */
{
  ...
  Copy_of_mcb_bldc_six_To_LCD(&Copy_of_mcb_bldc_sixstep__DWork.speedSCI_B,
    &Copy_of_mcb_bldc_sixstep_f280_B.To_LCD,
    &Copy_of_mcb_bldc_sixstep__DWork.To_LCD);

  /* End of Outputs for SubSystem: '<Root>/To_LCD' */
}

/* Model step function for TID1 */
void Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_button_step1(void) /* Sample time: [0.1s, 0.0s] */
{
  /* S-Function (c280xgpio_di): '<S7>/CW//CCW_GPIO7' */
  {
...
void Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_button_initialize(void)
{
  /* Registration code */
...

  {
    ...
    Copy_of_mcb_bldc_sixstep_f280_B.Saturation = 0.0F;
    Copy_of_mcb_bldc_sixstep_f280_B.To_LCD.dataLogging_Speed = 0.0F;
...

  {
    ...
    /* Start for S-Function (c280xgpio_di): '<S7>/CW//CCW_GPIO7' */
    EALLOW;
    ...
    Copy_of_mcb_bldc_sixstep__DWork.IbOffset = 3304U;

    /* Start for DataStoreMemory: '<Root>/g_IcOffset' */
    Copy_of_mcb_bldc_sixstep__DWork.IcOffset = 3304U;
    ...
    Copy_of_mcb_bld_To_LCD_Init(&Copy_of_mcb_bldc_sixstep_f280_B.To_LCD);
    ...
    if ((Copy_of_mcb_bldc_sixstep_f280_B.Divide2 > 2500U) &&
       ...
       */
      Copy_of_mcb_bldc_sixstep__DWork.IcOffset = 3020U;
...
void Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_button_terminate(void)
{
...
void Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_button_configure_interrupts(void)
{
