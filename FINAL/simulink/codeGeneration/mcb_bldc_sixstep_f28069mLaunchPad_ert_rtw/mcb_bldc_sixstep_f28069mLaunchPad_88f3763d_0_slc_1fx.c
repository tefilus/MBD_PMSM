...
int32_T mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_1fx(const
  SwitchedLinearClump *sys, const NeDynamicSystemInput *t7, SlcMethodOutput *t8)
{
  ...
  X_idx_9 = t7->mX.mX[9];
  out = t8->mFX;
  t5 = ((-X_idx_2 - X_idx_7) + X_idx_5) + X_idx_6;
  if (M_idx_8 != 0) {
    t0 = X_idx_1 - X_idx_8;
  } else {
    t0 = X_idx_1 - X_idx_8 * 0.0103;
  }

  if (M_idx_9 != 0) {
    t1 = -X_idx_1 - X_idx_5 * 0.0103;
  } else {
    t1 = -X_idx_1 * 1.0E-5 - X_idx_5;
  }

  if (M_idx_0 != 0) {
    t2 = -X_idx_1 - X_idx_9;
  } else {
    t2 = -X_idx_1 - X_idx_9 * 0.0103;
  }

  if (M_idx_1 != 0) {
    X_idx_7 = X_idx_1 - X_idx_7 * 0.0103;
  } else {
    X_idx_7 = X_idx_1 * 1.0E-5 - X_idx_7;
  }

  if (M_idx_8 != 0) {
    X_idx_5 = t5 - X_idx_8 * 1.0E-5;
  } else {
    X_idx_5 = t5 - X_idx_8;
  }

  if (M_idx_0 != 0) {
    t5 = X_idx_6 - X_idx_9 * 1.0E-5;
  } else {
    t5 = X_idx_6 - X_idx_9;
  }
