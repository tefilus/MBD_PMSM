...
#include "mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_2j.h"
#include "mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_2fx.h"
#include "ssc_ml_fun.h"
#include "mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_2_external_struct.h"
#include "mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_2_externals.h"
...
static int32_T slc_mode(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out);
SwitchedLinearClump *mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_2
  (PmAllocator *allocator)
{
  ...
  static size_t selector_M_[10] = { 6U, 7U, 15U, 16U, 17U, 18U, 24U, 25U, 26U,
    27U };
  ...
  static size_t selector_U_[2] = { 2U, 3U };

  static PmSizeVector selector_U = { 2U, selector_U_ };

  static PmSizeVector selector_V = { 0U, NULL };

  static size_t selector_X_[10] = { 13U, 10U, 1U, 15U, 16U, 21U, 5U, 6U, 22U,
    23U };
  ...
  static int32_T state_indices_[7] = { 1, 2, 5, 6, 7, 8, 9 };
  ...
  static int32_T mode_indices_[8] = { 0, 1, 2, 3, 4, 5, 6, 8 };

  static PmIntVector mode_indices = { 8U, mode_indices_ };

  static int32_T m_ref_indices_[4] = { 6, 7, 8, 9 };
  ...
  slc.mMethods[SLC_METHOD_J] =
    mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_2j;
  slc.mMethods[SLC_METHOD_FX] =
    mcb_bldc_sixstep_f28069mLaunchPad_88f3763d_0_slc_2fx;
                      ...
                      *t11, SlcMethodOutput *t12)
{
  ...
  X_idx_4 = t11->mX.mX[4];
  out = t12->mF;
  X_idx_0 = X_idx_0 * 5.0 - 2.0943951023931953;
  t9 = cos(X_idx_0);
  t10 = -sin(X_idx_0);
  if (M_idx_7 != 0) {
    X_idx_0 = 48.0;
  } else {
    X_idx_0 = 0.00048000000000000007;
  }
  ...
  NeDynamicSystemInput *t1, SlcMethodOutput *t2)
{
  ...
  out.mX[4] = 1;
  out.mX[5] = 1;
  out.mX[6] = (int32_T)(X_idx_8 < 0.0);
  out.mX[7] = (int32_T)(X_idx_9 < 0.0);
  (void)sys;
  (void)t2;
  return 0;
}
