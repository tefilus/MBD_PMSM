###########################################################################
## Makefile generated for component 'Copy_of_mcb_bldc_sixstep_f28069mLaunchPad'. 
## 
## Makefile     : Copy_of_mcb_bldc_sixstep_f28069mLaunchPad.mk
## Generated on : Tue May 06 16:22:34 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad.out
...
PRODUCT_NAME              = Copy_of_mcb_bldc_sixstep_f28069mLaunchPad
MAKEFILE                  = Copy_of_mcb_bldc_sixstep_f28069mLaunchPad.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad.out
...
DEFINES_STANDARD = -DMODEL=Copy_of_mcb_bldc_sixstep_f28069mLaunchPad -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Copy_of_mcb_bldc_sixstep_f28069mLaunchPad.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_data.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_qep.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/MW_c28xx_qep.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/Copy_of_mcb_bldc_sixstep_f28069mLaunchPad_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
