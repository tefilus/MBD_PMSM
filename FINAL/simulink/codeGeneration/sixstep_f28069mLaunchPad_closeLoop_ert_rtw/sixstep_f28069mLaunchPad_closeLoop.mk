###########################################################################
## Makefile generated for component 'sixstep_f28069mLaunchPad_closeLoop'. 
## 
## Makefile     : sixstep_f28069mLaunchPad_closeLoop.mk
## Generated on : Fri Jun 27 21:43:19 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sixstep_f28069mLaunchPad_closeLoop.out
...
PRODUCT_NAME              = sixstep_f28069mLaunchPad_closeLoop
MAKEFILE                  = sixstep_f28069mLaunchPad_closeLoop.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = E:/GiaotrinhDH/MBD_PMSM/FINAL/simulink/codeGeneration
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sixstep_f28069mLaunchPad_closeLoop.out
...
DEFINES_STANDARD = -DMODEL=sixstep_f28069mLaunchPad_closeLoop -DNUMST=5 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_qep.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/MW_c28xx_qep.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ToLCD.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/ToLCD.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


sixstep_f28069mLaunchPad_closeLoop.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/sixstep_f28069mLaunchPad_closeLoop.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


sixstep_f28069mLaunchPad_closeLoop_data.obj : $(START_DIR)/sixstep_f28069mLaunchPad_closeLoop_ert_rtw/sixstep_f28069mLaunchPad_closeLoop_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
